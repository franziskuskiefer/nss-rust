...
pub enum PLOptionInternal { }
#[derive(Copy, Clone)]
#[repr(u32)]
#[derive(Debug)]
pub enum PLOptStatus { PL_OPT_OK = 0, PL_OPT_EOL = 1, PL_OPT_BAD = 2, }
#[repr(C)]
#[derive(Copy, Clone)]
#[derive(Debug)]
pub struct PLLongOpt {
    pub longOptName: *const ::std::os::raw::c_char,
    pub longOption: PRIntn,
    pub valueRequired: PRBool,
}
impl ::std::default::Default for PLLongOpt {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
#[repr(C)]
#[derive(Copy, Clone)]
#[derive(Debug)]
pub struct PLOptState {
    pub option: ::std::os::raw::c_char,
    pub value: *const ::std::os::raw::c_char,
    pub internal: *mut PLOptionInternal,
    pub longOption: PRIntn,
    pub longOptIndex: PRIntn,
}
impl ::std::default::Default for PLOptState {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
extern "C" {
    ...
    pub fn PL_CreateOptState(argc: PRIntn,
                             argv: *mut *mut ::std::os::raw::c_char,
                             options: *const ::std::os::raw::c_char)
     -> *mut PLOptState;
    pub fn PL_CreateLongOptState(argc: PRIntn,
                                 argv: *mut *mut ::std::os::raw::c_char,
                                 options: *const ::std::os::raw::c_char,
                                 longOpts: *const PLLongOpt)
     -> *mut PLOptState;
    pub fn PL_DestroyOptState(opt: *mut PLOptState);
    pub fn PL_GetNextOpt(opt: *mut PLOptState) -> PLOptStatus;
}
