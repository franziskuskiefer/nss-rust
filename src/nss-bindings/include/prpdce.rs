...
extern "C" {
    ...
    pub fn PRP_TryLock(lock: *mut PRLock) -> PRStatus;
    pub fn PRP_NewNakedCondVar() -> *mut PRCondVar;
    pub fn PRP_DestroyNakedCondVar(cvar: *mut PRCondVar);
    pub fn PRP_NakedWait(cvar: *mut PRCondVar, lock: *mut PRLock,
                         timeout: PRIntervalTime) -> PRStatus;
    pub fn PRP_NakedNotify(cvar: *mut PRCondVar) -> PRStatus;
    pub fn PRP_NakedBroadcast(cvar: *mut PRCondVar) -> PRStatus;
}
