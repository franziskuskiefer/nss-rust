...
extern "C" {
    ...
    pub fn PR_CreateOrderedLock(order: PRInt32,
                                name: *const ::std::os::raw::c_char)
     -> *mut PROrderedLock;
    pub fn PR_DestroyOrderedLock(lock: *mut PROrderedLock);
    pub fn PR_LockOrderedLock(lock: *mut PROrderedLock);
    pub fn PR_UnlockOrderedLock(lock: *mut PROrderedLock) -> PRStatus;
}
