...
pub type PRCounterHandle = *mut ::std::os::raw::c_void;
extern "C" {
    ...
    pub fn PR_CreateCounter(qName: *const ::std::os::raw::c_char,
                            rName: *const ::std::os::raw::c_char,
                            description: *const ::std::os::raw::c_char)
     -> PRCounterHandle;
    pub fn PR_DestroyCounter(handle: PRCounterHandle);
    pub fn PR_GetCounterHandleFromName(qName: *const ::std::os::raw::c_char,
                                       rName: *const ::std::os::raw::c_char)
     -> PRCounterHandle;
    pub fn PR_GetCounterNameFromHandle(handle: PRCounterHandle,
                                       qName:
                                       ...
                                       description:
                                           *mut *const ::std::os::raw::c_char);
    pub fn PR_IncrementCounter(handle: PRCounterHandle);
    pub fn PR_DecrementCounter(handle: PRCounterHandle);
    pub fn PR_AddToCounter(handle: PRCounterHandle, value: PRUint32);
    pub fn PR_SubtractFromCounter(handle: PRCounterHandle, value: PRUint32);
    pub fn PR_GetCounter(handle: PRCounterHandle) -> PRUint32;
    pub fn PR_SetCounter(handle: PRCounterHandle, value: PRUint32);
    pub fn PR_FindNextCounterQname(handle: PRCounterHandle)
     -> PRCounterHandle;
    pub fn PR_FindNextCounterRname(rhandle: PRCounterHandle,
                                   qhandle: PRCounterHandle)
     -> PRCounterHandle;
}
