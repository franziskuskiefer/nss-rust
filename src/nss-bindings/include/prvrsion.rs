...
#[derive(Copy, Clone)]
#[derive(Debug)]
pub struct PRVersionDescription {
    pub version: PRInt32,
    pub buildTime: PRInt64,
    pub buildTimeString: *mut ::std::os::raw::c_char,
    pub vMajor: PRUint8,
    pub vMinor: PRUint8,
    pub vPatch: PRUint8,
    pub beta: PRBool,
    ...
    pub security: *mut ::std::os::raw::c_char,
    pub copyright: *mut ::std::os::raw::c_char,
    pub comment: *mut ::std::os::raw::c_char,
    pub specialString: *mut ::std::os::raw::c_char,
}
impl ::std::default::Default for PRVersionDescription {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
pub type versionEntryPointType =
    ::std::option::Option<extern "C" fn() -> *const PRVersionDescription>;
extern "C" {
