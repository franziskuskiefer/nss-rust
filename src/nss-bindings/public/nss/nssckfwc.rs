...
pub type NSSCKMDInstance = NSSCKMDInstanceStr;
pub type NSSCKMDSlot = NSSCKMDSlotStr;
pub type NSSCKMDToken = NSSCKMDTokenStr;
pub type NSSCKMDSession = NSSCKMDSessionStr;
pub type NSSCKMDCryptoOperation = NSSCKMDCryptoOperationStr;
pub type NSSCKMDFindObjects = NSSCKMDFindObjectsStr;
pub type NSSCKMDMechanism = NSSCKMDMechanismStr;
pub type NSSCKMDObject = NSSCKMDObjectStr;
#[repr(C)]
#[derive(Copy, Clone)]
#[derive(Debug)]
pub struct NSSCKFWItem {
    pub needsFreeing: PRBool,
    pub item: *mut NSSItem,
}
impl ::std::default::Default for NSSCKFWItem {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
#[repr(C)]
#[derive(Copy, Clone)]
#[derive(Debug)]
pub struct NSSCKMDInstanceStr {
    pub etc: *mut ::std::os::raw::c_void,
    pub Initialize: ::std::option::Option<unsafe extern "C" fn(mdInstance:
                                                                   *mut NSSCKMDInstance,
                                                               fwInstance:
                                                                   *mut NSSCKFWInstance,
                                                               configurationData:
                                                                   *mut NSSUTF8)
                                              -> CK_RV>,
    pub Finalize: ::std::option::Option<unsafe extern "C" fn(mdInstance:
                                                                 *mut NSSCKMDInstance,
                                                             fwInstance:
                                                                 *mut NSSCKFWInstance)>,
    pub GetNSlots: ::std::option::Option<unsafe extern "C" fn(mdInstance:
                                                                  *mut NSSCKMDInstance,
                                                              fwInstance:
                                                                  *mut NSSCKFWInstance,
                                                              pError:
                                                                  *mut CK_RV)
                                             -> CK_ULONG>,
    pub GetCryptokiVersion: ::std::option::Option<unsafe extern "C" fn(mdInstance:
                                                                           *mut NSSCKMDInstance,
                                                                       fwInstance:
                                                                           *mut NSSCKFWInstance)
                                                      -> CK_VERSION>,
    pub GetManufacturerID: ::std::option::Option<unsafe extern "C" fn(mdInstance:
                                                                          *mut NSSCKMDInstance,
                                                                      fwInstance:
                                                                          *mut NSSCKFWInstance,
                                                                      pError:
                                                                          *mut CK_RV)
                                                     -> *mut NSSUTF8>,
    pub GetLibraryDescription: ::std::option::Option<unsafe extern "C" fn(mdInstance:
                                                                              *mut NSSCKMDInstance,
                                                                          fwInstance:
                                                                              *mut NSSCKFWInstance,
                                                                          pError:
                                                                              *mut CK_RV)
                                                         -> *mut NSSUTF8>,
    pub GetLibraryVersion: ::std::option::Option<unsafe extern "C" fn(mdInstance:
                                                                          *mut NSSCKMDInstance,
                                                                      fwInstance:
                                                                          *mut NSSCKFWInstance)
                                                     -> CK_VERSION>,
    pub ModuleHandlesSessionObjects: ::std::option::Option<unsafe extern "C" fn(mdInstance:
                                                                                    *mut NSSCKMDInstance,
                                                                                fwInstance:
                                                                                    *mut NSSCKFWInstance)
                                                               -> CK_BBOOL>,
    pub GetSlots: ::std::option::Option<unsafe extern "C" fn(mdInstance:
                                                                 *mut NSSCKMDInstance,
                                                             fwInstance:
                                                                 *mut NSSCKFWInstance,
                                                             slots:
                                                                 *mut *mut NSSCKMDSlot)
                                            -> CK_RV>,
    pub WaitForSlotEvent: ::std::option::Option<unsafe extern "C" fn(mdInstance:
                                                                         *mut NSSCKMDInstance,
                                                                     fwInstance:
                                                                         *mut NSSCKFWInstance,
                                                                     block:
                                                                     ...
                                                                     pError:
                                                                         *mut CK_RV)
                                                    -> *mut NSSCKMDSlot>,
    pub null: *mut ::std::os::raw::c_void,
}
impl ::std::default::Default for NSSCKMDInstanceStr {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
#[repr(C)]
#[derive(Copy, Clone)]
#[derive(Debug)]
pub struct NSSCKMDSlotStr {
    pub etc: *mut ::std::os::raw::c_void,
    pub Initialize: ::std::option::Option<unsafe extern "C" fn(mdSlot:
                                                                   *mut NSSCKMDSlot,
                                                               fwSlot:
                                                                   *mut NSSCKFWSlot,
                                                               mdInstance:
                                                               ...
                                                               fwInstance:
                                                                   *mut NSSCKFWInstance)
                                              -> CK_RV>,
    pub Destroy: ::std::option::Option<unsafe extern "C" fn(mdSlot:
                                                                *mut NSSCKMDSlot,
                                                            fwSlot:
                                                                *mut NSSCKFWSlot,
                                                            mdInstance:
                                                            ...
                                                            fwInstance:
                                                                *mut NSSCKFWInstance)>,
    pub GetSlotDescription: ::std::option::Option<unsafe extern "C" fn(mdSlot:
                                                                           *mut NSSCKMDSlot,
                                                                       fwSlot:
                                                                           *mut NSSCKFWSlot,
                                                                       mdInstance:
                                                                       ...
                                                                       pError:
                                                                           *mut CK_RV)
                                                      -> *mut NSSUTF8>,
    pub GetManufacturerID: ::std::option::Option<unsafe extern "C" fn(mdSlot:
                                                                          *mut NSSCKMDSlot,
                                                                      fwSlot:
                                                                          *mut NSSCKFWSlot,
                                                                      mdInstance:
                                                                      ...
                                                                      pError:
                                                                          *mut CK_RV)
                                                     -> *mut NSSUTF8>,
    pub GetTokenPresent: ::std::option::Option<unsafe extern "C" fn(mdSlot:
                                                                        *mut NSSCKMDSlot,
                                                                    fwSlot:
                                                                        *mut NSSCKFWSlot,
                                                                    mdInstance:
                                                                    ...
                                                                    fwInstance:
                                                                        *mut NSSCKFWInstance)
                                                   -> CK_BBOOL>,
    pub GetRemovableDevice: ::std::option::Option<unsafe extern "C" fn(mdSlot:
                                                                           *mut NSSCKMDSlot,
                                                                       fwSlot:
                                                                           *mut NSSCKFWSlot,
                                                                       mdInstance:
                                                                       ...
                                                                       fwInstance:
                                                                           *mut NSSCKFWInstance)
                                                      -> CK_BBOOL>,
    pub GetHardwareSlot: ::std::option::Option<unsafe extern "C" fn(mdSlot:
                                                                        *mut NSSCKMDSlot,
                                                                    fwSlot:
                                                                        *mut NSSCKFWSlot,
                                                                    mdInstance:
                                                                    ...
                                                                    fwInstance:
                                                                        *mut NSSCKFWInstance)
                                                   -> CK_BBOOL>,
    pub GetHardwareVersion: ::std::option::Option<unsafe extern "C" fn(mdSlot:
                                                                           *mut NSSCKMDSlot,
                                                                       fwSlot:
                                                                           *mut NSSCKFWSlot,
                                                                       mdInstance:
                                                                       ...
                                                                       fwInstance:
                                                                           *mut NSSCKFWInstance)
                                                      -> CK_VERSION>,
    pub GetFirmwareVersion: ::std::option::Option<unsafe extern "C" fn(mdSlot:
                                                                           *mut NSSCKMDSlot,
                                                                       fwSlot:
                                                                           *mut NSSCKFWSlot,
                                                                       mdInstance:
                                                                       ...
                                                                       fwInstance:
                                                                           *mut NSSCKFWInstance)
                                                      -> CK_VERSION>,
    pub GetToken: ::std::option::Option<unsafe extern "C" fn(mdSlot:
                                                                 *mut NSSCKMDSlot,
                                                             fwSlot:
                                                                 *mut NSSCKFWSlot,
                                                             mdInstance:
...
impl ::std::default::Default for NSSCKMDSlotStr {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
#[repr(C)]
#[derive(Copy, Clone)]
#[derive(Debug)]
pub struct NSSCKMDTokenStr {
    pub etc: *mut ::std::os::raw::c_void,
    pub Setup: ::std::option::Option<unsafe extern "C" fn(mdToken:
                                                              *mut NSSCKMDToken,
                                                          fwToken:
                                                              *mut NSSCKFWToken,
                                                          mdInstance:
                                                          ...
                                                          fwInstance:
                                                              *mut NSSCKFWInstance)
                                         -> CK_RV>,
    pub Invalidate: ::std::option::Option<unsafe extern "C" fn(mdToken:
                                                                   *mut NSSCKMDToken,
                                                               fwToken:
                                                                   *mut NSSCKFWToken,
                                                               mdInstance:
                                                               ...
                                                               fwInstance:
                                                                   *mut NSSCKFWInstance)>,
    pub InitToken: ::std::option::Option<unsafe extern "C" fn(mdToken:
                                                                  *mut NSSCKMDToken,
                                                              fwToken:
                                                                  *mut NSSCKFWToken,
                                                              mdInstance:
                                                              ...
                                                              label:
                                                                  *mut NSSUTF8)
                                             -> CK_RV>,
    pub GetLabel: ::std::option::Option<unsafe extern "C" fn(mdToken:
                                                                 *mut NSSCKMDToken,
                                                             fwToken:
                                                                 *mut NSSCKFWToken,
                                                             mdInstance:
                                                             ...
                                                             pError:
                                                                 *mut CK_RV)
                                            -> *mut NSSUTF8>,
    pub GetManufacturerID: ::std::option::Option<unsafe extern "C" fn(mdToken:
                                                                          *mut NSSCKMDToken,
                                                                      fwToken:
                                                                          *mut NSSCKFWToken,
                                                                      mdInstance:
                                                                      ...
                                                                      pError:
                                                                          *mut CK_RV)
                                                     -> *mut NSSUTF8>,
    pub GetModel: ::std::option::Option<unsafe extern "C" fn(mdToken:
                                                                 *mut NSSCKMDToken,
                                                             fwToken:
                                                                 *mut NSSCKFWToken,
                                                             mdInstance:
                                                             ...
                                                             pError:
                                                                 *mut CK_RV)
                                            -> *mut NSSUTF8>,
    pub GetSerialNumber: ::std::option::Option<unsafe extern "C" fn(mdToken:
                                                                        *mut NSSCKMDToken,
                                                                    fwToken:
                                                                        *mut NSSCKFWToken,
                                                                    mdInstance:
                                                                    ...
                                                                    pError:
                                                                        *mut CK_RV)
                                                   -> *mut NSSUTF8>,
    pub GetHasRNG: ::std::option::Option<unsafe extern "C" fn(mdToken:
                                                                  *mut NSSCKMDToken,
                                                              fwToken:
                                                                  *mut NSSCKFWToken,
                                                              mdInstance:
                                                              ...
                                                              fwInstance:
                                                                  *mut NSSCKFWInstance)
                                             -> CK_BBOOL>,
    pub GetIsWriteProtected: ::std::option::Option<unsafe extern "C" fn(mdToken:
                                                                            *mut NSSCKMDToken,
                                                                        fwToken:
                                                                            *mut NSSCKFWToken,
                                                                        mdInstance:
                                                                        ...
                                                                        fwInstance:
                                                                            *mut NSSCKFWInstance)
                                                       -> CK_BBOOL>,
    pub GetLoginRequired: ::std::option::Option<unsafe extern "C" fn(mdToken:
                                                                         *mut NSSCKMDToken,
                                                                     fwToken:
                                                                         *mut NSSCKFWToken,
                                                                     mdInstance:
                                                                     ...
                                                                     fwInstance:
                                                                         *mut NSSCKFWInstance)
                                                    -> CK_BBOOL>,
    pub GetUserPinInitialized: ::std::option::Option<unsafe extern "C" fn(mdToken:
                                                                              *mut NSSCKMDToken,
                                                                          fwToken:
                                                                              *mut NSSCKFWToken,
                                                                          mdInstance:
                                                                          ...
                                                                          fwInstance:
                                                                              *mut NSSCKFWInstance)
                                                         -> CK_BBOOL>,
    pub GetRestoreKeyNotNeeded: ::std::option::Option<unsafe extern "C" fn(mdToken:
                                                                               *mut NSSCKMDToken,
                                                                           fwToken:
                                                                               *mut NSSCKFWToken,
                                                                           mdInstance:
                                                                           ...
                                                                           fwInstance:
                                                                               *mut NSSCKFWInstance)
                                                          -> CK_BBOOL>,
    pub GetHasClockOnToken: ::std::option::Option<unsafe extern "C" fn(mdToken:
                                                                           *mut NSSCKMDToken,
                                                                       fwToken:
                                                                           *mut NSSCKFWToken,
                                                                       mdInstance:
                                                                       ...
                                                                       fwInstance:
                                                                           *mut NSSCKFWInstance)
                                                      -> CK_BBOOL>,
    pub GetHasProtectedAuthenticationPath: ::std::option::Option<unsafe extern "C" fn(mdToken:
                                                                                          *mut NSSCKMDToken,
                                                                                      fwToken:
                                                                                          *mut NSSCKFWToken,
                                                                                      mdInstance:
                                                                     ...
                                                                     ->
                                                                         CK_BBOOL>,
    pub GetSupportsDualCryptoOperations: ::std::option::Option<unsafe extern "C" fn(mdToken:
                                                                                        *mut NSSCKMDToken,
                                                                                    fwToken:
                                                                                        *mut NSSCKFWToken,
                                                                                    mdInstance:
                                                                   ...
                                                                   ->
                                                                       CK_BBOOL>,
    pub GetMaxSessionCount: ::std::option::Option<unsafe extern "C" fn(mdToken:
                                                                           *mut NSSCKMDToken,
                                                                       fwToken:
                                                                           *mut NSSCKFWToken,
                                                                       mdInstance:
                                                                       ...
                                                                       fwInstance:
                                                                           *mut NSSCKFWInstance)
                                                      -> CK_ULONG>,
    pub GetMaxRwSessionCount: ::std::option::Option<unsafe extern "C" fn(mdToken:
                                                                             *mut NSSCKMDToken,
                                                                         fwToken:
                                                                             *mut NSSCKFWToken,
                                                                         mdInstance:
                                                                         ...
                                                                         fwInstance:
                                                                             *mut NSSCKFWInstance)
                                                        -> CK_ULONG>,
    pub GetMaxPinLen: ::std::option::Option<unsafe extern "C" fn(mdToken:
                                                                     *mut NSSCKMDToken,
                                                                 fwToken:
                                                                     *mut NSSCKFWToken,
                                                                 mdInstance:
                                                                 ...
                                                                 fwInstance:
                                                                     *mut NSSCKFWInstance)
                                                -> CK_ULONG>,
    pub GetMinPinLen: ::std::option::Option<unsafe extern "C" fn(mdToken:
                                                                     *mut NSSCKMDToken,
                                                                 fwToken:
                                                                     *mut NSSCKFWToken,
                                                                 mdInstance:
                                                                 ...
                                                                 fwInstance:
                                                                     *mut NSSCKFWInstance)
                                                -> CK_ULONG>,
    pub GetTotalPublicMemory: ::std::option::Option<unsafe extern "C" fn(mdToken:
                                                                             *mut NSSCKMDToken,
                                                                         fwToken:
                                                                             *mut NSSCKFWToken,
                                                                         mdInstance:
                                                                         ...
                                                                         fwInstance:
                                                                             *mut NSSCKFWInstance)
                                                        -> CK_ULONG>,
    pub GetFreePublicMemory: ::std::option::Option<unsafe extern "C" fn(mdToken:
                                                                            *mut NSSCKMDToken,
                                                                        fwToken:
                                                                            *mut NSSCKFWToken,
                                                                        mdInstance:
                                                                        ...
                                                                        fwInstance:
                                                                            *mut NSSCKFWInstance)
                                                       -> CK_ULONG>,
    pub GetTotalPrivateMemory: ::std::option::Option<unsafe extern "C" fn(mdToken:
                                                                              *mut NSSCKMDToken,
                                                                          fwToken:
                                                                              *mut NSSCKFWToken,
                                                                          mdInstance:
                                                                          ...
                                                                          fwInstance:
                                                                              *mut NSSCKFWInstance)
                                                         -> CK_ULONG>,
    pub GetFreePrivateMemory: ::std::option::Option<unsafe extern "C" fn(mdToken:
                                                                             *mut NSSCKMDToken,
                                                                         fwToken:
                                                                             *mut NSSCKFWToken,
                                                                         mdInstance:
                                                                         ...
                                                                         fwInstance:
                                                                             *mut NSSCKFWInstance)
                                                        -> CK_ULONG>,
    pub GetHardwareVersion: ::std::option::Option<unsafe extern "C" fn(mdToken:
                                                                           *mut NSSCKMDToken,
                                                                       fwToken:
                                                                           *mut NSSCKFWToken,
                                                                       mdInstance:
                                                                       ...
                                                                       fwInstance:
                                                                           *mut NSSCKFWInstance)
                                                      -> CK_VERSION>,
    pub GetFirmwareVersion: ::std::option::Option<unsafe extern "C" fn(mdToken:
                                                                           *mut NSSCKMDToken,
                                                                       fwToken:
                                                                           *mut NSSCKFWToken,
                                                                       mdInstance:
                                                                       ...
                                                                       fwInstance:
                                                                           *mut NSSCKFWInstance)
                                                      -> CK_VERSION>,
    pub GetUTCTime: ::std::option::Option<unsafe extern "C" fn(mdToken:
                                                                   *mut NSSCKMDToken,
                                                               fwToken:
                                                                   *mut NSSCKFWToken,
                                                               mdInstance:
                                                               ...
                                                               utcTime:
                                                                   *mut CK_CHAR)
                                              -> CK_RV>,
    pub OpenSession: ::std::option::Option<unsafe extern "C" fn(mdToken:
                                                                    *mut NSSCKMDToken,
                                                                fwToken:
                                                                    *mut NSSCKFWToken,
                                                                mdInstance:
                                                                ...
                                                                pError:
                                                                    *mut CK_RV)
                                               -> *mut NSSCKMDSession>,
    pub GetMechanismCount: ::std::option::Option<unsafe extern "C" fn(mdToken:
                                                                          *mut NSSCKMDToken,
                                                                      fwToken:
                                                                          *mut NSSCKFWToken,
                                                                      mdInstance:
                                                                      ...
                                                                      fwInstance:
                                                                          *mut NSSCKFWInstance)
                                                     -> CK_ULONG>,
    pub GetMechanismTypes: ::std::option::Option<unsafe extern "C" fn(mdToken:
                                                                          *mut NSSCKMDToken,
                                                                      fwToken:
                                                                          *mut NSSCKFWToken,
                                                                      mdInstance:
                                                     ...
                                                     -> CK_RV>,
    pub GetMechanism: ::std::option::Option<unsafe extern "C" fn(mdToken:
                                                                     *mut NSSCKMDToken,
                                                                 fwToken:
                                                                     *mut NSSCKFWToken,
                                                                 mdInstance:
                                                                 ...
                                                                 pError:
                                                                     *mut CK_RV)
                                                -> *mut NSSCKMDMechanism>,
    pub null: *mut ::std::os::raw::c_void,
}
impl ::std::default::Default for NSSCKMDTokenStr {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
#[repr(C)]
#[derive(Copy, Clone)]
#[derive(Debug)]
pub struct NSSCKMDSessionStr {
    pub etc: *mut ::std::os::raw::c_void,
    pub Close: ::std::option::Option<unsafe extern "C" fn(mdSession:
                                                              *mut NSSCKMDSession,
                                                          fwSession:
                                                              *mut NSSCKFWSession,
                                                          mdToken:
                                                          ...
                                                          fwInstance:
                                                              *mut NSSCKFWInstance)>,
    pub GetDeviceError: ::std::option::Option<unsafe extern "C" fn(mdSession:
                                                                       *mut NSSCKMDSession,
                                                                   fwSession:
                                                                       *mut NSSCKFWSession,
                                                                   mdToken:
                                                                   ...
                                                                   fwInstance:
                                                                       *mut NSSCKFWInstance)
                                                  -> CK_ULONG>,
    pub Login: ::std::option::Option<unsafe extern "C" fn(mdSession:
                                                              *mut NSSCKMDSession,
                                                          fwSession:
                                                              *mut NSSCKFWSession,
                                                          mdToken:
                                                          ...
                                                          newState: CK_STATE)
                                         -> CK_RV>,
    pub Logout: ::std::option::Option<unsafe extern "C" fn(mdSession:
                                                               *mut NSSCKMDSession,
                                                           fwSession:
                                                               *mut NSSCKFWSession,
                                                           mdToken:
                                                           ...
                                                           newState: CK_STATE)
                                          -> CK_RV>,
    pub InitPIN: ::std::option::Option<unsafe extern "C" fn(mdSession:
                                                                *mut NSSCKMDSession,
                                                            fwSession:
                                                                *mut NSSCKFWSession,
                                                            mdToken:
                                                            ...
                                                            pin: *mut NSSItem)
                                           -> CK_RV>,
    pub SetPIN: ::std::option::Option<unsafe extern "C" fn(mdSession:
                                                               *mut NSSCKMDSession,
                                                           fwSession:
                                                               *mut NSSCKFWSession,
                                                           mdToken:
                                                           ...
                                                           newPin:
                                                               *mut NSSItem)
                                          -> CK_RV>,
    pub GetOperationStateLen: ::std::option::Option<unsafe extern "C" fn(mdSession:
                                                                             *mut NSSCKMDSession,
                                                                         fwSession:
                                                                             *mut NSSCKFWSession,
                                                                         mdToken:
                                                                         ...
                                                                         pError:
                                                                             *mut CK_RV)
                                                        -> CK_ULONG>,
    pub GetOperationState: ::std::option::Option<unsafe extern "C" fn(mdSession:
                                                                          *mut NSSCKMDSession,
                                                                      fwSession:
                                                                          *mut NSSCKFWSession,
                                                                      mdToken:
                                                                      ...
                                                                      buffer:
                                                                          *mut NSSItem)
                                                     -> CK_RV>,
    pub SetOperationState: ::std::option::Option<unsafe extern "C" fn(mdSession:
                                                                          *mut NSSCKMDSession,
                                                                      fwSession:
                                                                          *mut NSSCKFWSession,
                                                                      mdToken:
                                                                      ...
                                                                      fwAuthenticationKey:
                                                                          *mut NSSCKFWObject)
                                                     -> CK_RV>,
    pub CreateObject: ::std::option::Option<unsafe extern "C" fn(mdSession:
                                                                     *mut NSSCKMDSession,
                                                                 fwSession:
                                                                     *mut NSSCKFWSession,
                                                                 mdToken:
                                                                 ...
                                                                 pError:
                                                                     *mut CK_RV)
                                                -> *mut NSSCKMDObject>,
    pub CopyObject: ::std::option::Option<unsafe extern "C" fn(mdSession:
                                                                   *mut NSSCKMDSession,
                                                               fwSession:
                                                                   *mut NSSCKFWSession,
                                                               mdToken:
                                                               ...
                                                               pError:
                                                                   *mut CK_RV)
                                              -> *mut NSSCKMDObject>,
    pub FindObjectsInit: ::std::option::Option<unsafe extern "C" fn(mdSession:
                                                                        *mut NSSCKMDSession,
                                                                    fwSession:
                                                                        *mut NSSCKFWSession,
                                                                    mdToken:
                                                                    ...
                                                                    pError:
                                                                        *mut CK_RV)
                                                   ->
                                                       *mut NSSCKMDFindObjects>,
    pub SeedRandom: ::std::option::Option<unsafe extern "C" fn(mdSession:
                                                                   *mut NSSCKMDSession,
                                                               fwSession:
                                                                   *mut NSSCKFWSession,
                                                               mdToken:
                                                               ...
                                                               seed:
                                                                   *mut NSSItem)
                                              -> CK_RV>,
    pub GetRandom: ::std::option::Option<unsafe extern "C" fn(mdSession:
                                                                  *mut NSSCKMDSession,
                                                              fwSession:
                                                                  *mut NSSCKFWSession,
                                                              mdToken:
...
impl ::std::default::Default for NSSCKMDSessionStr {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
#[repr(C)]
#[derive(Copy, Clone)]
#[derive(Debug)]
pub struct NSSCKMDFindObjectsStr {
    pub etc: *mut ::std::os::raw::c_void,
    pub Final: ::std::option::Option<unsafe extern "C" fn(mdFindObjects:
                                                              *mut NSSCKMDFindObjects,
                                                          fwFindObjects:
                                                              *mut NSSCKFWFindObjects,
                                                          mdSession:
                                                              *mut NSSCKMDSession,
                                                          fwSession:
                                                              *mut NSSCKFWSession,
                                                          ...
                                                          fwInstance:
                                                              *mut NSSCKFWInstance)>,
    pub Next: ::std::option::Option<unsafe extern "C" fn(mdFindObjects:
                                                             *mut NSSCKMDFindObjects,
                                                         fwFindObjects:
                                                             *mut NSSCKFWFindObjects,
                                                         mdSession:
...
impl ::std::default::Default for NSSCKMDFindObjectsStr {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
#[repr(C)]
#[derive(Copy, Clone)]
#[derive(Debug)]
pub struct NSSCKMDCryptoOperationStr {
    pub etc: *mut ::std::os::raw::c_void,
    pub Destroy: ::std::option::Option<unsafe extern "C" fn(mdCryptoOperation:
                                                                *mut NSSCKMDCryptoOperation,
                                                            fwCryptoOperation:
                                                                *mut NSSCKFWCryptoOperation,
                                                            mdInstance:
                                                                *mut NSSCKMDInstance,
                                                            fwInstance:
                                                                *mut NSSCKFWInstance)>,
    pub GetFinalLength: ::std::option::Option<unsafe extern "C" fn(mdCryptoOperation:
                                                                       *mut NSSCKMDCryptoOperation,
                                                                   fwCryptoOperation:
                                                                       *mut NSSCKFWCryptoOperation,
                                                                   mdSession:
                                                                   ...
                                                                   pError:
                                                                       *mut CK_RV)
                                                  -> CK_ULONG>,
    pub GetOperationLength: ::std::option::Option<unsafe extern "C" fn(mdCryptoOperation:
                                                                           *mut NSSCKMDCryptoOperation,
                                                                       fwCryptoOperation:
                                                                           *mut NSSCKFWCryptoOperation,
                                                                       mdSession:
                                                                       ...
                                                                       pError:
                                                                           *mut CK_RV)
                                                      -> CK_ULONG>,
    pub Final: ::std::option::Option<unsafe extern "C" fn(mdCryptoOperation:
                                                              *mut NSSCKMDCryptoOperation,
                                                          fwCryptoOperation:
                                                              *mut NSSCKFWCryptoOperation,
                                                          mdSession:
                                                          ...
                                                          outputBuffer:
                                                              *mut NSSItem)
                                         -> CK_RV>,
    pub Update: ::std::option::Option<unsafe extern "C" fn(mdCryptoOperation:
                                                               *mut NSSCKMDCryptoOperation,
                                                           fwCryptoOperation:
                                                               *mut NSSCKFWCryptoOperation,
                                                           mdSession:
                                                           ...
                                                           outputBuffer:
                                                               *mut NSSItem)
                                          -> CK_RV>,
    pub DigestUpdate: ::std::option::Option<unsafe extern "C" fn(mdCryptoOperation:
                                                                     *mut NSSCKMDCryptoOperation,
                                                                 fwCryptoOperation:
                                                                     *mut NSSCKFWCryptoOperation,
                                                                 mdSession:
                                                                 ...
                                                                 inputBuffer:
                                                                     *const NSSItem)
                                                -> CK_RV>,
    pub UpdateFinal: ::std::option::Option<unsafe extern "C" fn(mdCryptoOperation:
                                                                    *mut NSSCKMDCryptoOperation,
                                                                fwCryptoOperation:
                                                                    *mut NSSCKFWCryptoOperation,
                                                                mdSession:
                                                                ...
                                                                outputBuffer:
                                                                    *mut NSSItem)
                                               -> CK_RV>,
    pub UpdateCombo: ::std::option::Option<unsafe extern "C" fn(mdCryptoOperation:
                                                                    *mut NSSCKMDCryptoOperation,
                                                                fwCryptoOperation:
                                                                    *mut NSSCKFWCryptoOperation,
                                                                ...
                                                                outputBuffer:
                                                                    *mut NSSItem)
                                               -> CK_RV>,
    pub DigestKey: ::std::option::Option<unsafe extern "C" fn(mdCryptoOperation:
                                                                  *mut NSSCKMDCryptoOperation,
                                                              fwCryptoOperation:
                                                                  *mut NSSCKFWCryptoOperation,
                                                              mdToken:
...
impl ::std::default::Default for NSSCKMDCryptoOperationStr {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
#[repr(C)]
#[derive(Copy, Clone)]
#[derive(Debug)]
pub struct NSSCKMDMechanismStr {
    pub etc: *mut ::std::os::raw::c_void,
    pub Destroy: ::std::option::Option<unsafe extern "C" fn(mdMechanism:
                                                                *mut NSSCKMDMechanism,
                                                            fwMechanism:
                                                                *mut NSSCKFWMechanism,
                                                            mdInstance:
                                                                *mut NSSCKMDInstance,
                                                            fwInstance:
                                                                *mut NSSCKFWInstance)>,
    pub GetMinKeySize: ::std::option::Option<unsafe extern "C" fn(mdMechanism:
                                                                      *mut NSSCKMDMechanism,
                                                                  fwMechanism:
                                                                      *mut NSSCKFWMechanism,
                                                                  mdToken:
                                                                  ...
                                                                  pError:
                                                                      *mut CK_RV)
                                                 -> CK_ULONG>,
    pub GetMaxKeySize: ::std::option::Option<unsafe extern "C" fn(mdMechanism:
                                                                      *mut NSSCKMDMechanism,
                                                                  fwMechanism:
                                                                      *mut NSSCKFWMechanism,
                                                                  mdToken:
                                                                  ...
                                                                  pError:
                                                                      *mut CK_RV)
                                                 -> CK_ULONG>,
    pub GetInHardware: ::std::option::Option<unsafe extern "C" fn(mdMechanism:
                                                                      *mut NSSCKMDMechanism,
                                                                  fwMechanism:
                                                                      *mut NSSCKFWMechanism,
                                                                  mdToken:
                                                                  ...
                                                                  pError:
                                                                      *mut CK_RV)
                                                 -> CK_BBOOL>,
    pub EncryptInit: ::std::option::Option<unsafe extern "C" fn(mdMechanism:
                                                                    *mut NSSCKMDMechanism,
                                                                fwMechanism:
                                                                    *mut NSSCKFWMechanism,
                                                                pMechanism:
                                               ...
                                               ->
                                                   *mut NSSCKMDCryptoOperation>,
    pub DecryptInit: ::std::option::Option<unsafe extern "C" fn(mdMechanism:
                                                                    *mut NSSCKMDMechanism,
                                                                fwMechanism:
                                                                    *mut NSSCKFWMechanism,
                                                                pMechanism:
                                               ...
                                               ->
                                                   *mut NSSCKMDCryptoOperation>,
    pub DigestInit: ::std::option::Option<unsafe extern "C" fn(mdMechanism:
                                                                   *mut NSSCKMDMechanism,
                                                               fwMechanism:
                                                                   *mut NSSCKFWMechanism,
                                                               pMechanism:
                                                               ...
                                                               pError:
                                                                   *mut CK_RV)
                                              -> *mut NSSCKMDCryptoOperation>,
    pub SignInit: ::std::option::Option<unsafe extern "C" fn(mdMechanism:
                                                                 *mut NSSCKMDMechanism,
                                                             fwMechanism:
                                                                 *mut NSSCKFWMechanism,
                                                             pMechanism:
                                                             ...
                                                             pError:
                                                                 *mut CK_RV)
                                            -> *mut NSSCKMDCryptoOperation>,
    pub VerifyInit: ::std::option::Option<unsafe extern "C" fn(mdMechanism:
                                                                   *mut NSSCKMDMechanism,
                                                               fwMechanism:
                                                                   *mut NSSCKFWMechanism,
                                                               pMechanism:
                                                               ...
                                                               pError:
                                                                   *mut CK_RV)
                                              -> *mut NSSCKMDCryptoOperation>,
    pub SignRecoverInit: ::std::option::Option<unsafe extern "C" fn(mdMechanism:
                                                                        *mut NSSCKMDMechanism,
                                                                    fwMechanism:
                                                                        *mut NSSCKFWMechanism,
                                                                    pMechanism:
                                                   ...
                                                   ->
                                                       *mut NSSCKMDCryptoOperation>,
    pub VerifyRecoverInit: ::std::option::Option<unsafe extern "C" fn(mdMechanism:
                                                                          *mut NSSCKMDMechanism,
                                                                      fwMechanism:
                                                                          *mut NSSCKFWMechanism,
                                                                      pMechanism:
                                                     ...
                                                     ->
                                                         *mut NSSCKMDCryptoOperation>,
    pub GenerateKey: ::std::option::Option<unsafe extern "C" fn(mdMechanism:
                                                                    *mut NSSCKMDMechanism,
                                                                fwMechanism:
                                                                    *mut NSSCKFWMechanism,
                                                                pMechanism:
                                                                ...
                                                                pError:
                                                                    *mut CK_RV)
                                               -> *mut NSSCKMDObject>,
    pub GenerateKeyPair: ::std::option::Option<unsafe extern "C" fn(mdMechanism:
                                                                        *mut NSSCKMDMechanism,
                                                                    fwMechanism:
                                                                        *mut NSSCKFWMechanism,
                                                                    pMechanism:
                                                                    ...
                                                                    ulPrivateKeyAttributeCount:
                                                                        CK_ULONG,
                                                                    pPublicKey:
                                                                        *mut *mut NSSCKMDObject,
                                                                    pPrivateKey:
                                                                        *mut *mut NSSCKMDObject)
                                                   -> CK_RV>,
    pub GetWrapKeyLength: ::std::option::Option<unsafe extern "C" fn(mdMechanism:
                                                                         *mut NSSCKMDMechanism,
                                                                     fwMechanism:
                                                                         *mut NSSCKFWMechanism,
                                                                     pMechanism:
                                                                     ...
                                                                     pError:
                                                                         *mut CK_RV)
                                                    -> CK_ULONG>,
    pub WrapKey: ::std::option::Option<unsafe extern "C" fn(mdMechanism:
                                                                *mut NSSCKMDMechanism,
                                                            fwMechanism:
                                                                *mut NSSCKFWMechanism,
                                                            pMechanism:
                                                            ...
                                                            wrappedKey:
                                                                *mut NSSItem)
                                           -> CK_RV>,
    pub UnwrapKey: ::std::option::Option<unsafe extern "C" fn(mdMechanism:
                                                                  *mut NSSCKMDMechanism,
                                                              fwMechanism:
                                                                  *mut NSSCKFWMechanism,
                                                              pMechanism:
                                                              ...
                                                              pError:
                                                                  *mut CK_RV)
                                             -> *mut NSSCKMDObject>,
    pub DeriveKey: ::std::option::Option<unsafe extern "C" fn(mdMechanism:
                                                                  *mut NSSCKMDMechanism,
                                                              fwMechanism:
                                                                  *mut NSSCKFWMechanism,
                                                              pMechanism:
...
impl ::std::default::Default for NSSCKMDMechanismStr {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
#[repr(C)]
#[derive(Copy, Clone)]
#[derive(Debug)]
pub struct NSSCKMDObjectStr {
    pub etc: *mut ::std::os::raw::c_void,
    pub Finalize: ::std::option::Option<unsafe extern "C" fn(mdObject:
                                                                 *mut NSSCKMDObject,
                                                             fwObject:
                                                                 *mut NSSCKFWObject,
                                                             mdSession:
                                                             ...
                                                             fwInstance:
                                                                 *mut NSSCKFWInstance)>,
    pub Destroy: ::std::option::Option<unsafe extern "C" fn(mdObject:
                                                                *mut NSSCKMDObject,
                                                            fwObject:
                                                                *mut NSSCKFWObject,
                                                            mdSession:
                                                            ...
                                                            fwInstance:
                                                                *mut NSSCKFWInstance)
                                           -> CK_RV>,
    pub IsTokenObject: ::std::option::Option<unsafe extern "C" fn(mdObject:
                                                                      *mut NSSCKMDObject,
                                                                  fwObject:
                                                                      *mut NSSCKFWObject,
                                                                  mdSession:
                                                                  ...
                                                                  fwInstance:
                                                                      *mut NSSCKFWInstance)
                                                 -> CK_BBOOL>,
    pub GetAttributeCount: ::std::option::Option<unsafe extern "C" fn(mdObject:
                                                                          *mut NSSCKMDObject,
                                                                      fwObject:
                                                                          *mut NSSCKFWObject,
                                                                      mdSession:
                                                                      ...
                                                                      pError:
                                                                          *mut CK_RV)
                                                     -> CK_ULONG>,
    pub GetAttributeTypes: ::std::option::Option<unsafe extern "C" fn(mdObject:
                                                                          *mut NSSCKMDObject,
                                                                      fwObject:
                                                                          *mut NSSCKFWObject,
                                                                      mdSession:
                                                                      ...
                                                                      ulCount:
                                                                          CK_ULONG)
                                                     -> CK_RV>,
    pub GetAttributeSize: ::std::option::Option<unsafe extern "C" fn(mdObject:
                                                                         *mut NSSCKMDObject,
                                                                     fwObject:
                                                                         *mut NSSCKFWObject,
                                                                     mdSession:
                                                                     ...
                                                                     pError:
                                                                         *mut CK_RV)
                                                    -> CK_ULONG>,
    pub GetAttribute: ::std::option::Option<unsafe extern "C" fn(mdObject:
                                                                     *mut NSSCKMDObject,
                                                                 fwObject:
                                                                     *mut NSSCKFWObject,
                                                                 mdSession:
                                                                 ...
                                                                 pError:
                                                                     *mut CK_RV)
                                                -> NSSCKFWItem>,
    pub FreeAttribute: ::std::option::Option<unsafe extern "C" fn(item:
                                                                      *mut NSSCKFWItem)
                                                 -> CK_RV>,
    pub SetAttribute: ::std::option::Option<unsafe extern "C" fn(mdObject:
                                                                     *mut NSSCKMDObject,
                                                                 fwObject:
                                                                     *mut NSSCKFWObject,
                                                                 mdSession:
                                                                 ...
                                                                 value:
                                                                     *mut NSSItem)
                                                -> CK_RV>,
    pub GetObjectSize: ::std::option::Option<unsafe extern "C" fn(mdObject:
                                                                      *mut NSSCKMDObject,
                                                                  fwObject:
                                                                      *mut NSSCKFWObject,
                                                                  mdSession:
...
impl ::std::default::Default for NSSCKMDObjectStr {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
...
extern "C" {
    ...
    pub fn NSSCKFWC_Initialize(pFwInstance: *mut *mut NSSCKFWInstance,
                               mdInstance: *mut NSSCKMDInstance,
                               pInitArgs: CK_VOID_PTR) -> CK_RV;
    pub fn NSSCKFWC_Finalize(pFwInstance: *mut *mut NSSCKFWInstance) -> CK_RV;
    pub fn NSSCKFWC_GetInfo(fwInstance: *mut NSSCKFWInstance,
                            pInfo: CK_INFO_PTR) -> CK_RV;
    pub fn NSSCKFWC_GetSlotList(fwInstance: *mut NSSCKFWInstance,
                                tokenPresent: CK_BBOOL,
                                pSlotList: CK_SLOT_ID_PTR,
                                pulCount: CK_ULONG_PTR) -> CK_RV;
    pub fn NSSCKFWC_GetSlotInfo(fwInstance: *mut NSSCKFWInstance,
                                slotID: CK_SLOT_ID, pInfo: CK_SLOT_INFO_PTR)
     -> CK_RV;
    pub fn NSSCKFWC_GetTokenInfo(fwInstance: *mut NSSCKFWInstance,
                                 slotID: CK_SLOT_ID, pInfo: CK_TOKEN_INFO_PTR)
     -> CK_RV;
    pub fn NSSCKFWC_WaitForSlotEvent(fwInstance: *mut NSSCKFWInstance,
                                     flags: CK_FLAGS, pSlot: CK_SLOT_ID_PTR,
                                     pReserved: CK_VOID_PTR) -> CK_RV;
    pub fn NSSCKFWC_GetMechanismList(fwInstance: *mut NSSCKFWInstance,
                                     slotID: CK_SLOT_ID,
                                     pMechanismList: CK_MECHANISM_TYPE_PTR,
                                     pulCount: CK_ULONG_PTR) -> CK_RV;
    pub fn NSSCKFWC_GetMechanismInfo(fwInstance: *mut NSSCKFWInstance,
                                     slotID: CK_SLOT_ID,
                                     type_: CK_MECHANISM_TYPE,
                                     pInfo: CK_MECHANISM_INFO_PTR) -> CK_RV;
    pub fn NSSCKFWC_InitToken(fwInstance: *mut NSSCKFWInstance,
                              slotID: CK_SLOT_ID, pPin: CK_CHAR_PTR,
                              ulPinLen: CK_ULONG, pLabel: CK_CHAR_PTR)
     -> CK_RV;
    pub fn NSSCKFWC_InitPIN(fwInstance: *mut NSSCKFWInstance,
                            hSession: CK_SESSION_HANDLE, pPin: CK_CHAR_PTR,
                            ulPinLen: CK_ULONG) -> CK_RV;
    pub fn NSSCKFWC_SetPIN(fwInstance: *mut NSSCKFWInstance,
                           hSession: CK_SESSION_HANDLE, pOldPin: CK_CHAR_PTR,
                           ulOldLen: CK_ULONG, pNewPin: CK_CHAR_PTR,
                           ulNewLen: CK_ULONG) -> CK_RV;
    pub fn NSSCKFWC_OpenSession(fwInstance: *mut NSSCKFWInstance,
                                slotID: CK_SLOT_ID, flags: CK_FLAGS,
                                pApplication: CK_VOID_PTR, Notify: CK_NOTIFY,
                                phSession: CK_SESSION_HANDLE_PTR) -> CK_RV;
    pub fn NSSCKFWC_CloseSession(fwInstance: *mut NSSCKFWInstance,
                                 hSession: CK_SESSION_HANDLE) -> CK_RV;
    pub fn NSSCKFWC_CloseAllSessions(fwInstance: *mut NSSCKFWInstance,
                                     slotID: CK_SLOT_ID) -> CK_RV;
    pub fn NSSCKFWC_GetSessionInfo(fwInstance: *mut NSSCKFWInstance,
                                   hSession: CK_SESSION_HANDLE,
                                   pInfo: CK_SESSION_INFO_PTR) -> CK_RV;
    pub fn NSSCKFWC_GetOperationState(fwInstance: *mut NSSCKFWInstance,
                                      hSession: CK_SESSION_HANDLE,
                                      pOperationState: CK_BYTE_PTR,
                                      pulOperationStateLen: CK_ULONG_PTR)
     -> CK_RV;
    pub fn NSSCKFWC_SetOperationState(fwInstance: *mut NSSCKFWInstance,
                                      hSession: CK_SESSION_HANDLE,
                                      pOperationState: CK_BYTE_PTR,
     ...
     -> CK_RV;
    pub fn NSSCKFWC_Login(fwInstance: *mut NSSCKFWInstance,
                          hSession: CK_SESSION_HANDLE, userType: CK_USER_TYPE,
                          pPin: CK_CHAR_PTR, ulPinLen: CK_ULONG) -> CK_RV;
    pub fn NSSCKFWC_Logout(fwInstance: *mut NSSCKFWInstance,
                           hSession: CK_SESSION_HANDLE) -> CK_RV;
    pub fn NSSCKFWC_CreateObject(fwInstance: *mut NSSCKFWInstance,
                                 hSession: CK_SESSION_HANDLE,
                                 pTemplate: CK_ATTRIBUTE_PTR,
                                 ulCount: CK_ULONG,
                                 phObject: CK_OBJECT_HANDLE_PTR) -> CK_RV;
    pub fn NSSCKFWC_CopyObject(fwInstance: *mut NSSCKFWInstance,
                               hSession: CK_SESSION_HANDLE,
                               hObject: CK_OBJECT_HANDLE,
                               pTemplate: CK_ATTRIBUTE_PTR, ulCount: CK_ULONG,
                               phNewObject: CK_OBJECT_HANDLE_PTR) -> CK_RV;
    pub fn NSSCKFWC_DestroyObject(fwInstance: *mut NSSCKFWInstance,
                                  hSession: CK_SESSION_HANDLE,
                                  hObject: CK_OBJECT_HANDLE) -> CK_RV;
    pub fn NSSCKFWC_GetObjectSize(fwInstance: *mut NSSCKFWInstance,
                                  hSession: CK_SESSION_HANDLE,
                                  hObject: CK_OBJECT_HANDLE,
                                  pulSize: CK_ULONG_PTR) -> CK_RV;
    pub fn NSSCKFWC_GetAttributeValue(fwInstance: *mut NSSCKFWInstance,
                                      hSession: CK_SESSION_HANDLE,
                                      hObject: CK_OBJECT_HANDLE,
                                      pTemplate: CK_ATTRIBUTE_PTR,
                                      ulCount: CK_ULONG) -> CK_RV;
    pub fn NSSCKFWC_SetAttributeValue(fwInstance: *mut NSSCKFWInstance,
                                      hSession: CK_SESSION_HANDLE,
                                      hObject: CK_OBJECT_HANDLE,
                                      pTemplate: CK_ATTRIBUTE_PTR,
                                      ulCount: CK_ULONG) -> CK_RV;
    pub fn NSSCKFWC_FindObjectsInit(fwInstance: *mut NSSCKFWInstance,
                                    hSession: CK_SESSION_HANDLE,
                                    pTemplate: CK_ATTRIBUTE_PTR,
                                    ulCount: CK_ULONG) -> CK_RV;
    pub fn NSSCKFWC_FindObjects(fwInstance: *mut NSSCKFWInstance,
                                hSession: CK_SESSION_HANDLE,
                                phObject: CK_OBJECT_HANDLE_PTR,
                                ulMaxObjectCount: CK_ULONG,
                                pulObjectCount: CK_ULONG_PTR) -> CK_RV;
    pub fn NSSCKFWC_FindObjectsFinal(fwInstance: *mut NSSCKFWInstance,
                                     hSession: CK_SESSION_HANDLE) -> CK_RV;
    pub fn NSSCKFWC_EncryptInit(fwInstance: *mut NSSCKFWInstance,
                                hSession: CK_SESSION_HANDLE,
                                pMechanism: CK_MECHANISM_PTR,
                                hKey: CK_OBJECT_HANDLE) -> CK_RV;
    pub fn NSSCKFWC_Encrypt(fwInstance: *mut NSSCKFWInstance,
                            hSession: CK_SESSION_HANDLE, pData: CK_BYTE_PTR,
                            ulDataLen: CK_ULONG, pEncryptedData: CK_BYTE_PTR,
                            pulEncryptedDataLen: CK_ULONG_PTR) -> CK_RV;
    pub fn NSSCKFWC_EncryptUpdate(fwInstance: *mut NSSCKFWInstance,
                                  hSession: CK_SESSION_HANDLE,
                                  pPart: CK_BYTE_PTR, ulPartLen: CK_ULONG,
                                  pEncryptedPart: CK_BYTE_PTR,
                                  pulEncryptedPartLen: CK_ULONG_PTR) -> CK_RV;
    pub fn NSSCKFWC_EncryptFinal(fwInstance: *mut NSSCKFWInstance,
                                 hSession: CK_SESSION_HANDLE,
                                 pLastEncryptedPart: CK_BYTE_PTR,
                                 pulLastEncryptedPartLen: CK_ULONG_PTR)
     -> CK_RV;
    pub fn NSSCKFWC_DecryptInit(fwInstance: *mut NSSCKFWInstance,
                                hSession: CK_SESSION_HANDLE,
                                pMechanism: CK_MECHANISM_PTR,
                                hKey: CK_OBJECT_HANDLE) -> CK_RV;
    pub fn NSSCKFWC_Decrypt(fwInstance: *mut NSSCKFWInstance,
                            hSession: CK_SESSION_HANDLE,
                            pEncryptedData: CK_BYTE_PTR,
                            ulEncryptedDataLen: CK_ULONG, pData: CK_BYTE_PTR,
                            pulDataLen: CK_ULONG_PTR) -> CK_RV;
    pub fn NSSCKFWC_DecryptUpdate(fwInstance: *mut NSSCKFWInstance,
                                  hSession: CK_SESSION_HANDLE,
                                  pEncryptedPart: CK_BYTE_PTR,
                                  ulEncryptedPartLen: CK_ULONG,
                                  pPart: CK_BYTE_PTR,
                                  pulPartLen: CK_ULONG_PTR) -> CK_RV;
    pub fn NSSCKFWC_DecryptFinal(fwInstance: *mut NSSCKFWInstance,
                                 hSession: CK_SESSION_HANDLE,
                                 pLastPart: CK_BYTE_PTR,
                                 pulLastPartLen: CK_ULONG_PTR) -> CK_RV;
    pub fn NSSCKFWC_DigestInit(fwInstance: *mut NSSCKFWInstance,
                               hSession: CK_SESSION_HANDLE,
                               pMechanism: CK_MECHANISM_PTR) -> CK_RV;
    pub fn NSSCKFWC_Digest(fwInstance: *mut NSSCKFWInstance,
                           hSession: CK_SESSION_HANDLE, pData: CK_BYTE_PTR,
                           ulDataLen: CK_ULONG, pDigest: CK_BYTE_PTR,
                           pulDigestLen: CK_ULONG_PTR) -> CK_RV;
    pub fn NSSCKFWC_DigestUpdate(fwInstance: *mut NSSCKFWInstance,
                                 hSession: CK_SESSION_HANDLE,
                                 pData: CK_BYTE_PTR, ulDataLen: CK_ULONG)
     -> CK_RV;
    pub fn NSSCKFWC_DigestKey(fwInstance: *mut NSSCKFWInstance,
                              hSession: CK_SESSION_HANDLE,
                              hKey: CK_OBJECT_HANDLE) -> CK_RV;
    pub fn NSSCKFWC_DigestFinal(fwInstance: *mut NSSCKFWInstance,
                                hSession: CK_SESSION_HANDLE,
                                pDigest: CK_BYTE_PTR,
                                pulDigestLen: CK_ULONG_PTR) -> CK_RV;
    pub fn NSSCKFWC_SignInit(fwInstance: *mut NSSCKFWInstance,
                             hSession: CK_SESSION_HANDLE,
                             pMechanism: CK_MECHANISM_PTR,
                             hKey: CK_OBJECT_HANDLE) -> CK_RV;
    pub fn NSSCKFWC_Sign(fwInstance: *mut NSSCKFWInstance,
                         hSession: CK_SESSION_HANDLE, pData: CK_BYTE_PTR,
                         ulDataLen: CK_ULONG, pSignature: CK_BYTE_PTR,
                         pulSignatureLen: CK_ULONG_PTR) -> CK_RV;
    pub fn NSSCKFWC_SignUpdate(fwInstance: *mut NSSCKFWInstance,
                               hSession: CK_SESSION_HANDLE,
                               pPart: CK_BYTE_PTR, ulPartLen: CK_ULONG)
     -> CK_RV;
    pub fn NSSCKFWC_SignFinal(fwInstance: *mut NSSCKFWInstance,
                              hSession: CK_SESSION_HANDLE,
                              pSignature: CK_BYTE_PTR,
                              pulSignatureLen: CK_ULONG_PTR) -> CK_RV;
    pub fn NSSCKFWC_SignRecoverInit(fwInstance: *mut NSSCKFWInstance,
                                    hSession: CK_SESSION_HANDLE,
                                    pMechanism: CK_MECHANISM_PTR,
                                    hKey: CK_OBJECT_HANDLE) -> CK_RV;
    pub fn NSSCKFWC_SignRecover(fwInstance: *mut NSSCKFWInstance,
                                hSession: CK_SESSION_HANDLE,
                                pData: CK_BYTE_PTR, ulDataLen: CK_ULONG,
                                pSignature: CK_BYTE_PTR,
                                pulSignatureLen: CK_ULONG_PTR) -> CK_RV;
    pub fn NSSCKFWC_VerifyInit(fwInstance: *mut NSSCKFWInstance,
                               hSession: CK_SESSION_HANDLE,
                               pMechanism: CK_MECHANISM_PTR,
                               hKey: CK_OBJECT_HANDLE) -> CK_RV;
    pub fn NSSCKFWC_Verify(fwInstance: *mut NSSCKFWInstance,
                           hSession: CK_SESSION_HANDLE, pData: CK_BYTE_PTR,
                           ulDataLen: CK_ULONG, pSignature: CK_BYTE_PTR,
                           ulSignatureLen: CK_ULONG) -> CK_RV;
    pub fn NSSCKFWC_VerifyUpdate(fwInstance: *mut NSSCKFWInstance,
                                 hSession: CK_SESSION_HANDLE,
                                 pPart: CK_BYTE_PTR, ulPartLen: CK_ULONG)
     -> CK_RV;
    pub fn NSSCKFWC_VerifyFinal(fwInstance: *mut NSSCKFWInstance,
                                hSession: CK_SESSION_HANDLE,
                                pSignature: CK_BYTE_PTR,
                                ulSignatureLen: CK_ULONG) -> CK_RV;
    pub fn NSSCKFWC_VerifyRecoverInit(fwInstance: *mut NSSCKFWInstance,
                                      hSession: CK_SESSION_HANDLE,
                                      pMechanism: CK_MECHANISM_PTR,
                                      hKey: CK_OBJECT_HANDLE) -> CK_RV;
    pub fn NSSCKFWC_VerifyRecover(fwInstance: *mut NSSCKFWInstance,
                                  hSession: CK_SESSION_HANDLE,
                                  pSignature: CK_BYTE_PTR,
                                  ulSignatureLen: CK_ULONG,
                                  pData: CK_BYTE_PTR,
                                  pulDataLen: CK_ULONG_PTR) -> CK_RV;
    pub fn NSSCKFWC_DigestEncryptUpdate(fwInstance: *mut NSSCKFWInstance,
                                        hSession: CK_SESSION_HANDLE,
                                        pPart: CK_BYTE_PTR,
                                        ulPartLen: CK_ULONG,
                                        pEncryptedPart: CK_BYTE_PTR,
     ...
     -> CK_RV;
    pub fn NSSCKFWC_DecryptDigestUpdate(fwInstance: *mut NSSCKFWInstance,
                                        hSession: CK_SESSION_HANDLE,
                                        pEncryptedPart: CK_BYTE_PTR,
                                        ulEncryptedPartLen: CK_ULONG,
                                        pPart: CK_BYTE_PTR,
                                        pulPartLen: CK_ULONG_PTR) -> CK_RV;
    pub fn NSSCKFWC_SignEncryptUpdate(fwInstance: *mut NSSCKFWInstance,
                                      hSession: CK_SESSION_HANDLE,
                                      pPart: CK_BYTE_PTR, ulPartLen: CK_ULONG,
                                      pEncryptedPart: CK_BYTE_PTR,
                                      pulEncryptedPartLen: CK_ULONG_PTR)
     -> CK_RV;
    pub fn NSSCKFWC_DecryptVerifyUpdate(fwInstance: *mut NSSCKFWInstance,
                                        hSession: CK_SESSION_HANDLE,
                                        pEncryptedPart: CK_BYTE_PTR,
                                        ulEncryptedPartLen: CK_ULONG,
                                        pPart: CK_BYTE_PTR,
                                        pulPartLen: CK_ULONG_PTR) -> CK_RV;
    pub fn NSSCKFWC_GenerateKey(fwInstance: *mut NSSCKFWInstance,
                                hSession: CK_SESSION_HANDLE,
                                pMechanism: CK_MECHANISM_PTR,
                                pTemplate: CK_ATTRIBUTE_PTR,
                                ulCount: CK_ULONG,
                                phKey: CK_OBJECT_HANDLE_PTR) -> CK_RV;
    pub fn NSSCKFWC_GenerateKeyPair(fwInstance: *mut NSSCKFWInstance,
                                    hSession: CK_SESSION_HANDLE,
                                    pMechanism: CK_MECHANISM_PTR,
     ...
     -> CK_RV;
    pub fn NSSCKFWC_WrapKey(fwInstance: *mut NSSCKFWInstance,
                            hSession: CK_SESSION_HANDLE,
                            pMechanism: CK_MECHANISM_PTR,
                            hWrappingKey: CK_OBJECT_HANDLE,
                            hKey: CK_OBJECT_HANDLE, pWrappedKey: CK_BYTE_PTR,
                            pulWrappedKeyLen: CK_ULONG_PTR) -> CK_RV;
    pub fn NSSCKFWC_UnwrapKey(fwInstance: *mut NSSCKFWInstance,
                              hSession: CK_SESSION_HANDLE,
                              pMechanism: CK_MECHANISM_PTR,
                              ...
                              phKey: CK_OBJECT_HANDLE_PTR) -> CK_RV;
    pub fn NSSCKFWC_DeriveKey(fwInstance: *mut NSSCKFWInstance,
                              hSession: CK_SESSION_HANDLE,
                              pMechanism: CK_MECHANISM_PTR,
                              ...
                              ulAttributeCount: CK_ULONG,
                              phKey: CK_OBJECT_HANDLE_PTR) -> CK_RV;
    pub fn NSSCKFWC_SeedRandom(fwInstance: *mut NSSCKFWInstance,
                               hSession: CK_SESSION_HANDLE,
                               pSeed: CK_BYTE_PTR, ulSeedLen: CK_ULONG)
     -> CK_RV;
    pub fn NSSCKFWC_GenerateRandom(fwInstance: *mut NSSCKFWInstance,
                                   hSession: CK_SESSION_HANDLE,
                                   pRandomData: CK_BYTE_PTR,
                                   ulRandomLen: CK_ULONG) -> CK_RV;
    pub fn NSSCKFWC_GetFunctionStatus(fwInstance: *mut NSSCKFWInstance,
                                      hSession: CK_SESSION_HANDLE) -> CK_RV;
    pub fn NSSCKFWC_CancelFunction(fwInstance: *mut NSSCKFWInstance,
                                   hSession: CK_SESSION_HANDLE) -> CK_RV;
}
