...
extern "C" {
    ...
    pub fn NSS_Get_SECKEY_PointerToPrivateKeyInfoTemplate(arg:
                                                          ...
                                                          enc: PRBool)
     -> *const SEC_ASN1Template;
    pub fn SECMOD_LoadModule(moduleSpec: *mut ::std::os::raw::c_char,
                             parent: *mut SECMODModule, recurse: PRBool)
     -> *mut SECMODModule;
    pub fn SECMOD_LoadUserModule(moduleSpec: *mut ::std::os::raw::c_char,
                                 parent: *mut SECMODModule, recurse: PRBool)
     -> *mut SECMODModule;
    pub fn SECMOD_UnloadUserModule(mod_: *mut SECMODModule) -> SECStatus;
    pub fn SECMOD_CreateModule(lib: *const ::std::os::raw::c_char,
                               name: *const ::std::os::raw::c_char,
                               param: *const ::std::os::raw::c_char,
                               nss: *const ::std::os::raw::c_char)
     -> *mut SECMODModule;
    pub fn SECMOD_CreateModuleEx(lib: *const ::std::os::raw::c_char,
                                 name: *const ::std::os::raw::c_char,
                                 param: *const ::std::os::raw::c_char,
                                 nss: *const ::std::os::raw::c_char,
                                 config: *const ::std::os::raw::c_char)
     -> *mut SECMODModule;
    pub fn SECMOD_RestartModules(force: PRBool) -> SECStatus;
    pub fn SECMOD_GetModuleSpecList(module: *mut SECMODModule)
     -> *mut *mut ::std::os::raw::c_char;
    pub fn SECMOD_FreeModuleSpecList(module: *mut SECMODModule,
                                     moduleSpecList:
                                         *mut *mut ::std::os::raw::c_char)
     -> SECStatus;
    pub fn SECMOD_GetDefaultModuleList() -> *mut SECMODModuleList;
    pub fn SECMOD_GetDeadModuleList() -> *mut SECMODModuleList;
    pub fn SECMOD_GetDBModuleList() -> *mut SECMODModuleList;
    pub fn SECMOD_GetDefaultModuleListLock() -> *mut SECMODListLock;
    pub fn SECMOD_UpdateModule(module: *mut SECMODModule) -> SECStatus;
    pub fn SECMOD_GetReadLock(arg1: *mut SECMODListLock);
    pub fn SECMOD_ReleaseReadLock(arg1: *mut SECMODListLock);
    pub fn SECMOD_FindModule(name: *const ::std::os::raw::c_char)
     -> *mut SECMODModule;
    pub fn SECMOD_DeleteModule(name: *const ::std::os::raw::c_char,
                               type_: *mut ::std::os::raw::c_int)
     -> SECStatus;
    pub fn SECMOD_DeleteModuleEx(name: *const ::std::os::raw::c_char,
                                 mod_: *mut SECMODModule,
                                 type_: *mut ::std::os::raw::c_int,
                                 permdb: PRBool) -> SECStatus;
    pub fn SECMOD_DeleteInternalModule(name: *const ::std::os::raw::c_char)
     -> SECStatus;
    pub fn SECMOD_CanDeleteInternalModule() -> PRBool;
    pub fn SECMOD_AddNewModule(moduleName: *const ::std::os::raw::c_char,
                               dllPath: *const ::std::os::raw::c_char,
                               defaultMechanismFlags: ::std::os::raw::c_ulong,
                               cipherEnableFlags: ::std::os::raw::c_ulong)
     -> SECStatus;
    pub fn SECMOD_AddNewModuleEx(moduleName: *const ::std::os::raw::c_char,
                                 dllPath: *const ::std::os::raw::c_char,
                                 defaultMechanismFlags:
                                     ::std::os::raw::c_ulong,
                                 cipherEnableFlags: ::std::os::raw::c_ulong,
                                 modparms: *mut ::std::os::raw::c_char,
                                 nssparms: *mut ::std::os::raw::c_char)
     -> SECStatus;
    pub fn SECMOD_GetInternalModule() -> *mut SECMODModule;
    pub fn SECMOD_ReferenceModule(module: *mut SECMODModule)
     -> *mut SECMODModule;
    pub fn SECMOD_DestroyModule(module: *mut SECMODModule);
    pub fn SECMOD_LookupSlot(module: SECMODModuleID,
                             slotID: ::std::os::raw::c_ulong)
     -> *mut PK11SlotInfo;
    pub fn SECMOD_FindSlot(module: *mut SECMODModule,
                           name: *const ::std::os::raw::c_char)
     -> *mut PK11SlotInfo;
    pub fn SECMOD_IsModulePresent(pubCipherEnableFlags:
                                      ::std::os::raw::c_ulong) -> PRBool;
    pub fn SECMOD_GetSkipFirstFlag(mod_: *mut SECMODModule) -> PRBool;
    pub fn SECMOD_GetDefaultModDBFlag(mod_: *mut SECMODModule) -> PRBool;
    pub fn SECMOD_PubMechFlagstoInternal(publicFlags: ::std::os::raw::c_ulong)
     -> ::std::os::raw::c_ulong;
    pub fn SECMOD_InternaltoPubMechFlags(internalFlags:
                                             ::std::os::raw::c_ulong)
     -> ::std::os::raw::c_ulong;
    pub fn SECMOD_PubCipherFlagstoInternal(publicFlags:
                                               ::std::os::raw::c_ulong)
     -> ::std::os::raw::c_ulong;
    pub fn SECMOD_HasRemovableSlots(mod_: *mut SECMODModule) -> PRBool;
    pub fn SECMOD_WaitForAnyTokenEvent(mod_: *mut SECMODModule,
                                       flags: ::std::os::raw::c_ulong,
                                       latency: PRIntervalTime)
     -> *mut PK11SlotInfo;
    pub fn SECMOD_CancelWait(mod_: *mut SECMODModule) -> SECStatus;
    pub fn SECMOD_UpdateSlotList(mod_: *mut SECMODModule) -> SECStatus;
}
