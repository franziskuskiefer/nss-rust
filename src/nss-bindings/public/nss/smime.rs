...
#[repr(u32)]
#[derive(Debug)]
pub enum Enum_Unnamed11 { SCM_RIGHTS = 1, }
#[repr(C)]
#[derive(Copy, Clone)]
#[derive(Debug)]
pub struct linger {
...
#[repr(u32)]
#[derive(Debug)]
pub enum Enum_Unnamed12 { SHUT_RD = 0, SHUT_WR = 1, SHUT_RDWR = 2, }
pub type uint8_t = u8;
...
pub const IPPORT_BIFFUDP: Enum_Unnamed15 = Enum_Unnamed15::IPPORT_EXECSERVER;
pub const IPPORT_WHOSERVER: Enum_Unnamed15 =
    Enum_Unnamed15::IPPORT_LOGINSERVER;
pub const IPPORT_ROUTESERVER: Enum_Unnamed15 =
    Enum_Unnamed15::IPPORT_EFSSERVER;
#[derive(Copy, Clone)]
#[repr(u32)]
#[derive(Debug)]
...
impl PRNetAddr {
    pub unsafe fn raw(&mut self) -> *mut Struct_Unnamed18 {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_);
        ::std::mem::transmute(raw.offset(0))
    }
    pub unsafe fn inet(&mut self) -> *mut Struct_Unnamed19 {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_);
        ::std::mem::transmute(raw.offset(0))
    }
    pub unsafe fn ipv6(&mut self) -> *mut Struct_Unnamed20 {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_);
        ::std::mem::transmute(raw.offset(0))
    }
    pub unsafe fn local(&mut self) -> *mut Struct_Unnamed21 {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_);
        ::std::mem::transmute(raw.offset(0))
    }
}
...
impl Union_Unnamed23 {
    ...
    pub unsafe fn bits(&mut self) -> *mut Struct_Unnamed24 {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_);
        ::std::mem::transmute(raw.offset(0))
    }
}
...
pub struct CERTValParamInValueStr {
    pub scalar: Union_Unnamed27,
    pub pointer: Union_Unnamed28,
    pub array: Union_Unnamed29,
...
pub struct CERTValParamOutValueStr {
    pub scalar: Union_Unnamed30,
    pub pointer: Union_Unnamed31,
    pub array: Union_Unnamed32,
    pub arraySize: ::std::os::raw::c_int,
    _bindgen_padding_0_: [u8; 4usize],
}
...
pub type NSSCMSMessage = NSSCMSMessageStr;
pub type NSSCMSContent = NSSCMSContentUnion;
pub type NSSCMSContentInfo = NSSCMSContentInfoStr;
pub type NSSCMSSignedData = NSSCMSSignedDataStr;
pub type NSSCMSSignerInfo = NSSCMSSignerInfoStr;
pub type NSSCMSSignerIdentifier = NSSCMSSignerIdentifierStr;
pub type NSSCMSEnvelopedData = NSSCMSEnvelopedDataStr;
pub type NSSCMSOriginatorInfo = NSSCMSOriginatorInfoStr;
pub type NSSCMSRecipientInfo = NSSCMSRecipientInfoStr;
pub type NSSCMSDigestedData = NSSCMSDigestedDataStr;
pub type NSSCMSEncryptedData = NSSCMSEncryptedDataStr;
pub type NSSCMSGenericWrapperData = NSSCMSGenericWrapperDataStr;
pub type NSSCMSAttribute = NSSCMSAttributeStr;
pub enum NSSCMSDecoderContextStr { }
pub type NSSCMSDecoderContext = NSSCMSDecoderContextStr;
pub enum NSSCMSEncoderContextStr { }
pub type NSSCMSEncoderContext = NSSCMSEncoderContextStr;
pub enum NSSCMSCipherContextStr { }
pub type NSSCMSCipherContext = NSSCMSCipherContextStr;
pub enum NSSCMSDigestContextStr { }
pub type NSSCMSDigestContext = NSSCMSDigestContextStr;
pub enum NSSCMSContentInfoPrivateStr { }
pub type NSSCMSContentInfoPrivate = NSSCMSContentInfoPrivateStr;
pub type NSSCMSGenericWrapperDataCallback =
    ::std::option::Option<unsafe extern "C" fn(arg1:
                                                   *mut NSSCMSGenericWrapperData)
                              -> SECStatus>;
pub type NSSCMSGenericWrapperDataDestroy =
    ::std::option::Option<unsafe extern "C" fn(arg1:
                                                   *mut NSSCMSGenericWrapperData)>;
pub type NSSCMSContentCallback =
    ::std::option::Option<unsafe extern "C" fn(arg:
                                                   *mut ::std::os::raw::c_void,
                                               buf:
                                                   *const ::std::os::raw::c_char,
                                               len: ::std::os::raw::c_ulong)>;
pub type NSSCMSGetDecryptKeyCallback =
    ::std::option::Option<unsafe extern "C" fn(arg:
                                                   *mut ::std::os::raw::c_void,
...
#[derive(Copy, Clone)]
#[derive(Debug)]
pub struct NSSCMSContentUnion {
    pub _bindgen_data_: [u64; 1usize],
}
impl NSSCMSContentUnion {
    pub unsafe fn data(&mut self) -> *mut *mut SECItem {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_);
        ::std::mem::transmute(raw.offset(0))
    }
    pub unsafe fn digestedData(&mut self) -> *mut *mut NSSCMSDigestedData {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_);
        ::std::mem::transmute(raw.offset(0))
    }
    pub unsafe fn encryptedData(&mut self) -> *mut *mut NSSCMSEncryptedData {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_);
        ::std::mem::transmute(raw.offset(0))
    }
    pub unsafe fn envelopedData(&mut self) -> *mut *mut NSSCMSEnvelopedData {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_);
        ::std::mem::transmute(raw.offset(0))
    }
    pub unsafe fn signedData(&mut self) -> *mut *mut NSSCMSSignedData {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_);
        ::std::mem::transmute(raw.offset(0))
    }
    pub unsafe fn genericData(&mut self)
     -> *mut *mut NSSCMSGenericWrapperData {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_);
        ::std::mem::transmute(raw.offset(0))
    }
...
impl ::std::default::Default for NSSCMSContentUnion {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
#[repr(C)]
#[derive(Copy, Clone)]
#[derive(Debug)]
pub struct NSSCMSContentInfoStr {
    pub contentType: SECItem,
    pub content: NSSCMSContent,
    pub contentTypeTag: *mut SECOidData,
    pub contentEncAlg: SECAlgorithmID,
    pub rawContent: *mut SECItem,
    pub bulkkey: *mut PK11SymKey,
    pub keysize: ::std::os::raw::c_int,
    pub contentEncAlgTag: SECOidTag,
    pub privateInfo: *mut NSSCMSContentInfoPrivate,
    pub reserved: *mut ::std::os::raw::c_void,
}
impl ::std::default::Default for NSSCMSContentInfoStr {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
#[repr(C)]
#[derive(Copy, Clone)]
#[derive(Debug)]
pub struct NSSCMSMessageStr {
    pub contentInfo: NSSCMSContentInfo,
    pub poolp: *mut PLArenaPool,
    pub poolp_is_ours: PRBool,
    pub refCount: ::std::os::raw::c_int,
    pub detached_digestalgs: *mut *mut SECAlgorithmID,
    pub detached_digests: *mut *mut SECItem,
    pub pwfn_arg: *mut ::std::os::raw::c_void,
    pub decrypt_key_cb: NSSCMSGetDecryptKeyCallback,
    pub decrypt_key_cb_arg: *mut ::std::os::raw::c_void,
}
impl ::std::default::Default for NSSCMSMessageStr {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
#[repr(C)]
#[derive(Copy, Clone)]
#[derive(Debug)]
pub struct NSSCMSGenericWrapperDataStr {
    pub contentInfo: NSSCMSContentInfo,
    pub cmsg: *mut NSSCMSMessage,
}
impl ::std::default::Default for NSSCMSGenericWrapperDataStr {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
#[repr(C)]
#[derive(Copy, Clone)]
#[derive(Debug)]
pub struct NSSCMSSignedDataStr {
    pub version: SECItem,
    pub digestAlgorithms: *mut *mut SECAlgorithmID,
    pub contentInfo: NSSCMSContentInfo,
    pub rawCerts: *mut *mut SECItem,
    pub crls: *mut *mut CERTSignedCrl,
    pub signerInfos: *mut *mut NSSCMSSignerInfo,
    pub cmsg: *mut NSSCMSMessage,
    pub digests: *mut *mut SECItem,
    pub certs: *mut *mut CERTCertificate,
    pub certLists: *mut *mut CERTCertificateList,
    pub tempCerts: *mut *mut CERTCertificate,
}
impl ::std::default::Default for NSSCMSSignedDataStr {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
#[derive(Copy, Clone)]
#[repr(u32)]
#[derive(Debug)]
pub enum NSSCMSVerificationStatus {
...
#[repr(u32)]
#[derive(Debug)]
pub enum NSSCMSSignerIDSelector {
...
#[derive(Copy, Clone)]
#[derive(Debug)]
pub struct NSSCMSSignerIdentifierStr {
    pub identifierType: NSSCMSSignerIDSelector,
    pub id: Union_Unnamed34,
}
impl ::std::default::Default for NSSCMSSignerIdentifierStr {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
#[repr(C)]
#[derive(Copy, Clone)]
...
#[derive(Copy, Clone)]
#[derive(Debug)]
pub struct NSSCMSSignerInfoStr {
    pub version: SECItem,
    pub signerIdentifier: NSSCMSSignerIdentifier,
    pub digestAlg: SECAlgorithmID,
    pub authAttr: *mut *mut NSSCMSAttribute,
    pub digestEncAlg: SECAlgorithmID,
    pub encDigest: SECItem,
    pub unAuthAttr: *mut *mut NSSCMSAttribute,
    pub cmsg: *mut NSSCMSMessage,
    pub cert: *mut CERTCertificate,
    pub certList: *mut CERTCertificateList,
    pub signingTime: PRTime,
    pub verificationStatus: NSSCMSVerificationStatus,
    pub signingKey: *mut SECKEYPrivateKey,
    pub pubKey: *mut SECKEYPublicKey,
}
impl ::std::default::Default for NSSCMSSignerInfoStr {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
#[derive(Copy, Clone)]
#[repr(u32)]
#[derive(Debug)]
pub enum NSSCMSCertChainMode {
    NSSCMSCM_None = 0,
    NSSCMSCM_CertOnly = 1,
...
#[derive(Copy, Clone)]
#[derive(Debug)]
pub struct NSSCMSEnvelopedDataStr {
    pub version: SECItem,
    pub originatorInfo: *mut NSSCMSOriginatorInfo,
    pub recipientInfos: *mut *mut NSSCMSRecipientInfo,
    pub contentInfo: NSSCMSContentInfo,
    pub unprotectedAttr: *mut *mut NSSCMSAttribute,
    pub cmsg: *mut NSSCMSMessage,
}
impl ::std::default::Default for NSSCMSEnvelopedDataStr {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
#[repr(C)]
#[derive(Copy, Clone)]
#[derive(Debug)]
pub struct NSSCMSOriginatorInfoStr {
    pub rawCerts: *mut *mut SECItem,
    pub crls: *mut *mut CERTSignedCrl,
    pub certs: *mut *mut CERTCertificate,
}
impl ::std::default::Default for NSSCMSOriginatorInfoStr {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
#[derive(Copy, Clone)]
#[repr(u32)]
#[derive(Debug)]
pub enum NSSCMSRecipientIDSelector {
...
#[derive(Copy, Clone)]
#[derive(Debug)]
pub struct NSSCMSRecipientIdentifierStr {
    pub identifierType: NSSCMSRecipientIDSelector,
    pub id: Union_Unnamed35,
}
impl ::std::default::Default for NSSCMSRecipientIdentifierStr {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
#[repr(C)]
#[derive(Copy, Clone)]
...
pub type NSSCMSRecipientIdentifier = NSSCMSRecipientIdentifierStr;
#[repr(C)]
#[derive(Copy, Clone)]
#[derive(Debug)]
pub struct NSSCMSKeyTransRecipientInfoStr {
    pub version: SECItem,
    pub recipientIdentifier: NSSCMSRecipientIdentifier,
    pub keyEncAlg: SECAlgorithmID,
    pub encKey: SECItem,
}
impl ::std::default::Default for NSSCMSKeyTransRecipientInfoStr {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
pub type NSSCMSKeyTransRecipientInfo = NSSCMSKeyTransRecipientInfoStr;
#[repr(C)]
#[derive(Copy, Clone)]
#[derive(Debug)]
pub struct NSSCMSKeyTransRecipientInfoExStr {
    pub recipientInfo: NSSCMSKeyTransRecipientInfo,
    pub version: ::std::os::raw::c_int,
    pub pubKey: *mut SECKEYPublicKey,
}
impl ::std::default::Default for NSSCMSKeyTransRecipientInfoExStr {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
pub type NSSCMSKeyTransRecipientInfoEx = NSSCMSKeyTransRecipientInfoExStr;
#[repr(C)]
#[derive(Copy, Clone)]
#[derive(Debug)]
pub struct NSSCMSOriginatorPublicKeyStr {
    pub algorithmIdentifier: SECAlgorithmID,
    pub publicKey: SECItem,
}
impl ::std::default::Default for NSSCMSOriginatorPublicKeyStr {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
pub type NSSCMSOriginatorPublicKey = NSSCMSOriginatorPublicKeyStr;
#[derive(Copy, Clone)]
#[repr(u32)]
#[derive(Debug)]
pub enum NSSCMSOriginatorIDOrKeySelector {
...
#[derive(Copy, Clone)]
#[derive(Debug)]
pub struct NSSCMSOriginatorIdentifierOrKeyStr {
    pub identifierType: NSSCMSOriginatorIDOrKeySelector,
    pub id: Union_Unnamed36,
}
impl ::std::default::Default for NSSCMSOriginatorIdentifierOrKeyStr {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
#[repr(C)]
#[derive(Copy, Clone)]
...
impl Union_Unnamed36 {
    ...
    pub unsafe fn originatorPublicKey(&mut self)
     -> *mut NSSCMSOriginatorPublicKey {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_);
        ::std::mem::transmute(raw.offset(0))
    }
}
...
pub type NSSCMSOriginatorIdentifierOrKey = NSSCMSOriginatorIdentifierOrKeyStr;
#[repr(C)]
#[derive(Copy, Clone)]
#[derive(Debug)]
pub struct NSSCMSRecipientKeyIdentifierStr {
    pub subjectKeyIdentifier: *mut SECItem,
    pub date: *mut SECItem,
    pub other: *mut SECItem,
}
impl ::std::default::Default for NSSCMSRecipientKeyIdentifierStr {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
pub type NSSCMSRecipientKeyIdentifier = NSSCMSRecipientKeyIdentifierStr;
#[derive(Copy, Clone)]
#[repr(u32)]
#[derive(Debug)]
pub enum NSSCMSKeyAgreeRecipientIDSelector {
...
#[derive(Copy, Clone)]
#[derive(Debug)]
pub struct NSSCMSKeyAgreeRecipientIdentifierStr {
    pub identifierType: NSSCMSKeyAgreeRecipientIDSelector,
    pub id: Union_Unnamed37,
}
impl ::std::default::Default for NSSCMSKeyAgreeRecipientIdentifierStr {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
#[repr(C)]
#[derive(Copy, Clone)]
...
impl Union_Unnamed37 {
    ...
    pub unsafe fn recipientKeyIdentifier(&mut self)
     -> *mut NSSCMSRecipientKeyIdentifier {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_);
        ::std::mem::transmute(raw.offset(0))
    }
}
...
pub type NSSCMSKeyAgreeRecipientIdentifier =
    NSSCMSKeyAgreeRecipientIdentifierStr;
#[repr(C)]
#[derive(Copy, Clone)]
#[derive(Debug)]
pub struct NSSCMSRecipientEncryptedKeyStr {
    pub recipientIdentifier: NSSCMSKeyAgreeRecipientIdentifier,
    pub encKey: SECItem,
}
impl ::std::default::Default for NSSCMSRecipientEncryptedKeyStr {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
pub type NSSCMSRecipientEncryptedKey = NSSCMSRecipientEncryptedKeyStr;
#[repr(C)]
#[derive(Copy, Clone)]
#[derive(Debug)]
pub struct NSSCMSKeyAgreeRecipientInfoStr {
    pub version: SECItem,
    pub originatorIdentifierOrKey: NSSCMSOriginatorIdentifierOrKey,
    pub ukm: *mut SECItem,
    pub keyEncAlg: SECAlgorithmID,
    pub recipientEncryptedKeys: *mut *mut NSSCMSRecipientEncryptedKey,
}
impl ::std::default::Default for NSSCMSKeyAgreeRecipientInfoStr {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
pub type NSSCMSKeyAgreeRecipientInfo = NSSCMSKeyAgreeRecipientInfoStr;
#[repr(C)]
#[derive(Copy, Clone)]
#[derive(Debug)]
pub struct NSSCMSKEKIdentifierStr {
    pub keyIdentifier: SECItem,
    pub date: *mut SECItem,
    pub other: *mut SECItem,
}
impl ::std::default::Default for NSSCMSKEKIdentifierStr {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
pub type NSSCMSKEKIdentifier = NSSCMSKEKIdentifierStr;
#[repr(C)]
#[derive(Copy, Clone)]
#[derive(Debug)]
pub struct NSSCMSKEKRecipientInfoStr {
    pub version: SECItem,
    pub kekIdentifier: NSSCMSKEKIdentifier,
    pub keyEncAlg: SECAlgorithmID,
    pub encKey: SECItem,
}
impl ::std::default::Default for NSSCMSKEKRecipientInfoStr {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
pub type NSSCMSKEKRecipientInfo = NSSCMSKEKRecipientInfoStr;
#[derive(Copy, Clone)]
#[repr(u32)]
#[derive(Debug)]
pub enum NSSCMSRecipientInfoIDSelector {
...
#[derive(Copy, Clone)]
#[derive(Debug)]
pub struct NSSCMSRecipientInfoStr {
    pub recipientInfoType: NSSCMSRecipientInfoIDSelector,
    pub ri: Union_Unnamed38,
    pub cmsg: *mut NSSCMSMessage,
    pub cert: *mut CERTCertificate,
}
impl ::std::default::Default for NSSCMSRecipientInfoStr {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
#[repr(C)]
#[derive(Copy, Clone)]
...
impl Union_Unnamed38 {
    pub unsafe fn keyTransRecipientInfo(&mut self)
     -> *mut NSSCMSKeyTransRecipientInfo {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_);
        ::std::mem::transmute(raw.offset(0))
    }
    pub unsafe fn keyAgreeRecipientInfo(&mut self)
     -> *mut NSSCMSKeyAgreeRecipientInfo {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_);
        ::std::mem::transmute(raw.offset(0))
    }
    pub unsafe fn kekRecipientInfo(&mut self) -> *mut NSSCMSKEKRecipientInfo {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_);
        ::std::mem::transmute(raw.offset(0))
    }
    pub unsafe fn keyTransRecipientInfoEx(&mut self)
     -> *mut NSSCMSKeyTransRecipientInfoEx {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_);
        ::std::mem::transmute(raw.offset(0))
    }
}
...
#[derive(Copy, Clone)]
#[derive(Debug)]
pub struct NSSCMSDigestedDataStr {
    pub version: SECItem,
    pub digestAlg: SECAlgorithmID,
    pub contentInfo: NSSCMSContentInfo,
    pub digest: SECItem,
...
impl ::std::default::Default for NSSCMSDigestedDataStr {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
#[repr(C)]
#[derive(Copy, Clone)]
#[derive(Debug)]
pub struct NSSCMSEncryptedDataStr {
    pub version: SECItem,
    pub contentInfo: NSSCMSContentInfo,
    pub unprotectedAttr: *mut *mut NSSCMSAttribute,
    pub cmsg: *mut NSSCMSMessage,
}
impl ::std::default::Default for NSSCMSEncryptedDataStr {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
#[repr(C)]
#[derive(Copy, Clone)]
#[derive(Debug)]
pub struct NSSCMSAttributeStr {
    pub type_: SECItem,
...
impl ::std::default::Default for NSSCMSAttributeStr {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
...
extern "C" {
    ...
    pub static mut SECKEY_DSAPrivateKeyExportTemplate:
               [SEC_ASN1Template; 0usize];
    pub static mut NSSCMSGenericWrapperDataTemplate:
               [SEC_ASN1Template; 0usize];
    pub static mut NSS_PointerToCMSGenericWrapperDataTemplate:
               [SEC_ASN1Template; 0usize];
}
extern "C" {
    ...
    pub fn NSS_Get_SECKEY_RSAPSSParamsTemplate(arg:
                                               ...
                                               enc: PRBool)
     -> *const SEC_ASN1Template;
    pub fn NSS_Get_NSS_PointerToCMSGenericWrapperDataTemplate(arg:
                                                                  *mut ::std::os::raw::c_void,
                                                              enc: PRBool)
     -> *const SEC_ASN1Template;
    pub fn NSS_Get_NSSCMSGenericWrapperDataTemplate(arg:
                                                        *mut ::std::os::raw::c_void,
                                                    enc: PRBool)
     -> *const SEC_ASN1Template;
    pub fn NSS_CMSDecoder_Start(poolp: *mut PLArenaPool,
                                cb: NSSCMSContentCallback,
                                cb_arg: *mut ::std::os::raw::c_void,
                                pwfn: PK11PasswordFunc,
                                pwfn_arg: *mut ::std::os::raw::c_void,
                                decrypt_key_cb: NSSCMSGetDecryptKeyCallback,
                                decrypt_key_cb_arg:
                                    *mut ::std::os::raw::c_void)
     -> *mut NSSCMSDecoderContext;
    pub fn NSS_CMSDecoder_Update(p7dcx: *mut NSSCMSDecoderContext,
                                 buf: *const ::std::os::raw::c_char,
                                 len: ::std::os::raw::c_ulong) -> SECStatus;
    pub fn NSS_CMSDecoder_Cancel(p7dcx: *mut NSSCMSDecoderContext);
    pub fn NSS_CMSDecoder_Finish(p7dcx: *mut NSSCMSDecoderContext)
     -> *mut NSSCMSMessage;
    pub fn NSS_CMSMessage_CreateFromDER(DERmessage: *mut SECItem,
                                        cb: NSSCMSContentCallback,
                                        cb_arg: *mut ::std::os::raw::c_void,
                                        pwfn: PK11PasswordFunc,
                                        pwfn_arg: *mut ::std::os::raw::c_void,
                                        ...
                                        decrypt_key_cb_arg:
                                            *mut ::std::os::raw::c_void)
     -> *mut NSSCMSMessage;
    pub fn NSS_CMSEncoder_Start(cmsg: *mut NSSCMSMessage,
                                outputfn: NSSCMSContentCallback,
                                outputarg: *mut ::std::os::raw::c_void,
                                dest: *mut SECItem,
                                destpoolp: *mut PLArenaPool,
                                pwfn: PK11PasswordFunc,
                                pwfn_arg: *mut ::std::os::raw::c_void,
                                decrypt_key_cb: NSSCMSGetDecryptKeyCallback,
                                decrypt_key_cb_arg:
                                    *mut ::std::os::raw::c_void,
                                detached_digestalgs: *mut *mut SECAlgorithmID,
                                detached_digests: *mut *mut SECItem)
     -> *mut NSSCMSEncoderContext;
    pub fn NSS_CMSEncoder_Update(p7ecx: *mut NSSCMSEncoderContext,
                                 data: *const ::std::os::raw::c_char,
                                 len: ::std::os::raw::c_ulong) -> SECStatus;
    pub fn NSS_CMSEncoder_Cancel(p7ecx: *mut NSSCMSEncoderContext)
     -> SECStatus;
    pub fn NSS_CMSEncoder_Finish(p7ecx: *mut NSSCMSEncoderContext)
     -> SECStatus;
    pub fn NSS_CMSMessage_Create(poolp: *mut PLArenaPool)
     -> *mut NSSCMSMessage;
    pub fn NSS_CMSMessage_SetEncodingParams(cmsg: *mut NSSCMSMessage,
                                            pwfn: PK11PasswordFunc,
                                            pwfn_arg:
                                                *mut ::std::os::raw::c_void,
                                            decrypt_key_cb:
                                            ...
                                            decrypt_key_cb_arg:
                                                *mut ::std::os::raw::c_void,
                                            detached_digestalgs:
                                                *mut *mut SECAlgorithmID,
                                            detached_digests:
                                                *mut *mut SECItem);
    pub fn NSS_CMSMessage_Destroy(cmsg: *mut NSSCMSMessage);
    pub fn NSS_CMSMessage_Copy(cmsg: *mut NSSCMSMessage)
     -> *mut NSSCMSMessage;
    pub fn NSS_CMSMessage_GetArena(cmsg: *mut NSSCMSMessage)
     -> *mut PLArenaPool;
    pub fn NSS_CMSMessage_GetContentInfo(cmsg: *mut NSSCMSMessage)
     -> *mut NSSCMSContentInfo;
    pub fn NSS_CMSMessage_GetContent(cmsg: *mut NSSCMSMessage)
     -> *mut SECItem;
    pub fn NSS_CMSMessage_ContentLevelCount(cmsg: *mut NSSCMSMessage)
     -> ::std::os::raw::c_int;
    pub fn NSS_CMSMessage_ContentLevel(cmsg: *mut NSSCMSMessage,
                                       n: ::std::os::raw::c_int)
     -> *mut NSSCMSContentInfo;
    pub fn NSS_CMSMessage_ContainsCertsOrCrls(cmsg: *mut NSSCMSMessage)
     -> PRBool;
    pub fn NSS_CMSMessage_IsEncrypted(cmsg: *mut NSSCMSMessage) -> PRBool;
    pub fn NSS_CMSMessage_IsSigned(cmsg: *mut NSSCMSMessage) -> PRBool;
    pub fn NSS_CMSMessage_IsContentEmpty(cmsg: *mut NSSCMSMessage,
                                         minLen: ::std::os::raw::c_uint)
     -> PRBool;
    pub fn NSS_CMSContentInfo_Destroy(cinfo: *mut NSSCMSContentInfo);
    pub fn NSS_CMSContentInfo_GetChildContentInfo(cinfo:
                                                      *mut NSSCMSContentInfo)
     -> *mut NSSCMSContentInfo;
    pub fn NSS_CMSContentInfo_SetContent(cmsg: *mut NSSCMSMessage,
                                         cinfo: *mut NSSCMSContentInfo,
                                         type_: SECOidTag,
                                         ptr: *mut ::std::os::raw::c_void)
     -> SECStatus;
    pub fn NSS_CMSContentInfo_SetContent_Data(cmsg: *mut NSSCMSMessage,
                                              cinfo: *mut NSSCMSContentInfo,
                                              data: *mut SECItem,
                                              detached: PRBool) -> SECStatus;
    pub fn NSS_CMSContentInfo_SetContent_SignedData(cmsg: *mut NSSCMSMessage,
                                                    cinfo:
                                                        *mut NSSCMSContentInfo,
                                                    sigd:
                                                        *mut NSSCMSSignedData)
     -> SECStatus;
    pub fn NSS_CMSContentInfo_SetContent_EnvelopedData(cmsg:
                                                           *mut NSSCMSMessage,
                                                       cinfo:
                                                           *mut NSSCMSContentInfo,
                                                       envd:
                                                           *mut NSSCMSEnvelopedData)
     -> SECStatus;
    pub fn NSS_CMSContentInfo_SetContent_DigestedData(cmsg:
                                                          *mut NSSCMSMessage,
                                                      cinfo:
                                                          *mut NSSCMSContentInfo,
                                                      digd:
                                                          *mut NSSCMSDigestedData)
     -> SECStatus;
    pub fn NSS_CMSContentInfo_SetContent_EncryptedData(cmsg:
                                                           *mut NSSCMSMessage,
                                                       cinfo:
                                                           *mut NSSCMSContentInfo,
                                                       encd:
                                                           *mut NSSCMSEncryptedData)
     -> SECStatus;
    pub fn NSS_CMSContentInfo_SetDontStream(cinfo: *mut NSSCMSContentInfo,
                                            dontStream: PRBool) -> SECStatus;
    pub fn NSS_CMSContentInfo_GetContent(cinfo: *mut NSSCMSContentInfo)
     -> *mut ::std::os::raw::c_void;
    pub fn NSS_CMSContentInfo_GetInnerContent(cinfo: *mut NSSCMSContentInfo)
     -> *mut SECItem;
    pub fn NSS_CMSContentInfo_GetContentTypeTag(cinfo: *mut NSSCMSContentInfo)
     -> SECOidTag;
    pub fn NSS_CMSContentInfo_GetContentTypeOID(cinfo: *mut NSSCMSContentInfo)
     -> *mut SECItem;
    pub fn NSS_CMSContentInfo_GetContentEncAlgTag(cinfo:
                                                      *mut NSSCMSContentInfo)
     -> SECOidTag;
    pub fn NSS_CMSContentInfo_GetContentEncAlg(cinfo: *mut NSSCMSContentInfo)
     -> *mut SECAlgorithmID;
    pub fn NSS_CMSContentInfo_SetContentEncAlg(poolp: *mut PLArenaPool,
                                               cinfo: *mut NSSCMSContentInfo,
                                               bulkalgtag: SECOidTag,
                                               parameters: *mut SECItem,
                                               keysize: ::std::os::raw::c_int)
     -> SECStatus;
    pub fn NSS_CMSContentInfo_SetContentEncAlgID(poolp: *mut PLArenaPool,
                                                 cinfo:
                                                     *mut NSSCMSContentInfo,
                                                 algid: *mut SECAlgorithmID,
                                                 keysize:
                                                     ::std::os::raw::c_int)
     -> SECStatus;
    pub fn NSS_CMSContentInfo_SetBulkKey(cinfo: *mut NSSCMSContentInfo,
                                         bulkkey: *mut PK11SymKey);
    pub fn NSS_CMSContentInfo_GetBulkKey(cinfo: *mut NSSCMSContentInfo)
     -> *mut PK11SymKey;
    pub fn NSS_CMSContentInfo_GetBulkKeySize(cinfo: *mut NSSCMSContentInfo)
     -> ::std::os::raw::c_int;
    pub fn NSS_CMSArray_SortByDER(objs: *mut *mut ::std::os::raw::c_void,
                                  objtemplate: *const SEC_ASN1Template,
                                  objs2: *mut *mut ::std::os::raw::c_void)
     -> SECStatus;
    pub fn NSS_CMSUtil_DERCompare(a: *mut ::std::os::raw::c_void,
                                  b: *mut ::std::os::raw::c_void)
     -> ::std::os::raw::c_int;
    pub fn NSS_CMSAlgArray_GetIndexByAlgID(algorithmArray:
                                               *mut *mut SECAlgorithmID,
                                           algid: *mut SECAlgorithmID)
     -> ::std::os::raw::c_int;
    pub fn NSS_CMSAlgArray_GetIndexByAlgTag(algorithmArray:
                                                *mut *mut SECAlgorithmID,
                                            algtag: SECOidTag)
     -> ::std::os::raw::c_int;
    pub fn NSS_CMSUtil_GetHashObjByAlgID(algid: *mut SECAlgorithmID)
     -> *const SECHashObject;
    pub fn NSS_CMSUtil_GetTemplateByTypeTag(type_: SECOidTag)
     -> *const SEC_ASN1Template;
    pub fn NSS_CMSUtil_GetSizeByTypeTag(type_: SECOidTag) -> size_t;
    pub fn NSS_CMSContent_GetContentInfo(msg: *mut ::std::os::raw::c_void,
                                         type_: SECOidTag)
     -> *mut NSSCMSContentInfo;
    pub fn NSS_CMSUtil_VerificationStatusToString(vs:
                                                      NSSCMSVerificationStatus)
     -> *const ::std::os::raw::c_char;
    pub fn NSS_CMSSignedData_Create(cmsg: *mut NSSCMSMessage)
     -> *mut NSSCMSSignedData;
    pub fn NSS_CMSSignedData_Destroy(sigd: *mut NSSCMSSignedData);
    pub fn NSS_CMSSignedData_Encode_BeforeStart(sigd: *mut NSSCMSSignedData)
     -> SECStatus;
    pub fn NSS_CMSSignedData_Encode_BeforeData(sigd: *mut NSSCMSSignedData)
     -> SECStatus;
    pub fn NSS_CMSSignedData_Encode_AfterData(sigd: *mut NSSCMSSignedData)
     -> SECStatus;
    pub fn NSS_CMSSignedData_Decode_BeforeData(sigd: *mut NSSCMSSignedData)
     -> SECStatus;
    pub fn NSS_CMSSignedData_Decode_AfterData(sigd: *mut NSSCMSSignedData)
     -> SECStatus;
    pub fn NSS_CMSSignedData_Decode_AfterEnd(sigd: *mut NSSCMSSignedData)
     -> SECStatus;
    pub fn NSS_CMSSignedData_GetSignerInfos(sigd: *mut NSSCMSSignedData)
     -> *mut *mut NSSCMSSignerInfo;
    pub fn NSS_CMSSignedData_SignerInfoCount(sigd: *mut NSSCMSSignedData)
     -> ::std::os::raw::c_int;
    pub fn NSS_CMSSignedData_GetSignerInfo(sigd: *mut NSSCMSSignedData,
                                           i: ::std::os::raw::c_int)
     -> *mut NSSCMSSignerInfo;
    pub fn NSS_CMSSignedData_GetDigestAlgs(sigd: *mut NSSCMSSignedData)
     -> *mut *mut SECAlgorithmID;
    pub fn NSS_CMSSignedData_GetContentInfo(sigd: *mut NSSCMSSignedData)
     -> *mut NSSCMSContentInfo;
    pub fn NSS_CMSSignedData_GetCertificateList(sigd: *mut NSSCMSSignedData)
     -> *mut *mut SECItem;
    pub fn NSS_CMSSignedData_ImportCerts(sigd: *mut NSSCMSSignedData,
                                         certdb: *mut CERTCertDBHandle,
                                         certusage: SECCertUsage,
                                         keepcerts: PRBool) -> SECStatus;
    pub fn NSS_CMSSignedData_HasDigests(sigd: *mut NSSCMSSignedData)
     -> PRBool;
    pub fn NSS_CMSSignedData_VerifySignerInfo(sigd: *mut NSSCMSSignedData,
                                              i: ::std::os::raw::c_int,
                                              certdb: *mut CERTCertDBHandle,
                                              certusage: SECCertUsage)
     -> SECStatus;
    pub fn NSS_CMSSignedData_VerifyCertsOnly(sigd: *mut NSSCMSSignedData,
                                             certdb: *mut CERTCertDBHandle,
                                             usage: SECCertUsage)
     -> SECStatus;
    pub fn NSS_CMSSignedData_AddCertList(sigd: *mut NSSCMSSignedData,
                                         certlist: *mut CERTCertificateList)
     -> SECStatus;
    pub fn NSS_CMSSignedData_AddCertChain(sigd: *mut NSSCMSSignedData,
                                          cert: *mut CERTCertificate)
     -> SECStatus;
    pub fn NSS_CMSSignedData_AddCertificate(sigd: *mut NSSCMSSignedData,
                                            cert: *mut CERTCertificate)
     -> SECStatus;
    pub fn NSS_CMSSignedData_ContainsCertsOrCrls(sigd: *mut NSSCMSSignedData)
     -> PRBool;
    pub fn NSS_CMSSignedData_AddSignerInfo(sigd: *mut NSSCMSSignedData,
                                           signerinfo: *mut NSSCMSSignerInfo)
     -> SECStatus;
    pub fn NSS_CMSSignedData_SetDigests(sigd: *mut NSSCMSSignedData,
                                        digestalgs: *mut *mut SECAlgorithmID,
                                        digests: *mut *mut SECItem)
     -> SECStatus;
    pub fn NSS_CMSSignedData_SetDigestValue(sigd: *mut NSSCMSSignedData,
                                            digestalgtag: SECOidTag,
                                            digestdata: *mut SECItem)
     -> SECStatus;
    pub fn NSS_CMSSignedData_AddDigest(poolp: *mut PLArenaPool,
                                       sigd: *mut NSSCMSSignedData,
                                       digestalgtag: SECOidTag,
                                       digest: *mut SECItem) -> SECStatus;
    pub fn NSS_CMSSignedData_GetDigestValue(sigd: *mut NSSCMSSignedData,
                                            digestalgtag: SECOidTag)
     -> *mut SECItem;
    pub fn NSS_CMSSignedData_CreateCertsOnly(cmsg: *mut NSSCMSMessage,
                                             cert: *mut CERTCertificate,
                                             include_chain: PRBool)
     -> *mut NSSCMSSignedData;
    pub fn NSS_CMSSignerInfo_Create(cmsg: *mut NSSCMSMessage,
                                    cert: *mut CERTCertificate,
                                    digestalgtag: SECOidTag)
     -> *mut NSSCMSSignerInfo;
    pub fn NSS_CMSSignerInfo_CreateWithSubjKeyID(cmsg: *mut NSSCMSMessage,
                                                 ...
                                                 digestalgtag: SECOidTag)
     -> *mut NSSCMSSignerInfo;
    pub fn NSS_CMSSignerInfo_Destroy(si: *mut NSSCMSSignerInfo);
    pub fn NSS_CMSSignerInfo_Sign(signerinfo: *mut NSSCMSSignerInfo,
                                  digest: *mut SECItem,
                                  contentType: *mut SECItem) -> SECStatus;
    pub fn NSS_CMSSignerInfo_VerifyCertificate(signerinfo:
                                                   *mut NSSCMSSignerInfo,
                                               certdb: *mut CERTCertDBHandle,
                                               certusage: SECCertUsage)
     -> SECStatus;
    pub fn NSS_CMSSignerInfo_Verify(signerinfo: *mut NSSCMSSignerInfo,
                                    digest: *mut SECItem,
                                    contentType: *mut SECItem) -> SECStatus;
    pub fn NSS_CMSSignerInfo_GetVerificationStatus(signerinfo:
                                                       *mut NSSCMSSignerInfo)
     -> NSSCMSVerificationStatus;
    pub fn NSS_CMSSignerInfo_GetDigestAlg(signerinfo: *mut NSSCMSSignerInfo)
     -> *mut SECOidData;
    pub fn NSS_CMSSignerInfo_GetDigestAlgTag(signerinfo:
                                                 *mut NSSCMSSignerInfo)
     -> SECOidTag;
    pub fn NSS_CMSSignerInfo_GetVersion(signerinfo: *mut NSSCMSSignerInfo)
     -> ::std::os::raw::c_int;
    pub fn NSS_CMSSignerInfo_GetCertList(signerinfo: *mut NSSCMSSignerInfo)
     -> *mut CERTCertificateList;
    pub fn NSS_CMSSignerInfo_GetSigningTime(sinfo: *mut NSSCMSSignerInfo,
                                            stime: *mut PRTime) -> SECStatus;
    pub fn NSS_CMSSignerInfo_GetSigningCertificate(signerinfo:
                                                       *mut NSSCMSSignerInfo,
                                                   certdb:
                                                       *mut CERTCertDBHandle)
     -> *mut CERTCertificate;
    pub fn NSS_CMSSignerInfo_GetSignerCommonName(sinfo: *mut NSSCMSSignerInfo)
     -> *mut ::std::os::raw::c_char;
    pub fn NSS_CMSSignerInfo_GetSignerEmailAddress(sinfo:
                                                       *mut NSSCMSSignerInfo)
     -> *mut ::std::os::raw::c_char;
    pub fn NSS_CMSSignerInfo_AddAuthAttr(signerinfo: *mut NSSCMSSignerInfo,
                                         attr: *mut NSSCMSAttribute)
     -> SECStatus;
    pub fn NSS_CMSSignerInfo_AddUnauthAttr(signerinfo: *mut NSSCMSSignerInfo,
                                           attr: *mut NSSCMSAttribute)
     -> SECStatus;
    pub fn NSS_CMSSignerInfo_AddSigningTime(signerinfo: *mut NSSCMSSignerInfo,
                                            t: PRTime) -> SECStatus;
    pub fn NSS_CMSSignerInfo_AddSMIMECaps(signerinfo: *mut NSSCMSSignerInfo)
     -> SECStatus;
    pub fn NSS_CMSSignerInfo_AddSMIMEEncKeyPrefs(signerinfo:
                                                     *mut NSSCMSSignerInfo,
                                                 cert: *mut CERTCertificate,
                                                 certdb:
                                                     *mut CERTCertDBHandle)
     -> SECStatus;
    pub fn NSS_CMSSignerInfo_AddMSSMIMEEncKeyPrefs(signerinfo:
                                                       *mut NSSCMSSignerInfo,
                                                   cert: *mut CERTCertificate,
                                                   certdb:
                                                       *mut CERTCertDBHandle)
     -> SECStatus;
    pub fn NSS_CMSSignerInfo_AddCounterSignature(signerinfo:
                                                     *mut NSSCMSSignerInfo,
                                                 digestalg: SECOidTag,
                                                 signingcert: CERTCertificate)
     -> SECStatus;
    pub fn NSS_SMIMESignerInfo_SaveSMIMEProfile(signerinfo:
                                                    *mut NSSCMSSignerInfo)
     -> SECStatus;
    pub fn NSS_CMSSignerInfo_IncludeCerts(signerinfo: *mut NSSCMSSignerInfo,
                                          cm: NSSCMSCertChainMode,
                                          usage: SECCertUsage) -> SECStatus;
    pub fn NSS_CMSEnvelopedData_Create(cmsg: *mut NSSCMSMessage,
                                       algorithm: SECOidTag,
                                       keysize: ::std::os::raw::c_int)
     -> *mut NSSCMSEnvelopedData;
    pub fn NSS_CMSEnvelopedData_Destroy(edp: *mut NSSCMSEnvelopedData);
    pub fn NSS_CMSEnvelopedData_GetContentInfo(envd: *mut NSSCMSEnvelopedData)
     -> *mut NSSCMSContentInfo;
    pub fn NSS_CMSEnvelopedData_AddRecipient(edp: *mut NSSCMSEnvelopedData,
                                             rip: *mut NSSCMSRecipientInfo)
     -> SECStatus;
    pub fn NSS_CMSEnvelopedData_Encode_BeforeStart(envd:
                                                       *mut NSSCMSEnvelopedData)
     -> SECStatus;
    pub fn NSS_CMSEnvelopedData_Encode_BeforeData(envd:
                                                      *mut NSSCMSEnvelopedData)
     -> SECStatus;
    pub fn NSS_CMSEnvelopedData_Encode_AfterData(envd:
                                                     *mut NSSCMSEnvelopedData)
     -> SECStatus;
    pub fn NSS_CMSEnvelopedData_Decode_BeforeData(envd:
                                                      *mut NSSCMSEnvelopedData)
     -> SECStatus;
    pub fn NSS_CMSEnvelopedData_Decode_AfterData(envd:
                                                     *mut NSSCMSEnvelopedData)
     -> SECStatus;
    pub fn NSS_CMSEnvelopedData_Decode_AfterEnd(envd:
                                                    *mut NSSCMSEnvelopedData)
     -> SECStatus;
    pub fn NSS_CMSRecipientInfo_Create(cmsg: *mut NSSCMSMessage,
                                       cert: *mut CERTCertificate)
     -> *mut NSSCMSRecipientInfo;
    pub fn NSS_CMSRecipientInfo_CreateWithSubjKeyID(cmsg: *mut NSSCMSMessage,
                                                    subjKeyID: *mut SECItem,
                                                    pubKey:
                                                        *mut SECKEYPublicKey)
     -> *mut NSSCMSRecipientInfo;
    pub fn NSS_CMSRecipientInfo_CreateWithSubjKeyIDFromCert(cmsg:
                                                                *mut NSSCMSMessage,
                                                            cert:
                                                                *mut CERTCertificate)
     -> *mut NSSCMSRecipientInfo;
    pub fn NSS_CMSRecipientInfo_CreateNew(pwfn_arg:
                                              *mut ::std::os::raw::c_void)
     -> *mut NSSCMSRecipientInfo;
    pub fn NSS_CMSRecipientInfo_CreateFromDER(input: *mut SECItem,
                                              pwfn_arg:
                                                  *mut ::std::os::raw::c_void)
     -> *mut NSSCMSRecipientInfo;
    pub fn NSS_CMSRecipientInfo_Destroy(ri: *mut NSSCMSRecipientInfo);
    pub fn NSS_CMSRecipientInfo_GetCertAndKey(ri: *mut NSSCMSRecipientInfo,
                                              retcert:
                                                  *mut *mut CERTCertificate,
                                              retkey:
                                                  *mut *mut SECKEYPrivateKey)
     -> SECStatus;
    pub fn NSS_CMSRecipientInfo_GetVersion(ri: *mut NSSCMSRecipientInfo)
     -> ::std::os::raw::c_int;
    pub fn NSS_CMSRecipientInfo_GetEncryptedKey(ri: *mut NSSCMSRecipientInfo,
                                                subIndex:
                                                    ::std::os::raw::c_int)
     -> *mut SECItem;
    pub fn NSS_CMSRecipientInfo_Encode(poolp: *mut PLArenaPool,
                                       src: *const NSSCMSRecipientInfo,
                                       returned: *mut SECItem) -> SECStatus;
    pub fn NSS_CMSRecipientInfo_GetKeyEncryptionAlgorithmTag(ri:
                                                                 *mut NSSCMSRecipientInfo)
     -> SECOidTag;
    pub fn NSS_CMSRecipientInfo_WrapBulkKey(ri: *mut NSSCMSRecipientInfo,
                                            bulkkey: *mut PK11SymKey,
                                            bulkalgtag: SECOidTag)
     -> SECStatus;
    pub fn NSS_CMSRecipientInfo_UnwrapBulkKey(ri: *mut NSSCMSRecipientInfo,
                                              subIndex: ::std::os::raw::c_int,
                                              cert: *mut CERTCertificate,
                                              privkey: *mut SECKEYPrivateKey,
                                              bulkalgtag: SECOidTag)
     -> *mut PK11SymKey;
    pub fn NSS_CMSEncryptedData_Create(cmsg: *mut NSSCMSMessage,
                                       algorithm: SECOidTag,
                                       keysize: ::std::os::raw::c_int)
     -> *mut NSSCMSEncryptedData;
    pub fn NSS_CMSEncryptedData_Destroy(encd: *mut NSSCMSEncryptedData);
    pub fn NSS_CMSEncryptedData_GetContentInfo(encd: *mut NSSCMSEncryptedData)
     -> *mut NSSCMSContentInfo;
    pub fn NSS_CMSEncryptedData_Encode_BeforeStart(encd:
                                                       *mut NSSCMSEncryptedData)
     -> SECStatus;
    pub fn NSS_CMSEncryptedData_Encode_BeforeData(encd:
                                                      *mut NSSCMSEncryptedData)
     -> SECStatus;
    pub fn NSS_CMSEncryptedData_Encode_AfterData(encd:
                                                     *mut NSSCMSEncryptedData)
     -> SECStatus;
    pub fn NSS_CMSEncryptedData_Decode_BeforeData(encd:
                                                      *mut NSSCMSEncryptedData)
     -> SECStatus;
    pub fn NSS_CMSEncryptedData_Decode_AfterData(encd:
                                                     *mut NSSCMSEncryptedData)
     -> SECStatus;
    pub fn NSS_CMSEncryptedData_Decode_AfterEnd(encd:
                                                    *mut NSSCMSEncryptedData)
     -> SECStatus;
    pub fn NSS_CMSDigestedData_Create(cmsg: *mut NSSCMSMessage,
                                      digestalg: *mut SECAlgorithmID)
     -> *mut NSSCMSDigestedData;
    pub fn NSS_CMSDigestedData_Destroy(digd: *mut NSSCMSDigestedData);
    pub fn NSS_CMSDigestedData_GetContentInfo(digd: *mut NSSCMSDigestedData)
     -> *mut NSSCMSContentInfo;
    pub fn NSS_CMSDigestedData_Encode_BeforeStart(digd:
                                                      *mut NSSCMSDigestedData)
     -> SECStatus;
    pub fn NSS_CMSDigestedData_Encode_BeforeData(digd:
                                                     *mut NSSCMSDigestedData)
     -> SECStatus;
    pub fn NSS_CMSDigestedData_Encode_AfterData(digd: *mut NSSCMSDigestedData)
     -> SECStatus;
    pub fn NSS_CMSDigestedData_Decode_BeforeData(digd:
                                                     *mut NSSCMSDigestedData)
     -> SECStatus;
    pub fn NSS_CMSDigestedData_Decode_AfterData(digd: *mut NSSCMSDigestedData)
     -> SECStatus;
    pub fn NSS_CMSDigestedData_Decode_AfterEnd(digd: *mut NSSCMSDigestedData)
     -> SECStatus;
    pub fn NSS_CMSDigestContext_StartMultiple(digestalgs:
                                                  *mut *mut SECAlgorithmID)
     -> *mut NSSCMSDigestContext;
    pub fn NSS_CMSDigestContext_StartSingle(digestalg: *mut SECAlgorithmID)
     -> *mut NSSCMSDigestContext;
    pub fn NSS_CMSDigestContext_Update(cmsdigcx: *mut NSSCMSDigestContext,
                                       data: *const ::std::os::raw::c_uchar,
                                       len: ::std::os::raw::c_int);
    pub fn NSS_CMSDigestContext_Cancel(cmsdigcx: *mut NSSCMSDigestContext);
    pub fn NSS_CMSDigestContext_FinishMultiple(cmsdigcx:
                                                   *mut NSSCMSDigestContext,
                                               poolp: *mut PLArenaPool,
                                               digestsp:
                                                   *mut *mut *mut SECItem)
     -> SECStatus;
    pub fn NSS_CMSDigestContext_FinishSingle(cmsdigcx:
                                                 *mut NSSCMSDigestContext,
                                             poolp: *mut PLArenaPool,
                                             digest: *mut SECItem)
     -> SECStatus;
    pub fn NSS_CMSDEREncode(cmsg: *mut NSSCMSMessage, input: *mut SECItem,
                            derOut: *mut SECItem, arena: *mut PLArenaPool)
     -> SECStatus;
    pub fn NSS_CMSType_RegisterContentType(type_: SECOidTag,
                                           asn1Template:
                                               *mut SEC_ASN1Template,
                                           size: size_t,
                                           destroy:
                                           ...
                                           encode_after:
                                               NSSCMSGenericWrapperDataCallback,
                                           isData: PRBool) -> SECStatus;
    pub fn NSS_SMIMEUtil_EnableCipher(which: ::std::os::raw::c_long,
                                      on: ::std::os::raw::c_int) -> SECStatus;
    pub fn NSS_SMIMEUtils_AllowCipher(which: ::std::os::raw::c_long,
                                      on: ::std::os::raw::c_int) -> SECStatus;
    pub fn NSS_SMIMEUtil_DecryptionAllowed(algid: *mut SECAlgorithmID,
                                           key: *mut PK11SymKey) -> PRBool;
    pub fn NSS_SMIMEUtil_EncryptionPossible() -> PRBool;
    pub fn NSS_SMIMEUtil_CreateSMIMECapabilities(poolp: *mut PLArenaPool,
                                                 dest: *mut SECItem)
     -> SECStatus;
    pub fn NSS_SMIMEUtil_CreateSMIMEEncKeyPrefs(poolp: *mut PLArenaPool,
                                                dest: *mut SECItem,
                                                cert: *mut CERTCertificate)
     -> SECStatus;
    pub fn NSS_SMIMEUtil_CreateMSSMIMEEncKeyPrefs(poolp: *mut PLArenaPool,
                                                  dest: *mut SECItem,
                                                  cert: *mut CERTCertificate)
     -> SECStatus;
    pub fn NSS_SMIMEUtil_GetCertFromEncryptionKeyPreference(certdb:
                                                                *mut CERTCertDBHandle,
                                                            DERekp:
                                                                *mut SECItem)
     -> *mut CERTCertificate;
    pub fn NSS_SMIMEUtil_FindBulkAlgForRecipients(rcerts:
                                                      *mut *mut CERTCertificate,
                                                  bulkalgtag: *mut SECOidTag,
                                                  keysize:
                                                      *mut ::std::os::raw::c_int)
     -> SECStatus;
    pub fn NSSSMIME_VersionCheck(importedVersion:
                                     *const ::std::os::raw::c_char) -> PRBool;
    pub fn NSSSMIME_GetVersion() -> *const ::std::os::raw::c_char;
}
