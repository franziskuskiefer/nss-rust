...
#[repr(u32)]
#[derive(Debug)]
pub enum PBEBitGenID {
    pbeBitGenIDNull = 0,
    pbeBitGenCipherKey = 1,
    pbeBitGenCipherIV = 2,
    pbeBitGenIntegrityKey = 3,
}
pub enum PBEBitGenContextStr { }
pub type PBEBitGenContext = PBEBitGenContextStr;
...
extern "C" {
    ...
    pub fn NSS_Get_SECKEY_PointerToPrivateKeyInfoTemplate(arg:
                                                          ...
                                                          enc: PRBool)
     -> *const SEC_ASN1Template;
    pub fn sec_pkcs5CreateAlgorithmID(algorithm: SECOidTag,
                                      cipherAlgorithm: SECOidTag,
                                      prfAlg: SECOidTag,
                                      pPbeAlgorithm: *mut SECOidTag,
                                      keyLengh: ::std::os::raw::c_int,
                                      salt: *mut SECItem,
                                      iteration: ::std::os::raw::c_int)
     -> *mut SECAlgorithmID;
    pub fn SEC_PKCS5GetIV(algid: *mut SECAlgorithmID, pwitem: *mut SECItem,
                          faulty3DES: PRBool) -> *mut SECItem;
    pub fn SEC_PKCS5GetCryptoAlgorithm(algid: *mut SECAlgorithmID)
     -> SECOidTag;
    pub fn SEC_PKCS5IsAlgorithmPBEAlg(algid: *mut SECAlgorithmID) -> PRBool;
    pub fn SEC_PKCS5IsAlgorithmPBEAlgTag(algTag: SECOidTag) -> PRBool;
    pub fn SEC_PKCS5GetPBEAlgorithm(algTag: SECOidTag,
                                    keyLen: ::std::os::raw::c_int)
     -> SECOidTag;
    pub fn SEC_PKCS5GetKeyLength(algid: *mut SECAlgorithmID)
     -> ::std::os::raw::c_int;
    pub fn PBE_CreateContext(hashAlgorithm: SECOidTag,
                             bitGenPurpose: PBEBitGenID, pwitem: *mut SECItem,
                             salt: *mut SECItem,
                             bitsNeeded: ::std::os::raw::c_uint,
                             iterations: ::std::os::raw::c_uint)
     -> *mut PBEBitGenContext;
    pub fn PBE_DestroyContext(context: *mut PBEBitGenContext);
    pub fn PBE_GenerateBits(context: *mut PBEBitGenContext) -> *mut SECItem;
}
