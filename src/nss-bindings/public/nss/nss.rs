...
pub struct NSSInitParametersStr {
    ...
    pub minPWLen: ::std::os::raw::c_int,
    pub manufactureID: *mut ::std::os::raw::c_char,
    pub libraryDescription: *mut ::std::os::raw::c_char,
    pub cryptoTokenDescription: *mut ::std::os::raw::c_char,
    pub dbTokenDescription: *mut ::std::os::raw::c_char,
    pub FIPSTokenDescription: *mut ::std::os::raw::c_char,
    pub cryptoSlotDescription: *mut ::std::os::raw::c_char,
    pub dbSlotDescription: *mut ::std::os::raw::c_char,
    pub FIPSSlotDescription: *mut ::std::os::raw::c_char,
}
impl ::std::default::Default for NSSInitParametersStr {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
pub enum NSSInitContextStr { }
pub type NSSInitContext = NSSInitContextStr;
pub type NSS_ShutdownFunc =
    ::std::option::Option<unsafe extern "C" fn(appData:
...
extern "C" {
    ...
    pub fn PORT_LoadLibraryFromOrigin(existingShLibName:
                                      ...
                                      newShLibName:
                                          *const ::std::os::raw::c_char)
     -> *mut PRLibrary;
    pub fn NSS_VersionCheck(importedVersion: *const ::std::os::raw::c_char)
     -> PRBool;
    pub fn NSS_GetVersion() -> *const ::std::os::raw::c_char;
    pub fn NSS_Init(configdir: *const ::std::os::raw::c_char) -> SECStatus;
    pub fn NSS_IsInitialized() -> PRBool;
    pub fn NSS_InitReadWrite(configdir: *const ::std::os::raw::c_char)
     -> SECStatus;
    ...
    pub fn NSS_InitContext(configdir: *const ::std::os::raw::c_char,
                           certPrefix: *const ::std::os::raw::c_char,
                           keyPrefix: *const ::std::os::raw::c_char,
                           secmodName: *const ::std::os::raw::c_char,
                           initParams: *mut NSSInitParameters,
                           flags: PRUint32) -> *mut NSSInitContext;
    pub fn NSS_ShutdownContext(arg1: *mut NSSInitContext) -> SECStatus;
    pub fn NSS_InitWithMerge(configdir: *const ::std::os::raw::c_char,
                             certPrefix: *const ::std::os::raw::c_char,
                             keyPrefix: *const ::std::os::raw::c_char,
                             secmodName: *const ::std::os::raw::c_char,
                             updatedir: *const ::std::os::raw::c_char,
                             updCertPrefix: *const ::std::os::raw::c_char,
                             updKeyPrefix: *const ::std::os::raw::c_char,
                             updateID: *const ::std::os::raw::c_char,
                             updateName: *const ::std::os::raw::c_char,
                             flags: PRUint32) -> SECStatus;
    pub fn NSS_NoDB_Init(configdir: *const ::std::os::raw::c_char)
     -> SECStatus;
    pub fn NSS_RegisterShutdown(sFunc: NSS_ShutdownFunc,
                                appData: *mut ::std::os::raw::c_void)
     -> SECStatus;
    pub fn NSS_UnregisterShutdown(sFunc: NSS_ShutdownFunc,
                                  appData: *mut ::std::os::raw::c_void)
     -> SECStatus;
    pub fn NSS_OptionSet(which: PRInt32, value: PRInt32) -> SECStatus;
    pub fn NSS_OptionGet(which: PRInt32, value: *mut PRInt32) -> SECStatus;
    pub fn NSS_Shutdown() -> SECStatus;
    pub fn PK11_ConfigurePKCS11(man: *const ::std::os::raw::c_char,
                                libdesc: *const ::std::os::raw::c_char,
                                tokdesc: *const ::std::os::raw::c_char,
                                ptokdesc: *const ::std::os::raw::c_char,
                                slotdesc: *const ::std::os::raw::c_char,
                                pslotdesc: *const ::std::os::raw::c_char,
                                fslotdesc: *const ::std::os::raw::c_char,
                                fpslotdesc: *const ::std::os::raw::c_char,
                                minPwd: ::std::os::raw::c_int,
                                pwRequired: ::std::os::raw::c_int);
    pub fn nss_DumpCertificateCacheInfo();
}
