...
extern "C" {
    ...
    pub fn SEC_PKCS12DecryptionAllowed(algid: *mut SECAlgorithmID) -> PRBool;
    pub fn SEC_PKCS12IsEncryptionAllowed() -> PRBool;
    pub fn SEC_PKCS12EnableCipher(which: ::std::os::raw::c_long,
                                  on: ::std::os::raw::c_int) -> SECStatus;
    pub fn SEC_PKCS12SetPreferredCipher(which: ::std::os::raw::c_long,
                                        on: ::std::os::raw::c_int)
     -> SECStatus;
}
