...
extern "C" {
    ...
    pub static NSS_ERROR_NO_MEMORY: NSSError;
    pub static NSS_ERROR_INVALID_ARENA: NSSError;
    pub static NSS_ERROR_NO_ERROR: NSSError;
}
extern "C" {
    ...
    pub fn NSSArena_Create() -> *mut NSSArena;
    pub fn NSSArena_Destroy(arena: *mut NSSArena) -> PRStatus;
    pub fn NSS_GetError() -> NSSError;
    pub fn NSS_GetErrorStack() -> *mut NSSError;
    pub fn NSS_ZAlloc(arenaOpt: *mut NSSArena, size: PRUint32)
     -> *mut ::std::os::raw::c_void;
    pub fn NSS_ZRealloc(pointer: *mut ::std::os::raw::c_void,
                        newSize: PRUint32) -> *mut ::std::os::raw::c_void;
    pub fn NSS_ZFreeIf(pointer: *mut ::std::os::raw::c_void) -> PRStatus;
}
