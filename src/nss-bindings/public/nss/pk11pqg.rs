...
extern "C" {
    ...
    pub fn PORT_LoadLibraryFromOrigin(existingShLibName:
                                      ...
                                      newShLibName:
                                          *const ::std::os::raw::c_char)
     -> *mut PRLibrary;
    pub fn PK11_PQG_ParamGen(j: ::std::os::raw::c_uint,
                             pParams: *mut *mut PQGParams,
                             pVfy: *mut *mut PQGVerify) -> SECStatus;
    pub fn PK11_PQG_ParamGenSeedLen(j: ::std::os::raw::c_uint,
                                    seedBytes: ::std::os::raw::c_uint,
                                    pParams: *mut *mut PQGParams,
                                    pVfy: *mut *mut PQGVerify) -> SECStatus;
    pub fn PK11_PQG_ParamGenV2(L: ::std::os::raw::c_uint,
                               N: ::std::os::raw::c_uint,
                               seedBytes: ::std::os::raw::c_uint,
                               pParams: *mut *mut PQGParams,
                               pVfy: *mut *mut PQGVerify) -> SECStatus;
    pub fn PK11_PQG_VerifyParams(params: *const PQGParams,
                                 vfy: *const PQGVerify,
                                 result: *mut SECStatus) -> SECStatus;
    pub fn PK11_PQG_DestroyParams(params: *mut PQGParams);
    pub fn PK11_PQG_DestroyVerify(vfy: *mut PQGVerify);
    pub fn PK11_PQG_NewParams(prime: *const SECItem, subPrime: *const SECItem,
                              base: *const SECItem) -> *mut PQGParams;
    pub fn PK11_PQG_GetPrimeFromParams(params: *const PQGParams,
                                       prime: *mut SECItem) -> SECStatus;
    pub fn PK11_PQG_GetSubPrimeFromParams(params: *const PQGParams,
                                          subPrime: *mut SECItem)
     -> SECStatus;
    pub fn PK11_PQG_GetBaseFromParams(params: *const PQGParams,
                                      base: *mut SECItem) -> SECStatus;
    pub fn PK11_PQG_NewVerify(counter: ::std::os::raw::c_uint,
                              seed: *const SECItem, h: *const SECItem)
     -> *mut PQGVerify;
    pub fn PK11_PQG_GetCounterFromVerify(verify: *const PQGVerify)
     -> ::std::os::raw::c_uint;
    pub fn PK11_PQG_GetSeedFromVerify(verify: *const PQGVerify,
                                      seed: *mut SECItem) -> SECStatus;
    pub fn PK11_PQG_GetHFromVerify(verify: *const PQGVerify, h: *mut SECItem)
     -> SECStatus;
}
