...
extern "C" {
    ...
    pub fn PORT_LoadLibraryFromOrigin(existingShLibName:
                                      ...
                                      newShLibName:
                                          *const ::std::os::raw::c_char)
     -> *mut PRLibrary;
    pub fn BTOA_DataToAscii(data: *const ::std::os::raw::c_uchar,
                            len: ::std::os::raw::c_uint)
     -> *mut ::std::os::raw::c_char;
    pub fn ATOB_AsciiToData(string: *const ::std::os::raw::c_char,
                            lenp: *mut ::std::os::raw::c_uint)
     -> *mut ::std::os::raw::c_uchar;
    pub fn ATOB_ConvertAsciiToItem(binary_item: *mut SECItem,
                                   ascii: *const ::std::os::raw::c_char)
     -> SECStatus;
    pub fn BTOA_ConvertItemToAscii(binary_item: *mut SECItem)
     -> *mut ::std::os::raw::c_char;
}
