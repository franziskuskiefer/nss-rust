...
#[derive(Copy, Clone)]
#[derive(Debug)]
pub struct NSSCMSRecipientStr {
    pub riIndex: ::std::os::raw::c_int,
    pub subIndex: ::std::os::raw::c_int,
    pub kind: Enum_Unnamed35,
    pub id: Union_Unnamed36,
    pub cert: *mut CERTCertificate,
    pub privkey: *mut SECKEYPrivateKey,
    pub slot: *mut PK11SlotInfo,
}
impl ::std::default::Default for NSSCMSRecipientStr {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
#[derive(Copy, Clone)]
#[repr(u32)]
#[derive(Debug)]
pub enum Enum_Unnamed35 { RLIssuerSN = 0, RLSubjKeyID = 1, }
#[repr(C)]
#[derive(Copy, Clone)]
#[derive(Debug)]
...
impl Union_Unnamed36 {
    pub unsafe fn issuerAndSN(&mut self) -> *mut *mut CERTIssuerAndSN {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_);
        ::std::mem::transmute(raw.offset(0))
    }
    pub unsafe fn subjectKeyID(&mut self) -> *mut *mut SECItem {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_);
        ::std::mem::transmute(raw.offset(0))
    }
}
...
pub type NSSCMSRecipient = NSSCMSRecipientStr;
...
extern "C" {
    ...
    pub fn NSS_Get_CERT_TimeChoiceTemplate(arg: *mut ::std::os::raw::c_void,
                                           enc: PRBool)
     -> *const SEC_ASN1Template;
    pub fn PK11_FreeSlotList(list: *mut PK11SlotList);
    pub fn PK11_FreeSlotListElement(list: *mut PK11SlotList,
                                    le: *mut PK11SlotListElement)
     -> SECStatus;
    pub fn PK11_GetFirstSafe(list: *mut PK11SlotList)
     -> *mut PK11SlotListElement;
    pub fn PK11_GetNextSafe(list: *mut PK11SlotList,
                            le: *mut PK11SlotListElement, restart: PRBool)
     -> *mut PK11SlotListElement;
    pub fn PK11_ReferenceSlot(slot: *mut PK11SlotInfo) -> *mut PK11SlotInfo;
    pub fn PK11_FreeSlot(slot: *mut PK11SlotInfo);
    pub fn PK11_DestroyObject(slot: *mut PK11SlotInfo,
                              object: CK_OBJECT_HANDLE) -> SECStatus;
    pub fn PK11_DestroyTokenObject(slot: *mut PK11SlotInfo,
                                   object: CK_OBJECT_HANDLE) -> SECStatus;
    pub fn PK11_GetInternalKeySlot() -> *mut PK11SlotInfo;
    pub fn PK11_GetInternalSlot() -> *mut PK11SlotInfo;
    pub fn PK11_Logout(slot: *mut PK11SlotInfo) -> SECStatus;
    pub fn PK11_LogoutAll();
    pub fn PK11_SetSlotPWValues(slot: *mut PK11SlotInfo,
                                askpw: ::std::os::raw::c_int,
                                timeout: ::std::os::raw::c_int);
    pub fn PK11_GetSlotPWValues(slot: *mut PK11SlotInfo,
                                askpw: *mut ::std::os::raw::c_int,
                                timeout: *mut ::std::os::raw::c_int);
    pub fn PK11_CheckSSOPassword(slot: *mut PK11SlotInfo,
                                 ssopw: *mut ::std::os::raw::c_char)
     -> SECStatus;
    pub fn PK11_CheckUserPassword(slot: *mut PK11SlotInfo,
                                  pw: *const ::std::os::raw::c_char)
     -> SECStatus;
    pub fn PK11_IsLoggedIn(slot: *mut PK11SlotInfo,
                           wincx: *mut ::std::os::raw::c_void) -> PRBool;
    pub fn PK11_InitPin(slot: *mut PK11SlotInfo,
                        ssopw: *const ::std::os::raw::c_char,
                        pk11_userpwd: *const ::std::os::raw::c_char)
     -> SECStatus;
    pub fn PK11_ChangePW(slot: *mut PK11SlotInfo,
                         oldpw: *const ::std::os::raw::c_char,
                         newpw: *const ::std::os::raw::c_char) -> SECStatus;
    pub fn PK11_SetPasswordFunc(func: PK11PasswordFunc);
    pub fn PK11_GetMinimumPwdLength(slot: *mut PK11SlotInfo)
     -> ::std::os::raw::c_int;
    pub fn PK11_ResetToken(slot: *mut PK11SlotInfo,
                           sso_pwd: *mut ::std::os::raw::c_char) -> SECStatus;
    pub fn PK11_Authenticate(slot: *mut PK11SlotInfo, loadCerts: PRBool,
                             wincx: *mut ::std::os::raw::c_void) -> SECStatus;
    pub fn PK11_TokenRefresh(slot: *mut PK11SlotInfo) -> SECStatus;
    pub fn PK11_FindSlotByName(name: *const ::std::os::raw::c_char)
     -> *mut PK11SlotInfo;
    pub fn PK11_FindSlotsByNames(dllName: *const ::std::os::raw::c_char,
                                 slotName: *const ::std::os::raw::c_char,
                                 tokenName: *const ::std::os::raw::c_char,
                                 presentOnly: PRBool) -> *mut PK11SlotList;
    pub fn PK11_IsReadOnly(slot: *mut PK11SlotInfo) -> PRBool;
    pub fn PK11_IsInternal(slot: *mut PK11SlotInfo) -> PRBool;
    pub fn PK11_IsInternalKeySlot(slot: *mut PK11SlotInfo) -> PRBool;
    pub fn PK11_GetTokenName(slot: *mut PK11SlotInfo)
     -> *mut ::std::os::raw::c_char;
    pub fn PK11_GetSlotName(slot: *mut PK11SlotInfo)
     -> *mut ::std::os::raw::c_char;
    pub fn PK11_NeedLogin(slot: *mut PK11SlotInfo) -> PRBool;
    pub fn PK11_IsFriendly(slot: *mut PK11SlotInfo) -> PRBool;
    pub fn PK11_IsHW(slot: *mut PK11SlotInfo) -> PRBool;
    pub fn PK11_IsRemovable(slot: *mut PK11SlotInfo) -> PRBool;
    pub fn PK11_NeedUserInit(slot: *mut PK11SlotInfo) -> PRBool;
    pub fn PK11_ProtectedAuthenticationPath(slot: *mut PK11SlotInfo)
     -> PRBool;
    pub fn PK11_GetSlotSeries(slot: *mut PK11SlotInfo)
     -> ::std::os::raw::c_int;
    pub fn PK11_GetCurrentWrapIndex(slot: *mut PK11SlotInfo)
     -> ::std::os::raw::c_int;
    pub fn PK11_GetDefaultFlags(slot: *mut PK11SlotInfo)
     -> ::std::os::raw::c_ulong;
    pub fn PK11_GetSlotID(slot: *mut PK11SlotInfo) -> CK_SLOT_ID;
    pub fn PK11_GetModuleID(slot: *mut PK11SlotInfo) -> SECMODModuleID;
    pub fn PK11_GetSlotInfo(slot: *mut PK11SlotInfo, info: *mut CK_SLOT_INFO)
     -> SECStatus;
    pub fn PK11_GetTokenInfo(slot: *mut PK11SlotInfo,
                             info: *mut CK_TOKEN_INFO) -> SECStatus;
    pub fn PK11_IsDisabled(slot: *mut PK11SlotInfo) -> PRBool;
    pub fn PK11_HasRootCerts(slot: *mut PK11SlotInfo) -> PRBool;
    pub fn PK11_GetDisabledReason(slot: *mut PK11SlotInfo)
     -> PK11DisableReasons;
    pub fn PK11_UserDisableSlot(slot: *mut PK11SlotInfo) -> PRBool;
    pub fn PK11_UserEnableSlot(slot: *mut PK11SlotInfo) -> PRBool;
    pub fn PK11_WaitForTokenEvent(slot: *mut PK11SlotInfo,
                                  event: PK11TokenEvent,
                                  timeout: PRIntervalTime,
                                  pollInterval: PRIntervalTime,
                                  series: ::std::os::raw::c_int)
     -> PK11TokenStatus;
    pub fn PK11_NeedPWInit() -> PRBool;
    pub fn PK11_TokenExists(arg1: CK_MECHANISM_TYPE) -> PRBool;
    pub fn PK11_GetModInfo(mod_: *mut SECMODModule, info: *mut CK_INFO)
     -> SECStatus;
    pub fn PK11_IsFIPS() -> PRBool;
    pub fn PK11_GetModule(slot: *mut PK11SlotInfo) -> *mut SECMODModule;
    pub fn PK11_IsPresent(slot: *mut PK11SlotInfo) -> PRBool;
    pub fn PK11_DoesMechanism(slot: *mut PK11SlotInfo,
                              type_: CK_MECHANISM_TYPE) -> PRBool;
    pub fn PK11_GetAllTokens(type_: CK_MECHANISM_TYPE, needRW: PRBool,
                             loadCerts: PRBool,
                             wincx: *mut ::std::os::raw::c_void)
     -> *mut PK11SlotList;
    pub fn PK11_GetBestSlotMultipleWithAttributes(type_:
                                                      *mut CK_MECHANISM_TYPE,
                                                  mechFlag: *mut CK_FLAGS,
                                                  keySize:
                                                      *mut ::std::os::raw::c_uint,
                                                  count:
                                                      ::std::os::raw::c_uint,
                                                  wincx:
                                                      *mut ::std::os::raw::c_void)
     -> *mut PK11SlotInfo;
    pub fn PK11_GetBestSlotMultiple(type_: *mut CK_MECHANISM_TYPE,
                                    count: ::std::os::raw::c_uint,
                                    wincx: *mut ::std::os::raw::c_void)
     -> *mut PK11SlotInfo;
    pub fn PK11_GetBestSlot(type_: CK_MECHANISM_TYPE,
                            wincx: *mut ::std::os::raw::c_void)
     -> *mut PK11SlotInfo;
    pub fn PK11_GetBestSlotWithAttributes(type_: CK_MECHANISM_TYPE,
                                          mechFlag: CK_FLAGS,
                                          keySize: ::std::os::raw::c_uint,
                                          wincx: *mut ::std::os::raw::c_void)
     -> *mut PK11SlotInfo;
    pub fn PK11_GetBestWrapMechanism(slot: *mut PK11SlotInfo)
     -> CK_MECHANISM_TYPE;
    pub fn PK11_GetBestKeyLength(slot: *mut PK11SlotInfo,
                                 type_: CK_MECHANISM_TYPE)
     -> ::std::os::raw::c_int;
    pub fn SECMOD_OpenUserDB(moduleSpec: *const ::std::os::raw::c_char)
     -> *mut PK11SlotInfo;
    pub fn SECMOD_CloseUserDB(slot: *mut PK11SlotInfo) -> SECStatus;
    pub fn SECMOD_OpenNewSlot(mod_: *mut SECMODModule,
                              moduleSpec: *const ::std::os::raw::c_char)
     -> *mut PK11SlotInfo;
    pub fn PK11_MergeTokens(targetSlot: *mut PK11SlotInfo,
                            sourceSlot: *mut PK11SlotInfo,
                            log: *mut PK11MergeLog,
                            targetPwArg: *mut ::std::os::raw::c_void,
                            sourcePwArg: *mut ::std::os::raw::c_void)
     -> SECStatus;
    pub fn PK11_CreateMergeLog() -> *mut PK11MergeLog;
    pub fn PK11_DestroyMergeLog(log: *mut PK11MergeLog);
    pub fn PK11_GetKeyType(type_: CK_MECHANISM_TYPE,
                           len: ::std::os::raw::c_ulong) -> CK_KEY_TYPE;
    pub fn PK11_GetKeyGen(type_: CK_MECHANISM_TYPE) -> CK_MECHANISM_TYPE;
    pub fn PK11_GetBlockSize(type_: CK_MECHANISM_TYPE, params: *mut SECItem)
     -> ::std::os::raw::c_int;
    pub fn PK11_GetIVLength(type_: CK_MECHANISM_TYPE)
     -> ::std::os::raw::c_int;
    pub fn PK11_ParamFromIV(type_: CK_MECHANISM_TYPE, iv: *mut SECItem)
     -> *mut SECItem;
    pub fn PK11_IVFromParam(type_: CK_MECHANISM_TYPE, param: *mut SECItem,
                            len: *mut ::std::os::raw::c_int)
     -> *mut ::std::os::raw::c_uchar;
    pub fn PK11_BlockData(data: *mut SECItem, size: ::std::os::raw::c_ulong)
     -> *mut SECItem;
    pub fn PK11_ParamFromAlgid(algid: *mut SECAlgorithmID) -> *mut SECItem;
    pub fn PK11_GenerateNewParam(arg1: CK_MECHANISM_TYPE,
                                 arg2: *mut PK11SymKey) -> *mut SECItem;
    pub fn PK11_AlgtagToMechanism(algTag: SECOidTag) -> CK_MECHANISM_TYPE;
    pub fn PK11_MechanismToAlgtag(type_: CK_MECHANISM_TYPE) -> SECOidTag;
    pub fn PK11_FortezzaMapSig(algTag: SECOidTag) -> SECOidTag;
    pub fn PK11_ParamToAlgid(algtag: SECOidTag, param: *mut SECItem,
                             arena: *mut PLArenaPool,
                             algid: *mut SECAlgorithmID) -> SECStatus;
    pub fn PK11_SeedRandom(arg1: *mut PK11SlotInfo,
                           data: *mut ::std::os::raw::c_uchar,
                           len: ::std::os::raw::c_int) -> SECStatus;
    pub fn PK11_GenerateRandomOnSlot(arg1: *mut PK11SlotInfo,
                                     data: *mut ::std::os::raw::c_uchar,
                                     len: ::std::os::raw::c_int) -> SECStatus;
    pub fn PK11_RandomUpdate(data: *mut ::std::os::raw::c_void, bytes: size_t)
     -> SECStatus;
    pub fn PK11_GenerateRandom(data: *mut ::std::os::raw::c_uchar,
                               len: ::std::os::raw::c_int) -> SECStatus;
    pub fn PK11_MapPBEMechanismToCryptoMechanism(pPBEMechanism:
                                                     CK_MECHANISM_PTR,
                                                 pCryptoMechanism:
                                                     CK_MECHANISM_PTR,
                                                 pbe_pwd: *mut SECItem,
                                                 bad3DES: PRBool) -> CK_RV;
    pub fn PK11_GetPadMechanism(arg1: CK_MECHANISM_TYPE) -> CK_MECHANISM_TYPE;
    pub fn PK11_MapSignKeyType(keyType: KeyType) -> CK_MECHANISM_TYPE;
    pub fn PK11_FreeSymKey(key: *mut PK11SymKey);
    pub fn PK11_ReferenceSymKey(symKey: *mut PK11SymKey) -> *mut PK11SymKey;
    pub fn PK11_ImportSymKey(slot: *mut PK11SlotInfo,
                             type_: CK_MECHANISM_TYPE, origin: PK11Origin,
                             operation: CK_ATTRIBUTE_TYPE, key: *mut SECItem,
                             wincx: *mut ::std::os::raw::c_void)
     -> *mut PK11SymKey;
    pub fn PK11_ImportSymKeyWithFlags(slot: *mut PK11SlotInfo,
                                      type_: CK_MECHANISM_TYPE,
                                      origin: PK11Origin,
                                      operation: CK_ATTRIBUTE_TYPE,
                                      key: *mut SECItem, flags: CK_FLAGS,
                                      isPerm: PRBool,
                                      wincx: *mut ::std::os::raw::c_void)
     -> *mut PK11SymKey;
    pub fn PK11_SymKeyFromHandle(slot: *mut PK11SlotInfo,
                                 parent: *mut PK11SymKey, origin: PK11Origin,
                                 type_: CK_MECHANISM_TYPE,
                                 keyID: CK_OBJECT_HANDLE, owner: PRBool,
                                 wincx: *mut ::std::os::raw::c_void)
     -> *mut PK11SymKey;
    pub fn PK11_GetWrapKey(slot: *mut PK11SlotInfo,
                           wrap: ::std::os::raw::c_int,
                           type_: CK_MECHANISM_TYPE,
                           series: ::std::os::raw::c_int,
                           wincx: *mut ::std::os::raw::c_void)
     -> *mut PK11SymKey;
    pub fn PK11_SetWrapKey(slot: *mut PK11SlotInfo,
                           wrap: ::std::os::raw::c_int,
                           wrapKey: *mut PK11SymKey);
    pub fn PK11_GetMechanism(symKey: *mut PK11SymKey) -> CK_MECHANISM_TYPE;
    pub fn PK11_ImportPublicKey(slot: *mut PK11SlotInfo,
                                pubKey: *mut SECKEYPublicKey, isToken: PRBool)
     -> CK_OBJECT_HANDLE;
    pub fn PK11_KeyGen(slot: *mut PK11SlotInfo, type_: CK_MECHANISM_TYPE,
                       param: *mut SECItem, keySize: ::std::os::raw::c_int,
                       wincx: *mut ::std::os::raw::c_void) -> *mut PK11SymKey;
    pub fn PK11_TokenKeyGen(slot: *mut PK11SlotInfo, type_: CK_MECHANISM_TYPE,
                            param: *mut SECItem,
                            keySize: ::std::os::raw::c_int,
                            keyid: *mut SECItem, isToken: PRBool,
                            wincx: *mut ::std::os::raw::c_void)
     -> *mut PK11SymKey;
    pub fn PK11_TokenKeyGenWithFlags(slot: *mut PK11SlotInfo,
                                     type_: CK_MECHANISM_TYPE,
                                     param: *mut SECItem,
                                     keySize: ::std::os::raw::c_int,
                                     keyid: *mut SECItem, opFlags: CK_FLAGS,
                                     attrFlags: PK11AttrFlags,
                                     wincx: *mut ::std::os::raw::c_void)
     -> *mut PK11SymKey;
    pub fn PK11_KeyGenWithTemplate(slot: *mut PK11SlotInfo,
                                   type_: CK_MECHANISM_TYPE,
                                   keyGenType: CK_MECHANISM_TYPE,
                                   param: *mut SECItem,
                                   attrs: *mut CK_ATTRIBUTE,
                                   attrsCount: ::std::os::raw::c_uint,
                                   wincx: *mut ::std::os::raw::c_void)
     -> *mut PK11SymKey;
    pub fn PK11_ListFixedKeysInSlot(slot: *mut PK11SlotInfo,
                                    nickname: *mut ::std::os::raw::c_char,
                                    wincx: *mut ::std::os::raw::c_void)
     -> *mut PK11SymKey;
    pub fn PK11_GetNextSymKey(symKey: *mut PK11SymKey) -> *mut PK11SymKey;
    pub fn PK11_GetSymKeyType(key: *mut PK11SymKey) -> CK_KEY_TYPE;
    pub fn PK11_GetSymKeyHandle(symKey: *mut PK11SymKey) -> CK_OBJECT_HANDLE;
    pub fn PK11_SetSymKeyUserData(symKey: *mut PK11SymKey,
                                  data: *mut ::std::os::raw::c_void,
                                  freefunc: PK11FreeDataFunc);
    pub fn PK11_GetSymKeyUserData(symKey: *mut PK11SymKey)
     -> *mut ::std::os::raw::c_void;
    pub fn PK11_PubWrapSymKey(type_: CK_MECHANISM_TYPE,
                              pubKey: *mut SECKEYPublicKey,
                              symKey: *mut PK11SymKey,
                              wrappedKey: *mut SECItem) -> SECStatus;
    pub fn PK11_WrapSymKey(type_: CK_MECHANISM_TYPE, params: *mut SECItem,
                           wrappingKey: *mut PK11SymKey,
                           symKey: *mut PK11SymKey, wrappedKey: *mut SECItem)
     -> SECStatus;
    pub fn PK11_MoveSymKey(slot: *mut PK11SlotInfo,
                           operation: CK_ATTRIBUTE_TYPE, flags: CK_FLAGS,
                           perm: PRBool, symKey: *mut PK11SymKey)
     -> *mut PK11SymKey;
    pub fn PK11_Derive(baseKey: *mut PK11SymKey, mechanism: CK_MECHANISM_TYPE,
                       param: *mut SECItem, target: CK_MECHANISM_TYPE,
                       operation: CK_ATTRIBUTE_TYPE,
                       keySize: ::std::os::raw::c_int) -> *mut PK11SymKey;
    pub fn PK11_DeriveWithFlags(baseKey: *mut PK11SymKey,
                                derive: CK_MECHANISM_TYPE,
                                param: *mut SECItem,
                                target: CK_MECHANISM_TYPE,
                                operation: CK_ATTRIBUTE_TYPE,
                                keySize: ::std::os::raw::c_int,
                                flags: CK_FLAGS) -> *mut PK11SymKey;
    pub fn PK11_DeriveWithFlagsPerm(baseKey: *mut PK11SymKey,
                                    derive: CK_MECHANISM_TYPE,
                                    param: *mut SECItem,
                                    target: CK_MECHANISM_TYPE,
                                    operation: CK_ATTRIBUTE_TYPE,
                                    keySize: ::std::os::raw::c_int,
                                    flags: CK_FLAGS, isPerm: PRBool)
     -> *mut PK11SymKey;
    pub fn PK11_DeriveWithTemplate(baseKey: *mut PK11SymKey,
                                   derive: CK_MECHANISM_TYPE,
                                   param: *mut SECItem,
                                   target: CK_MECHANISM_TYPE,
                                   operation: CK_ATTRIBUTE_TYPE,
                                   keySize: ::std::os::raw::c_int,
                                   userAttr: *mut CK_ATTRIBUTE,
                                   numAttrs: ::std::os::raw::c_uint,
                                   isPerm: PRBool) -> *mut PK11SymKey;
    pub fn PK11_PubDerive(privKey: *mut SECKEYPrivateKey,
                          ...
                          wincx: *mut ::std::os::raw::c_void)
     -> *mut PK11SymKey;
    pub fn PK11_PubDeriveWithKDF(privKey: *mut SECKEYPrivateKey,
                                 pubKey: *mut SECKEYPublicKey,
                                 isSender: PRBool, randomA: *mut SECItem,
                                 randomB: *mut SECItem,
                                 derive: CK_MECHANISM_TYPE,
                                 target: CK_MECHANISM_TYPE,
                                 operation: CK_ATTRIBUTE_TYPE,
                                 keySize: ::std::os::raw::c_int,
                                 kdf: CK_ULONG, sharedData: *mut SECItem,
                                 wincx: *mut ::std::os::raw::c_void)
     -> *mut PK11SymKey;
    pub fn PK11_UnwrapSymKey(key: *mut PK11SymKey,
                             wraptype: CK_MECHANISM_TYPE, param: *mut SECItem,
                             wrapppedKey: *mut SECItem,
                             target: CK_MECHANISM_TYPE,
                             operation: CK_ATTRIBUTE_TYPE,
                             keySize: ::std::os::raw::c_int)
     -> *mut PK11SymKey;
    pub fn PK11_UnwrapSymKeyWithFlags(wrappingKey: *mut PK11SymKey,
                                      ...
                                      keySize: ::std::os::raw::c_int,
                                      flags: CK_FLAGS) -> *mut PK11SymKey;
    pub fn PK11_UnwrapSymKeyWithFlagsPerm(wrappingKey: *mut PK11SymKey,
                                          wrapType: CK_MECHANISM_TYPE,
                                          param: *mut SECItem,
                                          wrappedKey: *mut SECItem,
                                          target: CK_MECHANISM_TYPE,
                                          ...
                                          flags: CK_FLAGS, isPerm: PRBool)
     -> *mut PK11SymKey;
    pub fn PK11_PubUnwrapSymKey(key: *mut SECKEYPrivateKey,
                                wrapppedKey: *mut SECItem,
                                target: CK_MECHANISM_TYPE,
                                operation: CK_ATTRIBUTE_TYPE,
                                keySize: ::std::os::raw::c_int)
     -> *mut PK11SymKey;
    pub fn PK11_PubUnwrapSymKeyWithFlagsPerm(wrappingKey:
                                             ...
                                             flags: CK_FLAGS, isPerm: PRBool)
     -> *mut PK11SymKey;
    pub fn PK11_FindFixedKey(slot: *mut PK11SlotInfo,
                             type_: CK_MECHANISM_TYPE, keyID: *mut SECItem,
                             wincx: *mut ::std::os::raw::c_void)
     -> *mut PK11SymKey;
    pub fn PK11_DeleteTokenPrivateKey(privKey: *mut SECKEYPrivateKey,
                                      force: PRBool) -> SECStatus;
    pub fn PK11_DeleteTokenPublicKey(pubKey: *mut SECKEYPublicKey)
     -> SECStatus;
    pub fn PK11_DeleteTokenSymKey(symKey: *mut PK11SymKey) -> SECStatus;
    pub fn PK11_DeleteTokenCertAndKey(cert: *mut CERTCertificate,
                                      wincx: *mut ::std::os::raw::c_void)
     -> SECStatus;
    pub fn PK11_LoadPrivKey(slot: *mut PK11SlotInfo,
                            privKey: *mut SECKEYPrivateKey,
                            pubKey: *mut SECKEYPublicKey, token: PRBool,
                            sensitive: PRBool) -> *mut SECKEYPrivateKey;
    pub fn PK11_GetSymKeyNickname(symKey: *mut PK11SymKey)
     -> *mut ::std::os::raw::c_char;
    pub fn PK11_GetPrivateKeyNickname(privKey: *mut SECKEYPrivateKey)
     -> *mut ::std::os::raw::c_char;
    pub fn PK11_GetPublicKeyNickname(pubKey: *mut SECKEYPublicKey)
     -> *mut ::std::os::raw::c_char;
    pub fn PK11_SetSymKeyNickname(symKey: *mut PK11SymKey,
                                  nickname: *const ::std::os::raw::c_char)
     -> SECStatus;
    pub fn PK11_SetPrivateKeyNickname(privKey: *mut SECKEYPrivateKey,
                                      nickname: *const ::std::os::raw::c_char)
     -> SECStatus;
    pub fn PK11_SetPublicKeyNickname(pubKey: *mut SECKEYPublicKey,
                                     nickname: *const ::std::os::raw::c_char)
     -> SECStatus;
    pub fn __PK11_SetCertificateNickname(cert: *mut CERTCertificate,
                                         nickname:
                                             *const ::std::os::raw::c_char)
     -> SECStatus;
    pub fn PK11_GetKeyLength(key: *mut PK11SymKey) -> ::std::os::raw::c_uint;
    pub fn PK11_GetKeyStrength(key: *mut PK11SymKey,
                               algid: *mut SECAlgorithmID)
     -> ::std::os::raw::c_uint;
    pub fn PK11_ExtractKeyValue(symKey: *mut PK11SymKey) -> SECStatus;
    pub fn PK11_GetKeyData(symKey: *mut PK11SymKey) -> *mut SECItem;
    pub fn PK11_GetSlotFromKey(symKey: *mut PK11SymKey) -> *mut PK11SlotInfo;
    pub fn PK11_GetWindow(symKey: *mut PK11SymKey)
     -> *mut ::std::os::raw::c_void;
    pub fn PK11_GenerateKeyPairWithOpFlags(slot: *mut PK11SlotInfo,
                                           type_: CK_MECHANISM_TYPE,
                                           param: *mut ::std::os::raw::c_void,
                                           pubk: *mut *mut SECKEYPublicKey,
                                           attrFlags: PK11AttrFlags,
                                           opFlags: CK_FLAGS,
                                           opFlagsMask: CK_FLAGS,
                                           wincx: *mut ::std::os::raw::c_void)
     -> *mut SECKEYPrivateKey;
    pub fn PK11_GenerateKeyPairWithFlags(slot: *mut PK11SlotInfo,
                                         type_: CK_MECHANISM_TYPE,
                                         param: *mut ::std::os::raw::c_void,
                                         pubk: *mut *mut SECKEYPublicKey,
                                         attrFlags: PK11AttrFlags,
                                         wincx: *mut ::std::os::raw::c_void)
     -> *mut SECKEYPrivateKey;
    pub fn PK11_GenerateKeyPair(slot: *mut PK11SlotInfo,
                                type_: CK_MECHANISM_TYPE,
                                param: *mut ::std::os::raw::c_void,
                                pubk: *mut *mut SECKEYPublicKey,
                                isPerm: PRBool, isSensitive: PRBool,
                                wincx: *mut ::std::os::raw::c_void)
     -> *mut SECKEYPrivateKey;
    pub fn PK11_FindPrivateKeyFromCert(slot: *mut PK11SlotInfo,
                                       cert: *mut CERTCertificate,
                                       wincx: *mut ::std::os::raw::c_void)
     -> *mut SECKEYPrivateKey;
    pub fn PK11_FindKeyByAnyCert(cert: *mut CERTCertificate,
                                 wincx: *mut ::std::os::raw::c_void)
     -> *mut SECKEYPrivateKey;
    pub fn PK11_FindKeyByKeyID(slot: *mut PK11SlotInfo, keyID: *mut SECItem,
                               wincx: *mut ::std::os::raw::c_void)
     -> *mut SECKEYPrivateKey;
    pub fn PK11_GetPrivateModulusLen(key: *mut SECKEYPrivateKey)
     -> ::std::os::raw::c_int;
    pub fn PK11_Decrypt(symkey: *mut PK11SymKey, mechanism: CK_MECHANISM_TYPE,
                        param: *mut SECItem,
                        out: *mut ::std::os::raw::c_uchar,
                        outLen: *mut ::std::os::raw::c_uint,
                        maxLen: ::std::os::raw::c_uint,
                        enc: *const ::std::os::raw::c_uchar,
                        encLen: ::std::os::raw::c_uint) -> SECStatus;
    pub fn PK11_Encrypt(symKey: *mut PK11SymKey, mechanism: CK_MECHANISM_TYPE,
                        param: *mut SECItem,
                        out: *mut ::std::os::raw::c_uchar,
                        outLen: *mut ::std::os::raw::c_uint,
                        maxLen: ::std::os::raw::c_uint,
                        data: *const ::std::os::raw::c_uchar,
                        dataLen: ::std::os::raw::c_uint) -> SECStatus;
    pub fn PK11_PubDecryptRaw(key: *mut SECKEYPrivateKey,
                              data: *mut ::std::os::raw::c_uchar,
                              outLen: *mut ::std::os::raw::c_uint,
                              maxLen: ::std::os::raw::c_uint,
                              enc: *const ::std::os::raw::c_uchar,
                              encLen: ::std::os::raw::c_uint) -> SECStatus;
    pub fn PK11_PubEncryptRaw(key: *mut SECKEYPublicKey,
                              enc: *mut ::std::os::raw::c_uchar,
                              data: *const ::std::os::raw::c_uchar,
                              dataLen: ::std::os::raw::c_uint,
                              wincx: *mut ::std::os::raw::c_void)
     -> SECStatus;
    pub fn PK11_PrivDecryptPKCS1(key: *mut SECKEYPrivateKey,
                                 data: *mut ::std::os::raw::c_uchar,
                                 outLen: *mut ::std::os::raw::c_uint,
                                 maxLen: ::std::os::raw::c_uint,
                                 enc: *const ::std::os::raw::c_uchar,
                                 encLen: ::std::os::raw::c_uint) -> SECStatus;
    pub fn PK11_PubEncryptPKCS1(key: *mut SECKEYPublicKey,
                                enc: *mut ::std::os::raw::c_uchar,
                                data: *const ::std::os::raw::c_uchar,
                                dataLen: ::std::os::raw::c_uint,
                                wincx: *mut ::std::os::raw::c_void)
     -> SECStatus;
    pub fn PK11_PrivDecrypt(key: *mut SECKEYPrivateKey,
                            mechanism: CK_MECHANISM_TYPE, param: *mut SECItem,
                            out: *mut ::std::os::raw::c_uchar,
                            outLen: *mut ::std::os::raw::c_uint,
                            maxLen: ::std::os::raw::c_uint,
                            enc: *const ::std::os::raw::c_uchar,
                            encLen: ::std::os::raw::c_uint) -> SECStatus;
    pub fn PK11_PubEncrypt(key: *mut SECKEYPublicKey,
                           mechanism: CK_MECHANISM_TYPE, param: *mut SECItem,
                           out: *mut ::std::os::raw::c_uchar,
                           outLen: *mut ::std::os::raw::c_uint,
                           maxLen: ::std::os::raw::c_uint,
                           ...
                           dataLen: ::std::os::raw::c_uint,
                           wincx: *mut ::std::os::raw::c_void) -> SECStatus;
    pub fn PK11_ImportPrivateKeyInfo(slot: *mut PK11SlotInfo,
                                     pki: *mut SECKEYPrivateKeyInfo,
                                     nickname: *mut SECItem,
                                     publicValue: *mut SECItem,
                                     isPerm: PRBool, isPrivate: PRBool,
                                     usage: ::std::os::raw::c_uint,
                                     wincx: *mut ::std::os::raw::c_void)
     -> SECStatus;
    pub fn PK11_ImportPrivateKeyInfoAndReturnKey(slot: *mut PK11SlotInfo,
                                                 pki:
                                                     *mut SECKEYPrivateKeyInfo,
                                                 nickname: *mut SECItem,
                                                 publicValue: *mut SECItem,
                                                 isPerm: PRBool,
                                                 isPrivate: PRBool,
                                                 ...
                                                 wincx:
                                                     *mut ::std::os::raw::c_void)
     -> SECStatus;
    pub fn PK11_ImportDERPrivateKeyInfo(slot: *mut PK11SlotInfo,
                                        derPKI: *mut SECItem,
                                        nickname: *mut SECItem,
                                        publicValue: *mut SECItem,
                                        isPerm: PRBool, isPrivate: PRBool,
                                        ...
                                        wincx: *mut ::std::os::raw::c_void)
     -> SECStatus;
    pub fn PK11_ImportDERPrivateKeyInfoAndReturnKey(slot: *mut PK11SlotInfo,
                                                    derPKI: *mut SECItem,
                                                    nickname: *mut SECItem,
                                                    publicValue: *mut SECItem,
                                                    isPerm: PRBool,
                                                    ...
                                                    wincx:
                                                        *mut ::std::os::raw::c_void)
     -> SECStatus;
    pub fn PK11_ImportEncryptedPrivateKeyInfo(slot: *mut PK11SlotInfo,
                                              epki:
                                              ...
                                              wincx:
                                                  *mut ::std::os::raw::c_void)
     -> SECStatus;
    pub fn PK11_ImportEncryptedPrivateKeyInfoAndReturnKey(slot:
                                                              *mut PK11SlotInfo,
                                                          epki:
                                                              *mut SECKEYEncryptedPrivateKeyInfo,
                                                          pwitem:
                                                          ...
                                                          wincx:
                                                              *mut ::std::os::raw::c_void)
     -> SECStatus;
    pub fn PK11_ExportDERPrivateKeyInfo(pk: *mut SECKEYPrivateKey,
                                        wincx: *mut ::std::os::raw::c_void)
     -> *mut SECItem;
    pub fn PK11_ExportPrivKeyInfo(pk: *mut SECKEYPrivateKey,
                                  wincx: *mut ::std::os::raw::c_void)
     -> *mut SECKEYPrivateKeyInfo;
    pub fn PK11_ExportPrivateKeyInfo(cert: *mut CERTCertificate,
                                     wincx: *mut ::std::os::raw::c_void)
     -> *mut SECKEYPrivateKeyInfo;
    pub fn PK11_ExportEncryptedPrivKeyInfo(slot: *mut PK11SlotInfo,
                                           algTag: SECOidTag,
                                           pwitem: *mut SECItem,
                                           pk: *mut SECKEYPrivateKey,
                                           iteration: ::std::os::raw::c_int,
                                           wincx: *mut ::std::os::raw::c_void)
     -> *mut SECKEYEncryptedPrivateKeyInfo;
    pub fn PK11_ExportEncryptedPrivateKeyInfo(slot: *mut PK11SlotInfo,
                                              algTag: SECOidTag,
                                              pwitem: *mut SECItem,
                                              cert: *mut CERTCertificate,
                                              iteration:
                                              ...
                                              wincx:
                                                  *mut ::std::os::raw::c_void)
     -> *mut SECKEYEncryptedPrivateKeyInfo;
    pub fn PK11_FindKeyByDERCert(slot: *mut PK11SlotInfo,
                                 cert: *mut CERTCertificate,
                                 wincx: *mut ::std::os::raw::c_void)
     -> *mut SECKEYPrivateKey;
    pub fn PK11_MakeKEAPubKey(data: *mut ::std::os::raw::c_uchar,
                              length: ::std::os::raw::c_int)
     -> *mut SECKEYPublicKey;
    pub fn PK11_DigestKey(context: *mut PK11Context, key: *mut PK11SymKey)
     -> SECStatus;
    pub fn PK11_VerifyKeyOK(key: *mut PK11SymKey) -> PRBool;
    pub fn PK11_UnwrapPrivKey(slot: *mut PK11SlotInfo,
                              wrappingKey: *mut PK11SymKey,
                              wrapType: CK_MECHANISM_TYPE,
                              param: *mut SECItem, wrappedKey: *mut SECItem,
                              label: *mut SECItem, publicValue: *mut SECItem,
                              token: PRBool, sensitive: PRBool,
                              keyType: CK_KEY_TYPE,
                              usage: *mut CK_ATTRIBUTE_TYPE,
                              usageCount: ::std::os::raw::c_int,
                              wincx: *mut ::std::os::raw::c_void)
     -> *mut SECKEYPrivateKey;
    pub fn PK11_WrapPrivKey(slot: *mut PK11SlotInfo,
                            wrappingKey: *mut PK11SymKey,
                            privKey: *mut SECKEYPrivateKey,
                            wrapType: CK_MECHANISM_TYPE, param: *mut SECItem,
                            wrappedKey: *mut SECItem,
                            wincx: *mut ::std::os::raw::c_void) -> SECStatus;
    pub fn PK11_DEREncodePublicKey(pubk: *const SECKEYPublicKey)
     -> *mut SECItem;
    pub fn PK11_CopySymKeyForSigning(originalKey: *mut PK11SymKey,
                                     mech: CK_MECHANISM_TYPE)
     -> *mut PK11SymKey;
    pub fn PK11_ListPrivKeysInSlot(slot: *mut PK11SlotInfo,
                                   nickname: *mut ::std::os::raw::c_char,
                                   wincx: *mut ::std::os::raw::c_void)
     -> *mut SECKEYPrivateKeyList;
    pub fn PK11_ListPublicKeysInSlot(slot: *mut PK11SlotInfo,
                                     nickname: *mut ::std::os::raw::c_char)
     -> *mut SECKEYPublicKeyList;
    pub fn PK11_GetPQGParamsFromPrivateKey(privKey: *mut SECKEYPrivateKey)
     -> *mut SECKEYPQGParams;
    pub fn PK11_ListPrivateKeysInSlot(slot: *mut PK11SlotInfo)
     -> *mut SECKEYPrivateKeyList;
    pub fn PK11_ConvertSessionSymKeyToTokenSymKey(symk: *mut PK11SymKey,
                                                  wincx:
                                                      *mut ::std::os::raw::c_void)
     -> *mut PK11SymKey;
    pub fn PK11_ConvertSessionPrivKeyToTokenPrivKey(privk:
                                                        *mut SECKEYPrivateKey,
                                                    wincx:
                                                        *mut ::std::os::raw::c_void)
     -> *mut SECKEYPrivateKey;
    pub fn PK11_CopyTokenPrivKeyToSessionPrivKey(destSlot: *mut PK11SlotInfo,
                                                 privKey:
                                                     *mut SECKEYPrivateKey)
     -> *mut SECKEYPrivateKey;
    pub fn PK11_MakeIDFromPubKey(pubKeyData: *mut SECItem) -> *mut SECItem;
    pub fn PK11_TraverseSlotCerts(callback:
                                      ::std::option::Option<unsafe extern "C" fn(arg1:
                                                                                     *mut CERTCertificate,
                                                                                 arg2:
                                                                                     *mut SECItem,
                                  ...
                                  wincx: *mut ::std::os::raw::c_void)
     -> SECStatus;
    pub fn PK11_FindCertFromNickname(nickname: *const ::std::os::raw::c_char,
                                     wincx: *mut ::std::os::raw::c_void)
     -> *mut CERTCertificate;
    pub fn PK11_FindCertsFromEmailAddress(email:
                                              *const ::std::os::raw::c_char,
                                          wincx: *mut ::std::os::raw::c_void)
     -> *mut CERTCertList;
    pub fn PK11_FindCertsFromNickname(nickname: *const ::std::os::raw::c_char,
                                      wincx: *mut ::std::os::raw::c_void)
     -> *mut CERTCertList;
    pub fn PK11_GetCertFromPrivateKey(privKey: *mut SECKEYPrivateKey)
     -> *mut CERTCertificate;
    pub fn PK11_ImportCert(slot: *mut PK11SlotInfo,
                           cert: *mut CERTCertificate, key: CK_OBJECT_HANDLE,
                           nickname: *const ::std::os::raw::c_char,
                           includeTrust: PRBool) -> SECStatus;
    pub fn PK11_ImportDERCert(slot: *mut PK11SlotInfo, derCert: *mut SECItem,
                              key: CK_OBJECT_HANDLE,
                              nickname: *mut ::std::os::raw::c_char,
                              includeTrust: PRBool) -> SECStatus;
    pub fn PK11_ImportCertForKey(cert: *mut CERTCertificate,
                                 nickname: *const ::std::os::raw::c_char,
                                 wincx: *mut ::std::os::raw::c_void)
     -> *mut PK11SlotInfo;
    pub fn PK11_ImportDERCertForKey(derCert: *mut SECItem,
                                    nickname: *mut ::std::os::raw::c_char,
                                    wincx: *mut ::std::os::raw::c_void)
     -> *mut PK11SlotInfo;
    pub fn PK11_KeyForCertExists(cert: *mut CERTCertificate,
                                 keyPtr: *mut CK_OBJECT_HANDLE,
                                 wincx: *mut ::std::os::raw::c_void)
     -> *mut PK11SlotInfo;
    pub fn PK11_KeyForDERCertExists(derCert: *mut SECItem,
                                    keyPtr: *mut CK_OBJECT_HANDLE,
                                    wincx: *mut ::std::os::raw::c_void)
     -> *mut PK11SlotInfo;
    pub fn PK11_FindCertByIssuerAndSN(slot: *mut *mut PK11SlotInfo,
                                      sn: *mut CERTIssuerAndSN,
                                      wincx: *mut ::std::os::raw::c_void)
     -> *mut CERTCertificate;
    pub fn PK11_FindCertAndKeyByRecipientList(slot: *mut *mut PK11SlotInfo,
                                              array:
                                                  *mut *mut SEC_PKCS7RecipientInfo,
                                              rip:
                                                  *mut *mut SEC_PKCS7RecipientInfo,
                                              privKey:
                                                  *mut *mut SECKEYPrivateKey,
                                              wincx:
                                                  *mut ::std::os::raw::c_void)
     -> *mut CERTCertificate;
    pub fn PK11_FindCertAndKeyByRecipientListNew(recipientlist:
                                                     *mut *mut NSSCMSRecipient,
                                                 wincx:
                                                     *mut ::std::os::raw::c_void)
     -> ::std::os::raw::c_int;
    pub fn PK11_TraverseCertsForSubjectInSlot(cert: *mut CERTCertificate,
                                              ...
                                              arg:
                                                  *mut ::std::os::raw::c_void)
     -> SECStatus;
    pub fn PK11_FindCertFromDERCert(slot: *mut PK11SlotInfo,
                                    cert: *mut CERTCertificate,
                                    wincx: *mut ::std::os::raw::c_void)
     -> *mut CERTCertificate;
    pub fn PK11_FindCertFromDERCertItem(slot: *mut PK11SlotInfo,
                                        derCert: *const SECItem,
                                        wincx: *mut ::std::os::raw::c_void)
     -> *mut CERTCertificate;
    pub fn PK11_ImportCertForKeyToSlot(slot: *mut PK11SlotInfo,
                                       cert: *mut CERTCertificate,
                                       nickname: *mut ::std::os::raw::c_char,
                                       addUsage: PRBool,
                                       wincx: *mut ::std::os::raw::c_void)
     -> SECStatus;
    pub fn PK11_FindBestKEAMatch(serverCert: *mut CERTCertificate,
                                 wincx: *mut ::std::os::raw::c_void)
     -> *mut CERTCertificate;
    pub fn PK11_FortezzaHasKEA(cert: *mut CERTCertificate) -> PRBool;
    pub fn PK11_FindCertInSlot(slot: *mut PK11SlotInfo,
                               cert: *mut CERTCertificate,
                               wincx: *mut ::std::os::raw::c_void)
     -> CK_OBJECT_HANDLE;
    pub fn PK11_TraverseCertsForNicknameInSlot(nickname: *mut SECItem,
                                               slot: *mut PK11SlotInfo,
                                               callback:
                                                   ::std::option::Option<unsafe extern "C" fn(arg1:
                                                                                                  *mut CERTCertificate,
                                               ...
                                               arg:
                                                   *mut ::std::os::raw::c_void)
     -> SECStatus;
    pub fn PK11_ListCerts(type_: PK11CertListType,
                          pwarg: *mut ::std::os::raw::c_void)
     -> *mut CERTCertList;
    pub fn PK11_ListCertsInSlot(slot: *mut PK11SlotInfo) -> *mut CERTCertList;
    pub fn PK11_ImportCRL(slot: *mut PK11SlotInfo, derCRL: *mut SECItem,
                          url: *mut ::std::os::raw::c_char,
                          type_: ::std::os::raw::c_int,
                          wincx: *mut ::std::os::raw::c_void,
                          importOptions: PRInt32, arena: *mut PLArenaPool,
                          decodeOptions: PRInt32) -> *mut CERTSignedCrl;
    pub fn PK11_SignatureLen(key: *mut SECKEYPrivateKey)
     -> ::std::os::raw::c_int;
    pub fn PK11_GetSlotFromPrivateKey(key: *mut SECKEYPrivateKey)
     -> *mut PK11SlotInfo;
    pub fn PK11_Sign(key: *mut SECKEYPrivateKey, sig: *mut SECItem,
                     hash: *const SECItem) -> SECStatus;
    pub fn PK11_SignWithMechanism(key: *mut SECKEYPrivateKey,
                                  mechanism: CK_MECHANISM_TYPE,
                                  param: *const SECItem, sig: *mut SECItem,
                                  hash: *const SECItem) -> SECStatus;
    pub fn PK11_SignWithSymKey(symKey: *mut PK11SymKey,
                               mechanism: CK_MECHANISM_TYPE,
                               param: *mut SECItem, sig: *mut SECItem,
                               data: *const SECItem) -> SECStatus;
    pub fn PK11_VerifyRecover(key: *mut SECKEYPublicKey, sig: *const SECItem,
                              dsig: *mut SECItem,
                              wincx: *mut ::std::os::raw::c_void)
     -> SECStatus;
    pub fn PK11_Verify(key: *mut SECKEYPublicKey, sig: *const SECItem,
                       hash: *const SECItem,
                       wincx: *mut ::std::os::raw::c_void) -> SECStatus;
    pub fn PK11_VerifyWithMechanism(key: *mut SECKEYPublicKey,
                                    mechanism: CK_MECHANISM_TYPE,
                                    param: *const SECItem,
                                    sig: *const SECItem, hash: *const SECItem,
                                    wincx: *mut ::std::os::raw::c_void)
     -> SECStatus;
    pub fn PK11_DestroyContext(context: *mut PK11Context, freeit: PRBool);
    pub fn PK11_CreateContextBySymKey(type_: CK_MECHANISM_TYPE,
                                      operation: CK_ATTRIBUTE_TYPE,
                                      symKey: *mut PK11SymKey,
                                      param: *mut SECItem)
     -> *mut PK11Context;
    pub fn PK11_CreateDigestContext(hashAlg: SECOidTag) -> *mut PK11Context;
    pub fn PK11_CloneContext(old: *mut PK11Context) -> *mut PK11Context;
    pub fn PK11_DigestBegin(cx: *mut PK11Context) -> SECStatus;
    pub fn PK11_HashBuf(hashAlg: SECOidTag, out: *mut ::std::os::raw::c_uchar,
                        in_: *const ::std::os::raw::c_uchar, len: PRInt32)
     -> SECStatus;
    pub fn PK11_DigestOp(context: *mut PK11Context,
                         in_: *const ::std::os::raw::c_uchar,
                         len: ::std::os::raw::c_uint) -> SECStatus;
    pub fn PK11_CipherOp(context: *mut PK11Context,
                         out: *mut ::std::os::raw::c_uchar,
                         outlen: *mut ::std::os::raw::c_int,
                         maxout: ::std::os::raw::c_int,
                         in_: *const ::std::os::raw::c_uchar,
                         inlen: ::std::os::raw::c_int) -> SECStatus;
    pub fn PK11_Finalize(context: *mut PK11Context) -> SECStatus;
    pub fn PK11_DigestFinal(context: *mut PK11Context,
                            data: *mut ::std::os::raw::c_uchar,
                            outLen: *mut ::std::os::raw::c_uint,
                            length: ::std::os::raw::c_uint) -> SECStatus;
    pub fn PK11_SaveContext(cx: *mut PK11Context,
                            save: *mut ::std::os::raw::c_uchar,
                            len: *mut ::std::os::raw::c_int,
                            saveLength: ::std::os::raw::c_int) -> SECStatus;
    pub fn PK11_SaveContextAlloc(cx: *mut PK11Context,
                                 preAllocBuf: *mut ::std::os::raw::c_uchar,
                                 pabLen: ::std::os::raw::c_uint,
                                 stateLen: *mut ::std::os::raw::c_uint)
     -> *mut ::std::os::raw::c_uchar;
    pub fn PK11_RestoreContext(cx: *mut PK11Context,
                               save: *mut ::std::os::raw::c_uchar,
                               len: ::std::os::raw::c_int) -> SECStatus;
    pub fn PK11_GenerateFortezzaIV(symKey: *mut PK11SymKey,
                                   iv: *mut ::std::os::raw::c_uchar,
                                   len: ::std::os::raw::c_int) -> SECStatus;
    pub fn PK11_SetFortezzaHack(symKey: *mut PK11SymKey);
    pub fn PK11_CreatePBEParams(salt: *mut SECItem, pwd: *mut SECItem,
                                iterations: ::std::os::raw::c_uint)
     -> *mut SECItem;
    pub fn PK11_DestroyPBEParams(params: *mut SECItem);
    pub fn PK11_CreatePBEAlgorithmID(algorithm: SECOidTag,
                                     iteration: ::std::os::raw::c_int,
                                     salt: *mut SECItem)
     -> *mut SECAlgorithmID;
    pub fn PK11_CreatePBEV2AlgorithmID(pbeAlgTag: SECOidTag,
                                       cipherAlgTag: SECOidTag,
                                       prfAlgTag: SECOidTag,
    ...
    pub fn PK11_PBEKeyGen(slot: *mut PK11SlotInfo, algid: *mut SECAlgorithmID,
                          pwitem: *mut SECItem, faulty3DES: PRBool,
                          wincx: *mut ::std::os::raw::c_void)
     -> *mut PK11SymKey;
    pub fn PK11_RawPBEKeyGen(slot: *mut PK11SlotInfo,
                             type_: CK_MECHANISM_TYPE, params: *mut SECItem,
                             pwitem: *mut SECItem, faulty3DES: PRBool,
                             wincx: *mut ::std::os::raw::c_void)
     -> *mut PK11SymKey;
    pub fn PK11_GetPBEIV(algid: *mut SECAlgorithmID, pwitem: *mut SECItem)
     -> *mut SECItem;
    pub fn PK11_GetPBECryptoMechanism(algid: *mut SECAlgorithmID,
                                      param: *mut *mut SECItem,
                                      pwd: *mut SECItem) -> CK_MECHANISM_TYPE;
    pub fn PK11_GetDefaultArray(size: *mut ::std::os::raw::c_int)
     -> *const PK11DefaultArrayEntry;
    pub fn PK11_UpdateSlotAttribute(slot: *mut PK11SlotInfo,
                                    entry: *const PK11DefaultArrayEntry,
                                    add: PRBool) -> SECStatus;
    pub fn PK11_FindGenericObjects(slot: *mut PK11SlotInfo,
                                   objClass: CK_OBJECT_CLASS)
     -> *mut PK11GenericObject;
    pub fn PK11_GetNextGenericObject(object: *mut PK11GenericObject)
     -> *mut PK11GenericObject;
    pub fn PK11_GetPrevGenericObject(object: *mut PK11GenericObject)
     -> *mut PK11GenericObject;
    pub fn PK11_UnlinkGenericObject(object: *mut PK11GenericObject)
     -> SECStatus;
    pub fn PK11_LinkGenericObject(list: *mut PK11GenericObject,
                                  object: *mut PK11GenericObject)
     -> SECStatus;
    pub fn PK11_DestroyGenericObjects(object: *mut PK11GenericObject)
     -> SECStatus;
    pub fn PK11_DestroyGenericObject(object: *mut PK11GenericObject)
     -> SECStatus;
    pub fn PK11_CreateGenericObject(slot: *mut PK11SlotInfo,
                                    pTemplate: *const CK_ATTRIBUTE,
                                    count: ::std::os::raw::c_int,
                                    token: PRBool) -> *mut PK11GenericObject;
    pub fn PK11_ReadRawAttribute(type_: PK11ObjectType,
                                 object: *mut ::std::os::raw::c_void,
                                 attr: CK_ATTRIBUTE_TYPE, item: *mut SECItem)
     -> SECStatus;
    pub fn PK11_WriteRawAttribute(type_: PK11ObjectType,
                                  object: *mut ::std::os::raw::c_void,
                                  attr: CK_ATTRIBUTE_TYPE, item: *mut SECItem)
     -> SECStatus;
    pub fn PK11_GetAllSlotsForCert(cert: *mut CERTCertificate,
                                   arg: *mut ::std::os::raw::c_void)
     -> *mut PK11SlotList;
    pub fn PK11_GetLowLevelKeyIDForCert(slot: *mut PK11SlotInfo,
                                        cert: *mut CERTCertificate,
                                        pwarg: *mut ::std::os::raw::c_void)
     -> *mut SECItem;
    pub fn PK11_GetLowLevelKeyIDForPrivateKey(key: *mut SECKEYPrivateKey)
     -> *mut SECItem;
    pub fn SECMOD_HasRootCerts() -> PRBool;
    pub fn PK11_NewSlotList() -> *mut PK11SlotList;
    pub fn PK11_GetPrivateKeyTokens(type_: CK_MECHANISM_TYPE, needRW: PRBool,
                                    wincx: *mut ::std::os::raw::c_void)
     -> *mut PK11SlotList;
    pub fn PK11_AddSlotToList(list: *mut PK11SlotList,
                              slot: *mut PK11SlotInfo, sorted: PRBool)
     -> SECStatus;
    pub fn PK11_DeleteSlotFromList(list: *mut PK11SlotList,
                                   le: *mut PK11SlotListElement) -> SECStatus;
    pub fn PK11_FindSlotElement(list: *mut PK11SlotList,
                                slot: *mut PK11SlotInfo)
     -> *mut PK11SlotListElement;
    pub fn PK11_FindSlotBySerial(serial: *mut ::std::os::raw::c_char)
     -> *mut PK11SlotInfo;
    pub fn PK11_GetMaxKeyLength(type_: CK_MECHANISM_TYPE)
     -> ::std::os::raw::c_int;
    pub fn PK11_CopyKey(slot: *mut PK11SlotInfo, srcObject: CK_OBJECT_HANDLE)
     -> CK_OBJECT_HANDLE;
    pub fn PK11_ReadAttribute(slot: *mut PK11SlotInfo, id: CK_OBJECT_HANDLE,
                              type_: CK_ATTRIBUTE_TYPE,
                              arena: *mut PLArenaPool, result: *mut SECItem)
     -> SECStatus;
    pub fn PK11_ReadULongAttribute(slot: *mut PK11SlotInfo,
                                   id: CK_OBJECT_HANDLE,
                                   type_: CK_ATTRIBUTE_TYPE) -> CK_ULONG;
    pub fn PK11_MakeString(arena: *mut PLArenaPool,
                           space: *mut ::std::os::raw::c_char,
                           staticSring: *mut ::std::os::raw::c_char,
                           stringLen: ::std::os::raw::c_int)
     -> *mut ::std::os::raw::c_char;
    pub fn PK11_MapError(error: CK_RV) -> ::std::os::raw::c_int;
    pub fn PK11_GetRWSession(slot: *mut PK11SlotInfo) -> CK_SESSION_HANDLE;
    pub fn PK11_RestoreROSession(slot: *mut PK11SlotInfo,
                                 rwsession: CK_SESSION_HANDLE);
    pub fn PK11_RWSessionHasLock(slot: *mut PK11SlotInfo,
                                 session_handle: CK_SESSION_HANDLE) -> PRBool;
    pub fn PK11_NewSlotInfo(mod_: *mut SECMODModule) -> *mut PK11SlotInfo;
    pub fn PK11_EnterSlotMonitor(arg1: *mut PK11SlotInfo);
    pub fn PK11_ExitSlotMonitor(arg1: *mut PK11SlotInfo);
    pub fn PK11_CleanKeyList(slot: *mut PK11SlotInfo);
    pub fn PK11_DoPassword(slot: *mut PK11SlotInfo,
                           session: CK_SESSION_HANDLE, loadCerts: PRBool,
                           wincx: *mut ::std::os::raw::c_void,
                           alreadyLocked: PRBool, contextSpecific: PRBool)
     -> SECStatus;
    pub fn PK11_VerifyPW(slot: *mut PK11SlotInfo,
                         pw: *mut ::std::os::raw::c_char) -> SECStatus;
    pub fn PK11_HandlePasswordCheck(slot: *mut PK11SlotInfo,
                                    wincx: *mut ::std::os::raw::c_void);
    pub fn PK11_SetVerifyPasswordFunc(func: PK11VerifyPasswordFunc);
    pub fn PK11_SetIsLoggedInFunc(func: PK11IsLoggedInFunc);
    pub fn PK11_InitSlotLists() -> SECStatus;
    pub fn PK11_DestroySlotLists();
    pub fn PK11_GetSlotList(type_: CK_MECHANISM_TYPE) -> *mut PK11SlotList;
    pub fn PK11_LoadSlotList(slot: *mut PK11SlotInfo,
                             psi: *mut PK11PreSlotInfo,
                             count: ::std::os::raw::c_int);
    pub fn PK11_ClearSlotList(slot: *mut PK11SlotInfo);
    pub fn PK11_InitToken(slot: *mut PK11SlotInfo, loadCerts: PRBool)
     -> SECStatus;
    pub fn PK11_InitSlot(mod_: *mut SECMODModule, slotID: CK_SLOT_ID,
                         slot: *mut PK11SlotInfo);
    pub fn PK11_NeedPWInitForSlot(slot: *mut PK11SlotInfo) -> PRBool;
    pub fn PK11_ReadSlotCerts(slot: *mut PK11SlotInfo) -> SECStatus;
    pub fn pk11_SetInternalKeySlot(slot: *mut PK11SlotInfo);
    pub fn pk11_SwapInternalKeySlot(slot: *mut PK11SlotInfo)
     -> *mut PK11SlotInfo;
    pub fn pk11_SetInternalKeySlotIfFirst(slot: *mut PK11SlotInfo);
    pub fn PK11_AddMechanismEntry(type_: CK_MECHANISM_TYPE, key: CK_KEY_TYPE,
                                  keygen: CK_MECHANISM_TYPE,
                                  pad: CK_MECHANISM_TYPE,
                                  ivLen: ::std::os::raw::c_int,
                                  blocksize: ::std::os::raw::c_int);
    pub fn PK11_GetKeyMechanism(type_: CK_KEY_TYPE) -> CK_MECHANISM_TYPE;
    pub fn PK11_GetKeyGenWithSize(type_: CK_MECHANISM_TYPE,
                                  size: ::std::os::raw::c_int)
     -> CK_MECHANISM_TYPE;
    pub fn PK11_GenDES3TokenKey(slot: *mut PK11SlotInfo, keyid: *mut SECItem,
                                cx: *mut ::std::os::raw::c_void)
     -> *mut PK11SymKey;
    pub fn PK11_ExtractPublicKey(slot: *mut PK11SlotInfo, keyType: KeyType,
                                 id: CK_OBJECT_HANDLE)
     -> *mut SECKEYPublicKey;
    pub fn PK11_FindObjectForCert(cert: *mut CERTCertificate,
                                  wincx: *mut ::std::os::raw::c_void,
                                  pSlot: *mut *mut PK11SlotInfo)
     -> CK_OBJECT_HANDLE;
    pub fn pk11_CopyToSlot(slot: *mut PK11SlotInfo, type_: CK_MECHANISM_TYPE,
                           operation: CK_ATTRIBUTE_TYPE,
                           symKey: *mut PK11SymKey) -> *mut PK11SymKey;
    pub fn PK11_TraversePrivateKeysInSlot(slot: *mut PK11SlotInfo,
                                          callback:
                                              ::std::option::Option<unsafe extern "C" fn(arg1:
                                                                                             *mut SECKEYPrivateKey,
                                                                                         arg2:
                                          ...
                                          arg: *mut ::std::os::raw::c_void)
     -> SECStatus;
    pub fn PK11_FindPrivateKeyFromNickname(nickname:
                                               *mut ::std::os::raw::c_char,
                                           wincx: *mut ::std::os::raw::c_void)
     -> *mut SECKEYPrivateKey;
    pub fn PK11_FindObjectsFromNickname(nickname: *mut ::std::os::raw::c_char,
                                        slotptr: *mut *mut PK11SlotInfo,
                                        objclass: CK_OBJECT_CLASS,
                                        returnCount:
                                            *mut ::std::os::raw::c_int,
                                        wincx: *mut ::std::os::raw::c_void)
     -> *mut CK_OBJECT_HANDLE;
    pub fn PK11_MatchItem(slot: *mut PK11SlotInfo, peer: CK_OBJECT_HANDLE,
                          o_class: CK_OBJECT_CLASS) -> CK_OBJECT_HANDLE;
    pub fn PK11_HasAttributeSet(slot: *mut PK11SlotInfo, id: CK_OBJECT_HANDLE,
                                type_: CK_ATTRIBUTE_TYPE, haslock: PRBool)
     -> CK_BBOOL;
    pub fn PK11_GetAttributes(arena: *mut PLArenaPool,
                              slot: *mut PK11SlotInfo, obj: CK_OBJECT_HANDLE,
                              attr: *mut CK_ATTRIBUTE,
                              count: ::std::os::raw::c_int) -> CK_RV;
    pub fn PK11_NumberCertsForCertSubject(cert: *mut CERTCertificate)
     -> ::std::os::raw::c_int;
    pub fn PK11_TraverseCertsForSubject(cert: *mut CERTCertificate,
                                        callback:
                                            ::std::option::Option<unsafe extern "C" fn(arg1:
                                                                                           *mut CERTCertificate,
                                                                                       arg2:
                                        ...
                                        arg: *mut ::std::os::raw::c_void)
     -> SECStatus;
    pub fn PK11_GetKEAMatchedCerts(slot1: *mut PK11SlotInfo,
                                   slot2: *mut PK11SlotInfo,
                                   cert1: *mut *mut CERTCertificate,
                                   cert2: *mut *mut CERTCertificate)
     -> SECStatus;
    pub fn PK11_TraverseCertsInSlot(slot: *mut PK11SlotInfo,
                                    callback:
                                        ::std::option::Option<unsafe extern "C" fn(arg1:
                                                                                       *mut CERTCertificate,
                                                                                   arg2:
                                    ...
                                    arg: *mut ::std::os::raw::c_void)
     -> SECStatus;
    pub fn PK11_LookupCrls(nodes: *mut CERTCrlHeadNode,
                           type_: ::std::os::raw::c_int,
                           wincx: *mut ::std::os::raw::c_void) -> SECStatus;
    pub fn PK11_CreateContextByRawKey(slot: *mut PK11SlotInfo,
                                      type_: CK_MECHANISM_TYPE,
                                      origin: PK11Origin,
                                      operation: CK_ATTRIBUTE_TYPE,
                                      key: *mut SECItem, param: *mut SECItem,
                                      wincx: *mut ::std::os::raw::c_void)
     -> *mut PK11Context;
    pub fn PK11_HashOK(hashAlg: SECOidTag) -> PRBool;
    pub fn PK11_FindCrlByName(slot: *mut *mut PK11SlotInfo,
                              handle: *mut CK_OBJECT_HANDLE,
                              derName: *mut SECItem,
                              type_: ::std::os::raw::c_int,
                              url: *mut *mut ::std::os::raw::c_char)
     -> *mut SECItem;
    pub fn PK11_PutCrl(slot: *mut PK11SlotInfo, crl: *mut SECItem,
                       name: *mut SECItem, url: *mut ::std::os::raw::c_char,
                       type_: ::std::os::raw::c_int) -> CK_OBJECT_HANDLE;
    pub fn PK11_FindSMimeProfile(slotp: *mut *mut PK11SlotInfo,
                                 emailAddr: *mut ::std::os::raw::c_char,
                                 derSubj: *mut SECItem,
                                 profileTime: *mut *mut SECItem)
     -> *mut SECItem;
    pub fn PK11_SaveSMimeProfile(slot: *mut PK11SlotInfo,
                                 emailAddr: *mut ::std::os::raw::c_char,
                                 derSubj: *mut SECItem,
                                 emailProfile: *mut SECItem,
                                 profileTime: *mut SECItem) -> SECStatus;
    pub fn PK11_IsPermObject(slot: *mut PK11SlotInfo,
                             handle: CK_OBJECT_HANDLE) -> PRBool;
    pub fn PK11_GetObjectNickname(slot: *mut PK11SlotInfo,
                                  id: CK_OBJECT_HANDLE)
     -> *mut ::std::os::raw::c_char;
    pub fn PK11_SetObjectNickname(slot: *mut PK11SlotInfo,
                                  id: CK_OBJECT_HANDLE,
                                  nickname: *const ::std::os::raw::c_char)
     -> SECStatus;
    pub fn pk11_TraverseAllSlots(callback:
                                     ::std::option::Option<unsafe extern "C" fn(arg1:
                                                                                    *mut PK11SlotInfo,
                                                                                arg2:
                                                                                    *mut ::std::os::raw::c_void)
                                 ...
                                 pwArg: *mut ::std::os::raw::c_void)
     -> SECStatus;
    pub fn pk11_RetrieveCrls(nodes: *mut CERTCrlHeadNode,
                             issuer: *mut SECItem,
                             wincx: *mut ::std::os::raw::c_void) -> SECStatus;
    pub fn pk11_setGlobalOptions(noSingleThreadedModules: PRBool,
                                 allowAlreadyInitializedModules: PRBool,
                                 dontFinalizeModules: PRBool) -> SECStatus;
    pub fn pk11_getFinalizeModulesOption() -> PRBool;
}
