...
#[repr(u32)]
#[derive(Debug)]
pub enum CRMFCertTemplateField {
    crmfVersion = 0,
    crmfSerialNumber = 1,
    crmfSigningAlg = 2,
    crmfIssuer = 3,
...
#[repr(u32)]
#[derive(Debug)]
pub enum CRMFPublicationAction { crmfDontPublish = 0, crmfPleasePublish = 1, }
#[derive(Copy, Clone)]
#[repr(u32)]
#[derive(Debug)]
pub enum CRMFPublicationMethod {
    crmfDontCare = 0,
    crmfX500 = 1,
    crmfWeb = 2,
    crmfLdap = 3,
...
#[repr(u32)]
#[derive(Debug)]
pub enum CRMFPKIArchiveOptionsType {
...
#[repr(u32)]
#[derive(Debug)]
pub enum CRMFPOPOSkiInputAuthChoice { crmfSender = 0, crmfPublicKeyMAC = 1, }
#[derive(Copy, Clone)]
#[repr(u32)]
#[derive(Debug)]
pub enum CRMFSubseqMessOptions {
    crmfNoSubseqMess = 0,
    crmfEncrCert = 1,
    crmfChallengeResp = 2,
}
...
#[repr(u32)]
#[derive(Debug)]
pub enum CRMFPOPOPrivKeyChoice {
    crmfNoMessage = 0,
    crmfThisMessage = 1,
...
#[repr(u32)]
#[derive(Debug)]
pub enum CRMFEncryptedKeyChoice {
    crmfNoEncryptedKeyChoice = 0,
    crmfEncryptedValueChoice = 1,
    crmfEnvelopedDataChoice = 2,
}
pub type CRMFEncoderOutputCallback =
    ::std::option::Option<unsafe extern "C" fn(arg:
                                                   *mut ::std::os::raw::c_void,
                                               buf:
                                                   *const ::std::os::raw::c_char,
                                               len: ::std::os::raw::c_ulong)>;
pub type CRMFMACPasswordCallback =
    ::std::option::Option<unsafe extern "C" fn(arg:
                                                   *mut ::std::os::raw::c_void)
                              -> *mut SECItem>;
pub enum CRMFOptionalValidityStr { }
pub type CRMFOptionalValidity = CRMFOptionalValidityStr;
pub type CRMFGetValidity = CRMFValidityCreationInfoStr;
pub enum CRMFCertTemplateStr { }
pub type CRMFCertTemplate = CRMFCertTemplateStr;
pub enum CRMFCertRequestStr { }
pub type CRMFCertRequest = CRMFCertRequestStr;
pub enum CRMFCertReqMsgStr { }
pub type CRMFCertReqMsg = CRMFCertReqMsgStr;
pub enum CRMFCertReqMessagesStr { }
pub type CRMFCertReqMessages = CRMFCertReqMessagesStr;
pub enum CRMFProofOfPossessionStr { }
pub type CRMFProofOfPossession = CRMFProofOfPossessionStr;
pub enum CRMFPOPOSigningKeyStr { }
pub type CRMFPOPOSigningKey = CRMFPOPOSigningKeyStr;
pub enum CRMFPOPOSigningKeyInputStr { }
pub type CRMFPOPOSigningKeyInput = CRMFPOPOSigningKeyInputStr;
pub enum CRMFPOPOPrivKeyStr { }
pub type CRMFPOPOPrivKey = CRMFPOPOPrivKeyStr;
pub enum CRMFPKIPublicationInfoStr { }
pub type CRMFPKIPublicationInfo = CRMFPKIPublicationInfoStr;
pub enum CRMFSinglePubInfoStr { }
pub type CRMFSinglePubInfo = CRMFSinglePubInfoStr;
pub enum CRMFPKIArchiveOptionsStr { }
pub type CRMFPKIArchiveOptions = CRMFPKIArchiveOptionsStr;
pub enum CRMFEncryptedKeyStr { }
pub type CRMFEncryptedKey = CRMFEncryptedKeyStr;
pub enum CRMFEncryptedValueStr { }
pub type CRMFEncryptedValue = CRMFEncryptedValueStr;
pub enum CRMFCertIDStr { }
pub type CRMFCertID = CRMFCertIDStr;
pub type CRMFOldCertID = CRMFCertIDStr;
pub type CRMFProtocolEncrKey = CERTSubjectPublicKeyInfo;
pub type CRMFValidityCreationInfo = CRMFValidityCreationInfoStr;
pub type CRMFCertExtCreationInfo = CRMFCertExtCreationInfoStr;
pub enum CRMFPKMACValueStr { }
pub type CRMFPKMACValue = CRMFPKMACValueStr;
pub enum CRMFAttributeStr { }
pub type CRMFAttribute = CRMFAttributeStr;
pub enum CRMFControlStr { }
pub type CRMFControl = CRMFControlStr;
pub type CRMFGeneralName = CERTGeneralName;
pub enum CRMFCertExtensionStr { }
pub type CRMFCertExtension = CRMFCertExtensionStr;
#[repr(C)]
#[derive(Copy, Clone)]
#[derive(Debug)]
pub struct CRMFValidityCreationInfoStr {
    pub notBefore: *mut PRTime,
    pub notAfter: *mut PRTime,
}
impl ::std::default::Default for CRMFValidityCreationInfoStr {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
#[repr(C)]
#[derive(Copy, Clone)]
#[derive(Debug)]
pub struct CRMFCertExtCreationInfoStr {
    pub extensions: *mut *mut CRMFCertExtension,
    pub numExtensions: ::std::os::raw::c_int,
    _bindgen_padding_0_: [u8; 4usize],
}
impl ::std::default::Default for CRMFCertExtCreationInfoStr {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
...
extern "C" {
    ...
    pub static mut CRMFCertReqMessagesTemplate: [SEC_ASN1Template; 0usize];
    pub static mut CRMFCertRequestTemplate: [SEC_ASN1Template; 0usize];
...
extern "C" {
    ...
    pub fn SEC_PKCS7GetKeyLength(cinfo: *mut SEC_PKCS7ContentInfo)
     -> ::std::os::raw::c_int;
    pub fn CRMF_EncodeCertReqMsg(inCertReqMsg: *mut CRMFCertReqMsg,
                                 fn_: CRMFEncoderOutputCallback,
                                 arg: *mut ::std::os::raw::c_void)
     -> SECStatus;
    pub fn CRMF_EncodeCertRequest(inCertReq: *mut CRMFCertRequest,
                                  fn_: CRMFEncoderOutputCallback,
                                  arg: *mut ::std::os::raw::c_void)
     -> SECStatus;
    pub fn CRMF_EncodeCertReqMessages(inCertReqMsgs: *mut *mut CRMFCertReqMsg,
                                      fn_: CRMFEncoderOutputCallback,
                                      arg: *mut ::std::os::raw::c_void)
     -> SECStatus;
    pub fn CRMF_CreateCertReqMsg() -> *mut CRMFCertReqMsg;
    pub fn CRMF_DestroyCertReqMsg(inCertReqMsg: *mut CRMFCertReqMsg)
     -> SECStatus;
    pub fn CRMF_CertReqMsgSetCertRequest(inCertReqMsg: *mut CRMFCertReqMsg,
                                         inCertReq: *mut CRMFCertRequest)
     -> SECStatus;
    pub fn CRMF_CreateCertRequest(inRequestID: PRUint32)
     -> *mut CRMFCertRequest;
    pub fn CRMF_DestroyCertRequest(inCertReq: *mut CRMFCertRequest)
     -> SECStatus;
    pub fn CRMF_CreateCertExtension(id: SECOidTag, isCritical: PRBool,
                                    data: *mut SECItem)
     -> *mut CRMFCertExtension;
    pub fn CRMF_DestroyCertExtension(inExtension: *mut CRMFCertExtension)
     -> SECStatus;
    pub fn CRMF_CertRequestSetTemplateField(inCertReq: *mut CRMFCertRequest,
                                            inTemplateField:
                                                CRMFCertTemplateField,
                                            data: *mut ::std::os::raw::c_void)
     -> SECStatus;
    pub fn CRMF_CertRequestIsFieldPresent(inCertReq: *mut CRMFCertRequest,
                                          inTemplateField:
                                              CRMFCertTemplateField)
     -> PRBool;
    pub fn CRMF_CertRequestIsControlPresent(inCertReq: *mut CRMFCertRequest,
                                            inControlType: CRMFControlType)
     -> PRBool;
    pub fn CRMF_CertRequestSetRegTokenControl(inCertReq: *mut CRMFCertRequest,
                                              value: *mut SECItem)
     -> SECStatus;
    pub fn CRMF_CertRequestSetAuthenticatorControl(inCertReq:
                                                       *mut CRMFCertRequest,
                                                   value: *mut SECItem)
     -> SECStatus;
    pub fn CRMF_CreateEncryptedKeyWithEncryptedValue(inPrivKey:
                                                         *mut SECKEYPrivateKey,
                                                     inCACert:
                                                         *mut CERTCertificate)
     -> *mut CRMFEncryptedKey;
    pub fn CRMF_DestroyEncryptedKey(inEncrKey: *mut CRMFEncryptedKey)
     -> SECStatus;
    pub fn CRMF_CreatePKIArchiveOptions(inType: CRMFPKIArchiveOptionsType,
                                        data: *mut ::std::os::raw::c_void)
     -> *mut CRMFPKIArchiveOptions;
    pub fn CRMF_DestroyPKIArchiveOptions(inOptions:
                                             *mut CRMFPKIArchiveOptions)
     -> SECStatus;
    pub fn CRMF_CertRequestSetPKIArchiveOptions(inCertReq:
                                                    *mut CRMFCertRequest,
                                                inOptions:
                                                    *mut CRMFPKIArchiveOptions)
     -> SECStatus;
    pub fn CRMF_CertReqMsgGetPOPType(inCertReqMsg: *mut CRMFCertReqMsg)
     -> CRMFPOPChoice;
    pub fn CRMF_CertReqMsgSetRAVerifiedPOP(inCertReqMsg: *mut CRMFCertReqMsg)
     -> SECStatus;
    pub fn CRMF_CertReqMsgSetSignaturePOP(inCertReqMsg: *mut CRMFCertReqMsg,
                                          inPrivKey: *mut SECKEYPrivateKey,
                                          inPubKey: *mut SECKEYPublicKey,
                                          inCertForInput:
                                              *mut CERTCertificate,
                                          fn_: CRMFMACPasswordCallback,
                                          arg: *mut ::std::os::raw::c_void)
     -> SECStatus;
    pub fn CRMF_CertReqMsgSetKeyEnciphermentPOP(inCertReqMsg:
                                                    *mut CRMFCertReqMsg,
                                                inKeyChoice:
                                                    CRMFPOPOPrivKeyChoice,
                                                subseqMess:
                                                    CRMFSubseqMessOptions,
                                                encPrivKey: *mut SECItem)
     -> SECStatus;
    pub fn CRMF_CertReqMsgSetKeyAgreementPOP(inCertReqMsg:
                                                 *mut CRMFCertReqMsg,
                                             inKeyChoice:
                                                 CRMFPOPOPrivKeyChoice,
                                             subseqMess:
                                             ...
                                             encPrivKey: *mut SECItem)
     -> SECStatus;
    pub fn CRMF_CreateCertReqMsgFromDER(buf: *const ::std::os::raw::c_char,
                                        len: ::std::os::raw::c_long)
     -> *mut CRMFCertReqMsg;
    pub fn CRMF_CreateCertReqMessagesFromDER(buf:
                                                 *const ::std::os::raw::c_char,
                                             len: ::std::os::raw::c_long)
     -> *mut CRMFCertReqMessages;
    pub fn CRMF_DestroyCertReqMessages(inCertReqMsgs:
                                           *mut CRMFCertReqMessages)
     -> SECStatus;
    pub fn CRMF_CertReqMessagesGetNumMessages(inCertReqMsgs:
                                                  *mut CRMFCertReqMessages)
     -> ::std::os::raw::c_int;
    pub fn CRMF_CertReqMessagesGetCertReqMsgAtIndex(inReqMsgs:
                                                        *mut CRMFCertReqMessages,
                                                    index:
                                                        ::std::os::raw::c_int)
     -> *mut CRMFCertReqMsg;
    pub fn CRMF_CertReqMsgGetID(inCertReqMsg: *mut CRMFCertReqMsg,
                                destID: *mut ::std::os::raw::c_long)
     -> SECStatus;
    pub fn CRMF_DoesRequestHaveField(inCertReq: *mut CRMFCertRequest,
                                     inField: CRMFCertTemplateField)
     -> PRBool;
    pub fn CRMF_CertReqMsgGetCertRequest(inCertReqMsg: *mut CRMFCertReqMsg)
     -> *mut CRMFCertRequest;
    pub fn CRMF_CertRequestGetCertTemplateVersion(inCertReq:
                                                      *mut CRMFCertRequest,
                                                  version:
                                                      *mut ::std::os::raw::c_long)
     -> SECStatus;
    pub fn CRMF_CertRequestGetCertTemplateSerialNumber(inCertReq:
                                                           *mut CRMFCertRequest,
                                                       serialNumber:
                                                           *mut ::std::os::raw::c_long)
     -> SECStatus;
    pub fn CRMF_CertRequestGetCertTemplateSigningAlg(inCertReq:
                                                         *mut CRMFCertRequest,
                                                     destAlg:
                                                         *mut SECAlgorithmID)
     -> SECStatus;
    pub fn CRMF_CertRequestGetCertTemplateIssuer(inCertReq:
                                                     *mut CRMFCertRequest,
                                                 destIssuer: *mut CERTName)
     -> SECStatus;
    pub fn CRMF_CertRequestGetCertTemplateValidity(inCertReq:
                                                       *mut CRMFCertRequest,
                                                   destValidity:
                                                       *mut CRMFGetValidity)
     -> SECStatus;
    pub fn CRMF_DestroyGetValidity(inValidity: *mut CRMFGetValidity)
     -> SECStatus;
    pub fn CRMF_CertRequestGetCertTemplateSubject(inCertReq:
                                                      *mut CRMFCertRequest,
                                                  destSubject: *mut CERTName)
     -> SECStatus;
    pub fn CRMF_CertRequestGetCertTemplatePublicKey(inCertReq:
                                                        *mut CRMFCertRequest,
                                                    destPublicKey:
                                                        *mut CERTSubjectPublicKeyInfo)
     -> SECStatus;
    pub fn CRMF_CertRequestGetCertTemplateIssuerUID(inCertReq:
                                                        *mut CRMFCertRequest,
                                                    destIssuerUID:
                                                        *mut SECItem)
     -> SECStatus;
    pub fn CRMF_GetCertTemplateSubjectUID(inCertReq: *mut CRMFCertRequest,
                                          destSubjectUID: *mut SECItem)
     -> SECStatus;
    pub fn CRMF_CertRequestGetNumberOfExtensions(inCertReq:
                                                     *mut CRMFCertRequest)
     -> ::std::os::raw::c_int;
    pub fn CRMF_CertRequestGetExtensionAtIndex(inCertReq:
                                                   *mut CRMFCertRequest,
                                               index: ::std::os::raw::c_int)
     -> *mut CRMFCertExtension;
    pub fn CRMF_CertExtensionGetOidTag(inExtension: *mut CRMFCertExtension)
     -> SECOidTag;
    pub fn CRMF_CertExtensionGetIsCritical(inExt: *mut CRMFCertExtension)
     -> PRBool;
    pub fn CRMF_CertExtensionGetValue(inExtension: *mut CRMFCertExtension)
     -> *mut SECItem;
    pub fn CRMF_CertReqMsgGetPOPOSigningKey(inCertReqMsg: *mut CRMFCertReqMsg,
                                            destKey:
                                                *mut *mut CRMFPOPOSigningKey)
     -> SECStatus;
    pub fn CRMF_DestroyPOPOSigningKey(inKey: *mut CRMFPOPOSigningKey)
     -> SECStatus;
    pub fn CRMF_POPOSigningKeyGetAlgID(inSignKey: *mut CRMFPOPOSigningKey)
     -> *mut SECAlgorithmID;
    pub fn CRMF_POPOSigningKeyGetSignature(inSignKey: *mut CRMFPOPOSigningKey)
     -> *mut SECItem;
    pub fn CRMF_POPOSigningKeyGetInput(inSignKey: *mut CRMFPOPOSigningKey)
     -> *mut SECItem;
    pub fn CRMF_CertReqMsgGetPOPKeyEncipherment(inCertReqMsg:
                                                    *mut CRMFCertReqMsg,
                                                destKey:
                                                    *mut *mut CRMFPOPOPrivKey)
     -> SECStatus;
    pub fn CRMF_CertReqMsgGetPOPKeyAgreement(inCertReqMsg:
                                                 *mut CRMFCertReqMsg,
                                             destKey:
                                                 *mut *mut CRMFPOPOPrivKey)
     -> SECStatus;
    pub fn CRMF_DestroyPOPOPrivKey(inPrivKey: *mut CRMFPOPOPrivKey)
     -> SECStatus;
    pub fn CRMF_POPOPrivKeyGetChoice(inKey: *mut CRMFPOPOPrivKey)
     -> CRMFPOPOPrivKeyChoice;
    pub fn CRMF_POPOPrivKeyGetThisMessage(inKey: *mut CRMFPOPOPrivKey,
                                          destString: *mut SECItem)
     -> SECStatus;
    pub fn CRMF_POPOPrivKeyGetSubseqMess(inKey: *mut CRMFPOPOPrivKey,
                                         destOpt: *mut CRMFSubseqMessOptions)
     -> SECStatus;
    pub fn CRMF_POPOPrivKeyGetDHMAC(inKey: *mut CRMFPOPOPrivKey,
                                    destMAC: *mut SECItem) -> SECStatus;
    pub fn CRMF_CertRequestGetNumControls(inCertReq: *mut CRMFCertRequest)
     -> ::std::os::raw::c_int;
    pub fn CRMF_CertRequestGetControlAtIndex(inCertReq: *mut CRMFCertRequest,
                                             index: ::std::os::raw::c_int)
     -> *mut CRMFControl;
    pub fn CRMF_DestroyControl(inControl: *mut CRMFControl) -> SECStatus;
    pub fn CRMF_ControlGetControlType(inControl: *mut CRMFControl)
     -> CRMFControlType;
    pub fn CRMF_ControlGetRegTokenControlValue(inControl: *mut CRMFControl)
     -> *mut SECItem;
    pub fn CRMF_ControlGetAuthicatorControlValue(inControl: *mut CRMFControl)
     -> *mut SECItem;
    pub fn CRMF_ControlGetPKIArchiveOptions(inControl: *mut CRMFControl)
     -> *mut CRMFPKIArchiveOptions;
    pub fn CRMF_PKIArchiveOptionsGetOptionType(inOptions:
                                                   *mut CRMFPKIArchiveOptions)
     -> CRMFPKIArchiveOptionsType;
    pub fn CRMF_PKIArchiveOptionsGetEncryptedPrivKey(inOpts:
                                                         *mut CRMFPKIArchiveOptions)
     -> *mut CRMFEncryptedKey;
    pub fn CRMF_EncryptedKeyGetChoice(inEncrKey: *mut CRMFEncryptedKey)
     -> CRMFEncryptedKeyChoice;
    pub fn CRMF_EncryptedKeyGetEncryptedValue(inKey: *mut CRMFEncryptedKey)
     -> *mut CRMFEncryptedValue;
    pub fn CRMF_DestroyEncryptedValue(inEncrValue: *mut CRMFEncryptedValue)
     -> SECStatus;
    pub fn CRMF_EncryptedValueGetEncValue(inEncValue: *mut CRMFEncryptedValue)
     -> *mut SECItem;
    pub fn CRMF_EncryptedValueGetIntendedAlg(inEncValue:
                                                 *mut CRMFEncryptedValue)
     -> *mut SECAlgorithmID;
    pub fn CRMF_EncryptedValueGetSymmAlg(inEncValue: *mut CRMFEncryptedValue)
     -> *mut SECAlgorithmID;
    pub fn CRMF_EncryptedValueGetKeyAlg(inEncValue: *mut CRMFEncryptedValue)
     -> *mut SECAlgorithmID;
    pub fn CRMF_EncryptedValueGetValueHint(inEncValue:
                                               *mut CRMFEncryptedValue)
     -> *mut SECItem;
    pub fn CRMF_EncryptedValueGetEncSymmKey(inEncValue:
                                                *mut CRMFEncryptedValue)
     -> *mut SECItem;
    pub fn CRMF_PKIArchiveOptionsGetKeyGenParameters(inOptions:
                                                         *mut CRMFPKIArchiveOptions)
     -> *mut SECItem;
    pub fn CRMF_PKIArchiveOptionsGetArchiveRemGenPrivKey(inOpt:
                                                             *mut CRMFPKIArchiveOptions,
                                                         destVal: *mut PRBool)
     -> SECStatus;
    pub fn CRMF_GetBestWrapPadMechanism(slot: *mut PK11SlotInfo)
     -> CK_MECHANISM_TYPE;
    pub fn CRMF_GetIVFromMechanism(mechType: CK_MECHANISM_TYPE)
     -> *mut SECItem;
    pub fn CMMF_CreateCertRepContent() -> *mut CMMFCertRepContent;
    pub fn CMMF_CreateCertRepContentFromDER(db: *mut CERTCertDBHandle,
                                            buf:
                                                *const ::std::os::raw::c_char,
                                            len: ::std::os::raw::c_long)
     -> *mut CMMFCertRepContent;
    pub fn CMMF_CreateCertResponse(inCertReqId: ::std::os::raw::c_long)
     -> *mut CMMFCertResponse;
    pub fn CMMF_CreateKeyRecRepContent() -> *mut CMMFKeyRecRepContent;
    pub fn CMMF_CreateKeyRecRepContentFromDER(db: *mut CERTCertDBHandle,
                                              buf:
                                                  *const ::std::os::raw::c_char,
                                              len: ::std::os::raw::c_long)
     -> *mut CMMFKeyRecRepContent;
    pub fn CMMF_CreatePOPODecKeyChallContent()
     -> *mut CMMFPOPODecKeyChallContent;
    pub fn CMMF_CreatePOPODecKeyChallContentFromDER(buf:
                                                        *const ::std::os::raw::c_char,
                                                    len:
                                                        ::std::os::raw::c_long)
     -> *mut CMMFPOPODecKeyChallContent;
    pub fn CMMF_CreatePOPODecKeyRespContentFromDER(buf:
                                                       *const ::std::os::raw::c_char,
                                                   len:
                                                       ::std::os::raw::c_long)
     -> *mut CMMFPOPODecKeyRespContent;
    pub fn CMMF_CertRepContentSetCertResponses(inCertRepContent:
                                                   *mut CMMFCertRepContent,
                                               inCertResponses:
                                                   *mut *mut CMMFCertResponse,
                                               inNumResponses:
                                                   ::std::os::raw::c_int)
     -> SECStatus;
    pub fn CMMF_CertRepContentSetCAPubs(inCertRepContent:
                                            *mut CMMFCertRepContent,
                                        inCAPubs: *mut CERTCertList)
     -> SECStatus;
    pub fn CMMF_CertResponseSetPKIStatusInfoStatus(inCertResp:
                                                       *mut CMMFCertResponse,
                                                   inPKIStatus: CMMFPKIStatus)
     -> SECStatus;
    pub fn CMMF_CertResponseSetCertificate(inCertResp: *mut CMMFCertResponse,
                                           inCertificate:
                                               *mut CERTCertificate)
     -> SECStatus;
    pub fn CMMF_KeyRecRepContentSetPKIStatusInfoStatus(inKeyRecRep:
                                                           *mut CMMFKeyRecRepContent,
                                                       inPKIStatus:
                                                           CMMFPKIStatus)
     -> SECStatus;
    pub fn CMMF_KeyRecRepContentSetNewSignCert(inKeyRecRep:
                                                   *mut CMMFKeyRecRepContent,
                                               inNewSignCert:
                                                   *mut CERTCertificate)
     -> SECStatus;
    pub fn CMMF_KeyRecRepContentSetCACerts(inKeyRecRep:
                                               *mut CMMFKeyRecRepContent,
                                           inCACerts: *mut CERTCertList)
     -> SECStatus;
    pub fn CMMF_KeyRecRepContentSetCertifiedKeyPair(inKeyRecRep:
                                                        *mut CMMFKeyRecRepContent,
                                                    inCert:
                                                        *mut CERTCertificate,
                                                    inPrivKey:
                                                    ...
                                                    inPubKey:
                                                        *mut SECKEYPublicKey)
     -> SECStatus;
    pub fn CMMF_POPODecKeyChallContentSetNextChallenge(inDecKeyChall:
                                                           *mut CMMFPOPODecKeyChallContent,
                                                       inRandom:
                                                           ::std::os::raw::c_long,
                                                       inSender:
                                                       ...
                                                       passwdArg:
                                                           *mut ::std::os::raw::c_void)
     -> SECStatus;
    pub fn CMMF_EncodeCertRepContent(inCertRepContent:
                                         *mut CMMFCertRepContent,
                                     inCallback: CRMFEncoderOutputCallback,
                                     inArg: *mut ::std::os::raw::c_void)
     -> SECStatus;
    pub fn CMMF_EncodeKeyRecRepContent(inKeyRecRep: *mut CMMFKeyRecRepContent,
                                       inCallback: CRMFEncoderOutputCallback,
                                       inArg: *mut ::std::os::raw::c_void)
     -> SECStatus;
    pub fn CMMF_EncodePOPODecKeyChallContent(inDecKeyChall:
                                                 *mut CMMFPOPODecKeyChallContent,
                                             inCallback:
                                             ...
                                             inArg:
                                                 *mut ::std::os::raw::c_void)
     -> SECStatus;
    pub fn CMMF_EncodePOPODecKeyRespContent(inDecodedRand:
                                                *mut ::std::os::raw::c_long,
                                            inNumRand: ::std::os::raw::c_int,
                                            inCallback:
                                                CRMFEncoderOutputCallback,
                                            inArg:
                                                *mut ::std::os::raw::c_void)
     -> SECStatus;
    pub fn CMMF_CertRepContentGetCAPubs(inCertRepContent:
                                            *mut CMMFCertRepContent)
     -> *mut CERTCertList;
    pub fn CMMF_CertRepContentGetNumResponses(inCertRepContent:
                                                  *mut CMMFCertRepContent)
     -> ::std::os::raw::c_int;
    pub fn CMMF_CertRepContentGetResponseAtIndex(inCertRepContent:
                                                     *mut CMMFCertRepContent,
                                                 inIndex:
                                                     ::std::os::raw::c_int)
     -> *mut CMMFCertResponse;
    pub fn CMMF_CertResponseGetCertReqId(inCertResp: *mut CMMFCertResponse)
     -> ::std::os::raw::c_long;
    pub fn CMMF_CertResponseGetPKIStatusInfoStatus(inCertResp:
                                                       *mut CMMFCertResponse)
     -> CMMFPKIStatus;
    pub fn CMMF_CertResponseGetCertificate(inCertResp: *mut CMMFCertResponse,
                                           inCertdb: *mut CERTCertDBHandle)
     -> *mut CERTCertificate;
    pub fn CMMF_KeyRecRepContentGetPKIStatusInfoStatus(inKeyRecRep:
                                                           *mut CMMFKeyRecRepContent)
     -> CMMFPKIStatus;
    pub fn CMMF_KeyRecRepContentGetNewSignCert(inKeyRecRep:
                                                   *mut CMMFKeyRecRepContent)
     -> *mut CERTCertificate;
    pub fn CMMF_KeyRecRepContentGetCACerts(inKeyRecRep:
                                               *mut CMMFKeyRecRepContent)
     -> *mut CERTCertList;
    pub fn CMMF_KeyRecRepContentGetNumKeyPairs(inKeyRecRep:
                                                   *mut CMMFKeyRecRepContent)
     -> ::std::os::raw::c_int;
    pub fn CMMF_KeyRecRepContentGetCertKeyAtIndex(inKeyRecRep:
                                                      *mut CMMFKeyRecRepContent,
                                                  inIndex:
                                                      ::std::os::raw::c_int)
     -> *mut CMMFCertifiedKeyPair;
    pub fn CMMF_CertifiedKeyPairGetCertificate(inCertKeyPair:
                                                   *mut CMMFCertifiedKeyPair,
                                               inCertdb:
                                                   *mut CERTCertDBHandle)
     -> *mut CERTCertificate;
    pub fn CMMF_POPODecKeyChallContentGetNumChallenges(inKeyChallCont:
                                                           *mut CMMFPOPODecKeyChallContent)
     -> ::std::os::raw::c_int;
    pub fn CMMF_POPODecKeyChallContentGetPublicValue(inKeyChallCont:
                                                         *mut CMMFPOPODecKeyChallContent,
                                                     inIndex:
                                                         ::std::os::raw::c_int)
     -> *mut SECItem;
    pub fn CMMF_POPODecKeyChallContentGetRandomNumber(inKeyChallCont:
                                                          *mut CMMFPOPODecKeyChallContent,
                                                      inIndex:
                                                          ::std::os::raw::c_int,
                                                      inDest:
                                                          *mut ::std::os::raw::c_long)
     -> SECStatus;
    pub fn CMMF_POPODecKeyRespContentGetNumResponses(inRespCont:
                                                         *mut CMMFPOPODecKeyRespContent)
     -> ::std::os::raw::c_int;
    pub fn CMMF_POPODecKeyRespContentGetResponse(inRespCont:
                                                     *mut CMMFPOPODecKeyRespContent,
                                                 inIndex:
                                                     ::std::os::raw::c_int,
                                                 inDest:
                                                     *mut ::std::os::raw::c_long)
     -> SECStatus;
    pub fn CMMF_DestroyCertResponse(inCertResp: *mut CMMFCertResponse)
     -> SECStatus;
    pub fn CMMF_DestroyCertRepContent(inCertRepContent:
                                          *mut CMMFCertRepContent)
     -> SECStatus;
    pub fn CMMF_DestroyKeyRecRepContent(inKeyRecRep:
                                            *mut CMMFKeyRecRepContent)
     -> SECStatus;
    pub fn CMMF_DestroyCertifiedKeyPair(inCertKeyPair:
                                            *mut CMMFCertifiedKeyPair)
     -> SECStatus;
    pub fn CMMF_DestroyPOPODecKeyRespContent(inDecKeyResp:
                                                 *mut CMMFPOPODecKeyRespContent)
     -> SECStatus;
    pub fn CMMF_CertifiedKeyPairUnwrapPrivKey(inKeyPair:
                                                  *mut CMMFCertifiedKeyPair,
                                              inPrivKey:
                                                  *mut SECKEYPrivateKey,
                                              inNickName: *mut SECItem,
                                              inSlot: *mut PK11SlotInfo,
                                              inCertdb: *mut CERTCertDBHandle,
                                              destPrivKey:
                                              ...
                                              wincx:
                                                  *mut ::std::os::raw::c_void)
     -> SECStatus;
    pub fn CMMF_KeyRecRepContentHasCACerts(inKeyRecRep:
                                               *mut CMMFKeyRecRepContent)
     -> PRBool;
    pub fn CMMF_POPODecKeyChallContDecryptChallenge(inChalCont:
                                                        *mut CMMFPOPODecKeyChallContent,
                                                    inIndex:
                                                        ::std::os::raw::c_int,
                                                    inPrivKey:
                                                        *mut SECKEYPrivateKey)
     -> SECStatus;
    pub fn CMMF_DestroyPOPODecKeyChallContent(inDecKeyCont:
                                                  *mut CMMFPOPODecKeyChallContent)
     -> SECStatus;
}
