...
#[repr(u32)]
#[derive(Debug)]
pub enum Enum_Unnamed10 { SCM_RIGHTS = 1, }
#[repr(C)]
#[derive(Copy, Clone)]
#[derive(Debug)]
pub struct linger {
...
#[repr(u32)]
#[derive(Debug)]
pub enum Enum_Unnamed11 { SHUT_RD = 0, SHUT_WR = 1, SHUT_RDWR = 2, }
pub type uint8_t = u8;
...
pub const IPPORT_BIFFUDP: Enum_Unnamed14 = Enum_Unnamed14::IPPORT_EXECSERVER;
pub const IPPORT_WHOSERVER: Enum_Unnamed14 =
    Enum_Unnamed14::IPPORT_LOGINSERVER;
pub const IPPORT_ROUTESERVER: Enum_Unnamed14 =
    Enum_Unnamed14::IPPORT_EFSSERVER;
#[derive(Copy, Clone)]
#[repr(u32)]
#[derive(Debug)]
...
impl PRNetAddr {
    pub unsafe fn raw(&mut self) -> *mut Struct_Unnamed17 {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_);
        ::std::mem::transmute(raw.offset(0))
    }
    pub unsafe fn inet(&mut self) -> *mut Struct_Unnamed18 {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_);
        ::std::mem::transmute(raw.offset(0))
    }
    pub unsafe fn ipv6(&mut self) -> *mut Struct_Unnamed19 {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_);
        ::std::mem::transmute(raw.offset(0))
    }
    pub unsafe fn local(&mut self) -> *mut Struct_Unnamed20 {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_);
        ::std::mem::transmute(raw.offset(0))
    }
}
...
pub type PEHeader = PEHeaderStr;
pub type PEFortezzaHeader = PEFortezzaHeaderStr;
pub type PEFortezzaGeneratedHeader = PEFortezzaGeneratedHeaderStr;
pub type PEFixedKeyHeader = PEFixedKeyHeaderStr;
pub type PERSAKeyHeader = PERSAKeyHeaderStr;
#[repr(C)]
#[derive(Copy, Clone)]
#[derive(Debug)]
pub struct PEFortezzaHeaderStr {
    pub key: [::std::os::raw::c_uchar; 12usize],
    pub iv: [::std::os::raw::c_uchar; 24usize],
    pub hash: [::std::os::raw::c_uchar; 20usize],
    pub serial: [::std::os::raw::c_uchar; 8usize],
}
impl ::std::default::Default for PEFortezzaHeaderStr {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
#[repr(C)]
#[derive(Copy)]
pub struct PEFortezzaGeneratedHeaderStr {
    pub key: [::std::os::raw::c_uchar; 12usize],
    pub iv: [::std::os::raw::c_uchar; 24usize],
    pub hash: [::std::os::raw::c_uchar; 20usize],
    pub Ra: [::std::os::raw::c_uchar; 128usize],
    pub Y: [::std::os::raw::c_uchar; 128usize],
}
impl ::std::clone::Clone for PEFortezzaGeneratedHeaderStr {
    fn clone(&self) -> Self { *self }
}
impl ::std::default::Default for PEFortezzaGeneratedHeaderStr {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
#[repr(C)]
#[derive(Copy, Clone)]
#[derive(Debug)]
pub struct PEFixedKeyHeaderStr {
    pub pkcs11Mech: [::std::os::raw::c_uchar; 4usize],
    pub labelLen: [::std::os::raw::c_uchar; 2usize],
    pub keyIDLen: [::std::os::raw::c_uchar; 2usize],
    pub ivLen: [::std::os::raw::c_uchar; 2usize],
    pub keyLen: [::std::os::raw::c_uchar; 2usize],
    pub data: [::std::os::raw::c_uchar; 1usize],
}
impl ::std::default::Default for PEFixedKeyHeaderStr {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
#[repr(C)]
#[derive(Copy, Clone)]
#[derive(Debug)]
pub struct PERSAKeyHeaderStr {
    pub pkcs11Mech: [::std::os::raw::c_uchar; 4usize],
    pub issuerLen: [::std::os::raw::c_uchar; 2usize],
    pub serialLen: [::std::os::raw::c_uchar; 2usize],
    pub ivLen: [::std::os::raw::c_uchar; 2usize],
    pub keyLen: [::std::os::raw::c_uchar; 2usize],
    pub data: [::std::os::raw::c_uchar; 1usize],
}
impl ::std::default::Default for PERSAKeyHeaderStr {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
#[repr(C)]
#[derive(Copy, Clone)]
#[derive(Debug)]
pub struct PEHeaderStr {
    pub magic: [::std::os::raw::c_uchar; 2usize],
    pub len: [::std::os::raw::c_uchar; 2usize],
    pub type_: [::std::os::raw::c_uchar; 2usize],
    pub version: [::std::os::raw::c_uchar; 2usize],
    pub u: Union_Unnamed22,
}
impl ::std::default::Default for PEHeaderStr {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
#[repr(C)]
#[derive(Copy, Clone)]
...
pub struct Union_Unnamed22 {
    pub _bindgen_data_: [u8; 312usize],
}
impl Union_Unnamed22 {
    pub unsafe fn fortezza(&mut self) -> *mut PEFortezzaHeader {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_);
        ::std::mem::transmute(raw.offset(0))
    }
    pub unsafe fn g_fortezza(&mut self) -> *mut PEFortezzaGeneratedHeader {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_);
        ::std::mem::transmute(raw.offset(0))
    }
    pub unsafe fn fixed(&mut self) -> *mut PEFixedKeyHeader {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_);
        ::std::mem::transmute(raw.offset(0))
    }
    pub unsafe fn rsa(&mut self) -> *mut PERSAKeyHeader {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_);
        ::std::mem::transmute(raw.offset(0))
    }
}
...
extern "C" {
    ...
    pub fn SSL_PreencryptedStreamToFile(fd: *mut PRFileDesc,
                                        arg1: *mut PEHeader,
                                        headerSize:
                                            *mut ::std::os::raw::c_int)
     -> *mut PEHeader;
    pub fn SSL_PreencryptedFileToStream(fd: *mut PRFileDesc,
                                        arg1: *mut PEHeader,
                                        headerSize:
                                            *mut ::std::os::raw::c_int)
     -> *mut PEHeader;
