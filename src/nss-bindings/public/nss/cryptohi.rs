...
pub type __BLAPI_DEPRECATED = ::std::os::raw::c_int;
pub enum DESContextStr { }
pub enum RC2ContextStr { }
pub enum RC4ContextStr { }
pub enum RC5ContextStr { }
pub enum AESContextStr { }
pub enum CamelliaContextStr { }
pub enum MD2ContextStr { }
pub enum MD5ContextStr { }
pub enum SHA1ContextStr { }
pub enum SHA256ContextStr { }
pub enum SHA512ContextStr { }
pub enum AESKeyWrapContextStr { }
pub enum SEEDContextStr { }
pub enum ChaCha20Poly1305ContextStr { }
pub type DESContext = DESContextStr;
pub type RC2Context = RC2ContextStr;
pub type RC4Context = RC4ContextStr;
pub type RC5Context = RC5ContextStr;
pub type AESContext = AESContextStr;
pub type CamelliaContext = CamelliaContextStr;
pub type MD2Context = MD2ContextStr;
pub type MD5Context = MD5ContextStr;
pub type SHA1Context = SHA1ContextStr;
pub type SHA256Context = SHA256ContextStr;
pub type SHA224Context = SHA256ContextStr;
pub type SHA512Context = SHA512ContextStr;
pub type SHA384Context = SHA512ContextStr;
pub type AESKeyWrapContext = AESKeyWrapContextStr;
pub type SEEDContext = SEEDContextStr;
pub type ChaCha20Poly1305Context = ChaCha20Poly1305ContextStr;
#[repr(C)]
#[derive(Copy, Clone)]
#[derive(Debug)]
pub struct RSAPublicKeyStr {
    pub arena: *mut PLArenaPool,
    pub modulus: SECItem,
    pub publicExponent: SECItem,
}
impl ::std::default::Default for RSAPublicKeyStr {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
pub type RSAPublicKey = RSAPublicKeyStr;
#[repr(C)]
#[derive(Copy, Clone)]
#[derive(Debug)]
pub struct RSAPrivateKeyStr {
    pub arena: *mut PLArenaPool,
    pub version: SECItem,
    pub modulus: SECItem,
    pub publicExponent: SECItem,
    pub privateExponent: SECItem,
    pub prime1: SECItem,
    pub prime2: SECItem,
    pub exponent1: SECItem,
    pub exponent2: SECItem,
    pub coefficient: SECItem,
}
impl ::std::default::Default for RSAPrivateKeyStr {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
pub type RSAPrivateKey = RSAPrivateKeyStr;
#[repr(C)]
#[derive(Copy, Clone)]
#[derive(Debug)]
pub struct PQGParamsStr {
    pub arena: *mut PLArenaPool,
    pub prime: SECItem,
    pub subPrime: SECItem,
    pub base: SECItem,
}
impl ::std::default::Default for PQGParamsStr {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
pub type PQGParams = PQGParamsStr;
#[repr(C)]
#[derive(Copy, Clone)]
#[derive(Debug)]
pub struct PQGVerifyStr {
    pub arena: *mut PLArenaPool,
    pub counter: ::std::os::raw::c_uint,
    pub seed: SECItem,
    pub h: SECItem,
}
impl ::std::default::Default for PQGVerifyStr {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
pub type PQGVerify = PQGVerifyStr;
#[repr(C)]
#[derive(Copy, Clone)]
#[derive(Debug)]
pub struct DSAPublicKeyStr {
    pub params: PQGParams,
    pub publicValue: SECItem,
}
impl ::std::default::Default for DSAPublicKeyStr {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
pub type DSAPublicKey = DSAPublicKeyStr;
#[repr(C)]
#[derive(Copy, Clone)]
#[derive(Debug)]
pub struct DSAPrivateKeyStr {
    pub params: PQGParams,
    pub publicValue: SECItem,
    pub privateValue: SECItem,
}
impl ::std::default::Default for DSAPrivateKeyStr {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
pub type DSAPrivateKey = DSAPrivateKeyStr;
#[repr(C)]
#[derive(Copy, Clone)]
#[derive(Debug)]
pub struct DHParamsStr {
    pub arena: *mut PLArenaPool,
    pub prime: SECItem,
    pub base: SECItem,
}
impl ::std::default::Default for DHParamsStr {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
pub type DHParams = DHParamsStr;
#[repr(C)]
#[derive(Copy, Clone)]
#[derive(Debug)]
pub struct DHPublicKeyStr {
    pub arena: *mut PLArenaPool,
    pub prime: SECItem,
    pub base: SECItem,
    pub publicValue: SECItem,
}
impl ::std::default::Default for DHPublicKeyStr {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
pub type DHPublicKey = DHPublicKeyStr;
#[repr(C)]
#[derive(Copy, Clone)]
#[derive(Debug)]
pub struct DHPrivateKeyStr {
    pub arena: *mut PLArenaPool,
    pub prime: SECItem,
    pub base: SECItem,
    pub publicValue: SECItem,
...
impl ::std::default::Default for DHPrivateKeyStr {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
pub type DHPrivateKey = DHPrivateKeyStr;
#[derive(Copy, Clone)]
#[repr(u32)]
#[derive(Debug)]
pub enum ECParamsType { ec_params_explicit = 0, ec_params_named = 1, }
#[derive(Copy, Clone)]
#[repr(u32)]
#[derive(Debug)]
pub enum ECFieldType { ec_field_GFp = 1, ec_field_GF2m = 2, }
#[repr(C)]
#[derive(Copy, Clone)]
#[derive(Debug)]
pub struct ECFieldIDStr {
    pub size: ::std::os::raw::c_int,
    pub type_: ECFieldType,
    pub u: Union_Unnamed9,
    pub k1: ::std::os::raw::c_int,
    pub k2: ::std::os::raw::c_int,
    pub k3: ::std::os::raw::c_int,
    _bindgen_padding_0_: [u8; 4usize],
}
impl ::std::default::Default for ECFieldIDStr {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
#[repr(C)]
#[derive(Copy, Clone)]
...
impl Union_Unnamed9 {
    pub unsafe fn prime(&mut self) -> *mut SECItem {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_);
        ::std::mem::transmute(raw.offset(0))
    }
    pub unsafe fn poly(&mut self) -> *mut SECItem {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_);
        ::std::mem::transmute(raw.offset(0))
    }
}
...
pub type ECFieldID = ECFieldIDStr;
#[repr(C)]
#[derive(Copy, Clone)]
#[derive(Debug)]
pub struct ECCurveStr {
    pub a: SECItem,
    pub b: SECItem,
    pub seed: SECItem,
}
impl ::std::default::Default for ECCurveStr {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
pub type ECCurve = ECCurveStr;
#[repr(C)]
#[derive(Copy, Clone)]
#[derive(Debug)]
pub struct ECParamsStr {
    pub arena: *mut PLArenaPool,
    pub type_: ECParamsType,
    pub fieldID: ECFieldID,
    pub curve: ECCurve,
    pub base: SECItem,
    pub order: SECItem,
    pub cofactor: ::std::os::raw::c_int,
    pub DEREncoding: SECItem,
    pub name: ECCurveName,
    pub curveOID: SECItem,
}
impl ::std::default::Default for ECParamsStr {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
pub type ECParams = ECParamsStr;
#[repr(C)]
#[derive(Copy, Clone)]
#[derive(Debug)]
pub struct ECPublicKeyStr {
    pub ecParams: ECParams,
    pub publicValue: SECItem,
}
impl ::std::default::Default for ECPublicKeyStr {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
pub type ECPublicKey = ECPublicKeyStr;
#[repr(C)]
#[derive(Copy, Clone)]
#[derive(Debug)]
pub struct ECPrivateKeyStr {
    pub ecParams: ECParams,
    pub publicValue: SECItem,
    pub privateValue: SECItem,
    pub version: SECItem,
}
impl ::std::default::Default for ECPrivateKeyStr {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
pub type ECPrivateKey = ECPrivateKeyStr;
pub type BLapiAllocateFunc =
    ::std::option::Option<extern "C" fn() -> *mut ::std::os::raw::c_void>;
pub type BLapiDestroyContextFunc =
    ::std::option::Option<unsafe extern "C" fn(cx:
                                                   *mut ::std::os::raw::c_void,
                                               freeit: PRBool)>;
pub type BLapiInitContextFunc =
    ::std::option::Option<unsafe extern "C" fn(cx:
                                                   *mut ::std::os::raw::c_void,
                                               key:
...
pub enum SGNContextStr { }
pub type SGNContext = SGNContextStr;
pub enum VFYContextStr { }
pub type VFYContext = VFYContextStr;
...
#[repr(u32)]
#[derive(Debug)]
pub enum Enum_Unnamed13 { SCM_RIGHTS = 1, }
#[repr(C)]
#[derive(Copy, Clone)]
#[derive(Debug)]
pub struct linger {
...
#[repr(u32)]
#[derive(Debug)]
pub enum Enum_Unnamed14 { SHUT_RD = 0, SHUT_WR = 1, SHUT_RDWR = 2, }
pub type uint8_t = u8;
...
pub const IPPORT_BIFFUDP: Enum_Unnamed17 = Enum_Unnamed17::IPPORT_EXECSERVER;
pub const IPPORT_WHOSERVER: Enum_Unnamed17 =
    Enum_Unnamed17::IPPORT_LOGINSERVER;
pub const IPPORT_ROUTESERVER: Enum_Unnamed17 =
    Enum_Unnamed17::IPPORT_EFSSERVER;
#[derive(Copy, Clone)]
#[repr(u32)]
#[derive(Debug)]
...
impl PRNetAddr {
    pub unsafe fn raw(&mut self) -> *mut Struct_Unnamed20 {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_);
        ::std::mem::transmute(raw.offset(0))
    }
    pub unsafe fn inet(&mut self) -> *mut Struct_Unnamed21 {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_);
        ::std::mem::transmute(raw.offset(0))
    }
    pub unsafe fn ipv6(&mut self) -> *mut Struct_Unnamed22 {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_);
        ::std::mem::transmute(raw.offset(0))
    }
    pub unsafe fn local(&mut self) -> *mut Struct_Unnamed23 {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_);
        ::std::mem::transmute(raw.offset(0))
    }
}
...
impl Union_Unnamed25 {
    ...
    pub unsafe fn bits(&mut self) -> *mut Struct_Unnamed26 {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_);
        ::std::mem::transmute(raw.offset(0))
    }
}
...
pub struct CERTValParamInValueStr {
    pub scalar: Union_Unnamed29,
    pub pointer: Union_Unnamed30,
    pub array: Union_Unnamed31,
...
pub struct CERTValParamOutValueStr {
    pub scalar: Union_Unnamed32,
    pub pointer: Union_Unnamed33,
    pub array: Union_Unnamed34,
    pub arraySize: ::std::os::raw::c_int,
    _bindgen_padding_0_: [u8; 4usize],
}
...
extern "C" {
    ...
    pub fn NSS_Get_CERT_TimeChoiceTemplate(arg: *mut ::std::os::raw::c_void,
                                           enc: PRBool)
     -> *const SEC_ASN1Template;
    pub fn DSAU_EncodeDerSig(dest: *mut SECItem, src: *mut SECItem)
     -> SECStatus;
    pub fn DSAU_DecodeDerSig(item: *const SECItem) -> *mut SECItem;
    pub fn DSAU_EncodeDerSigWithLen(dest: *mut SECItem, src: *mut SECItem,
                                    len: ::std::os::raw::c_uint) -> SECStatus;
    pub fn DSAU_DecodeDerSigToLen(item: *const SECItem,
                                  len: ::std::os::raw::c_uint)
     -> *mut SECItem;
    pub fn SGN_NewContext(alg: SECOidTag, privKey: *mut SECKEYPrivateKey)
     -> *mut SGNContext;
    pub fn SGN_DestroyContext(cx: *mut SGNContext, freeit: PRBool);
    pub fn SGN_Begin(cx: *mut SGNContext) -> SECStatus;
    pub fn SGN_Update(cx: *mut SGNContext,
                      input: *const ::std::os::raw::c_uchar,
                      inputLen: ::std::os::raw::c_uint) -> SECStatus;
    pub fn SGN_End(cx: *mut SGNContext, result: *mut SECItem) -> SECStatus;
    pub fn SEC_SignData(result: *mut SECItem,
                        buf: *const ::std::os::raw::c_uchar,
                        len: ::std::os::raw::c_int, pk: *mut SECKEYPrivateKey,
                        algid: SECOidTag) -> SECStatus;
    pub fn SGN_Digest(privKey: *mut SECKEYPrivateKey, algtag: SECOidTag,
                      result: *mut SECItem, digest: *mut SECItem)
     -> SECStatus;
    pub fn SEC_DerSignData(arena: *mut PLArenaPool, result: *mut SECItem,
                           buf: *const ::std::os::raw::c_uchar,
                           len: ::std::os::raw::c_int,
                           pk: *mut SECKEYPrivateKey, algid: SECOidTag)
     -> SECStatus;
    pub fn SEC_DestroySignedData(sd: *mut CERTSignedData, freeit: PRBool);
    pub fn SEC_GetSignatureAlgorithmOidTag(keyType: KeyType,
                                           hashAlgTag: SECOidTag)
     -> SECOidTag;
    pub fn VFY_CreateContext(key: *mut SECKEYPublicKey, sig: *mut SECItem,
                             sigAlg: SECOidTag,
                             wincx: *mut ::std::os::raw::c_void)
     -> *mut VFYContext;
    pub fn VFY_CreateContextDirect(key: *const SECKEYPublicKey,
                                   sig: *const SECItem, pubkAlg: SECOidTag,
                                   hashAlg: SECOidTag, hash: *mut SECOidTag,
                                   wincx: *mut ::std::os::raw::c_void)
     -> *mut VFYContext;
    pub fn VFY_CreateContextWithAlgorithmID(key: *const SECKEYPublicKey,
                                            sig: *const SECItem,
                                            algid: *const SECAlgorithmID,
                                            hash: *mut SECOidTag,
                                            wincx:
                                                *mut ::std::os::raw::c_void)
     -> *mut VFYContext;
    pub fn VFY_DestroyContext(cx: *mut VFYContext, freeit: PRBool);
    pub fn VFY_Begin(cx: *mut VFYContext) -> SECStatus;
    pub fn VFY_Update(cx: *mut VFYContext,
                      input: *const ::std::os::raw::c_uchar,
                      inputLen: ::std::os::raw::c_uint) -> SECStatus;
    pub fn VFY_End(cx: *mut VFYContext) -> SECStatus;
    pub fn VFY_EndWithSignature(cx: *mut VFYContext, sig: *mut SECItem)
     -> SECStatus;
    pub fn VFY_VerifyDigest(dig: *mut SECItem, key: *mut SECKEYPublicKey,
                            sig: *mut SECItem, sigAlg: SECOidTag,
                            wincx: *mut ::std::os::raw::c_void) -> SECStatus;
    pub fn VFY_VerifyDigestDirect(dig: *const SECItem,
                                  key: *const SECKEYPublicKey,
                                  sig: *const SECItem, pubkAlg: SECOidTag,
                                  hashAlg: SECOidTag,
                                  wincx: *mut ::std::os::raw::c_void)
     -> SECStatus;
    pub fn VFY_VerifyDigestWithAlgorithmID(dig: *const SECItem,
                                           key: *const SECKEYPublicKey,
                                           sig: *const SECItem,
                                           algid: *const SECAlgorithmID,
                                           hash: SECOidTag,
                                           wincx: *mut ::std::os::raw::c_void)
     -> SECStatus;
    pub fn VFY_VerifyData(buf: *const ::std::os::raw::c_uchar,
                          len: ::std::os::raw::c_int,
                          key: *const SECKEYPublicKey, sig: *const SECItem,
                          sigAlg: SECOidTag,
                          wincx: *mut ::std::os::raw::c_void) -> SECStatus;
    pub fn VFY_VerifyDataDirect(buf: *const ::std::os::raw::c_uchar,
                                len: ::std::os::raw::c_int,
                                key: *const SECKEYPublicKey,
                                sig: *const SECItem, pubkAlg: SECOidTag,
                                hashAlg: SECOidTag, hash: *mut SECOidTag,
                                wincx: *mut ::std::os::raw::c_void)
     -> SECStatus;
    pub fn VFY_VerifyDataWithAlgorithmID(buf: *const ::std::os::raw::c_uchar,
                                         len: ::std::os::raw::c_int,
                                         key: *const SECKEYPublicKey,
                                         sig: *const SECItem,
                                         algid: *const SECAlgorithmID,
