...
extern "C" {
    ...
    pub fn PR_FormatTimeUSEnglish(buf: *mut ::std::os::raw::c_char,
                                  ...
                                  time: *const PRExplodedTime) -> PRUint32;
    pub fn DER_Encode(arena: *mut PLArenaPool, dest: *mut SECItem,
                      t: *mut DERTemplate, src: *mut ::std::os::raw::c_void)
     -> SECStatus;
    pub fn DER_Lengths(item: *mut SECItem,
                       header_len_p: *mut ::std::os::raw::c_int,
                       contents_len_p: *mut PRUint32) -> SECStatus;
    pub fn DER_StoreHeader(to: *mut ::std::os::raw::c_uchar,
                           code: ::std::os::raw::c_uint,
                           encodingLen: PRUint32)
     -> *mut ::std::os::raw::c_uchar;
    pub fn DER_LengthLength(len: PRUint32) -> ::std::os::raw::c_int;
    pub fn DER_SetInteger(arena: *mut PLArenaPool, dst: *mut SECItem,
                          src: PRInt32) -> SECStatus;
    pub fn DER_SetUInteger(arena: *mut PLArenaPool, dst: *mut SECItem,
                           src: PRUint32) -> SECStatus;
    pub fn DER_GetInteger(src: *const SECItem) -> ::std::os::raw::c_long;
    pub fn DER_GetUInteger(src: *mut SECItem) -> ::std::os::raw::c_ulong;
    pub fn DER_TimeToUTCTime(result: *mut SECItem, time: PRTime) -> SECStatus;
    pub fn DER_TimeToUTCTimeArena(arenaOpt: *mut PLArenaPool,
                                  dst: *mut SECItem, gmttime: PRTime)
     -> SECStatus;
    pub fn DER_AsciiToTime(result: *mut PRTime,
                           string: *const ::std::os::raw::c_char)
     -> SECStatus;
    pub fn DER_UTCTimeToTime(result: *mut PRTime, time: *const SECItem)
     -> SECStatus;
    pub fn DER_UTCTimeToAscii(utcTime: *mut SECItem)
     -> *mut ::std::os::raw::c_char;
    pub fn DER_UTCDayToAscii(utctime: *mut SECItem)
     -> *mut ::std::os::raw::c_char;
    pub fn DER_GeneralizedDayToAscii(gentime: *mut SECItem)
     -> *mut ::std::os::raw::c_char;
    pub fn DER_TimeChoiceDayToAscii(timechoice: *mut SECItem)
     -> *mut ::std::os::raw::c_char;
    pub fn DER_TimeToGeneralizedTime(dst: *mut SECItem, gmttime: PRTime)
     -> SECStatus;
    pub fn DER_TimeToGeneralizedTimeArena(arenaOpt: *mut PLArenaPool,
                                          dst: *mut SECItem, gmttime: PRTime)
     -> SECStatus;
    pub fn DER_GeneralizedTimeToTime(dst: *mut PRTime, time: *const SECItem)
     -> SECStatus;
    pub fn CERT_UTCTime2FormattedAscii(utcTime: PRTime,
                                       format: *mut ::std::os::raw::c_char)
     -> *mut ::std::os::raw::c_char;
    pub fn CERT_GenTime2FormattedAscii(genTime: PRTime,
                                       format: *mut ::std::os::raw::c_char)
     -> *mut ::std::os::raw::c_char;
    pub fn DER_DecodeTimeChoice(output: *mut PRTime, input: *const SECItem)
     -> SECStatus;
    pub fn DER_EncodeTimeChoice(arena: *mut PLArenaPool, output: *mut SECItem,
                                input: PRTime) -> SECStatus;
}
