...
pub type CERT_StringFromCertFcn =
    ::std::option::Option<unsafe extern "C" fn(cert: *mut CERTCertificate)
                              -> *mut ::std::os::raw::c_char>;
pub enum CERTOCSPRequestStr { }
pub type CERTOCSPRequest = CERTOCSPRequestStr;
pub enum CERTOCSPResponseStr { }
pub type CERTOCSPResponse = CERTOCSPResponseStr;
pub enum CERTOCSPCertIDStr { }
pub type CERTOCSPCertID = CERTOCSPCertIDStr;
pub enum CERTOCSPSingleResponseStr { }
pub type CERTOCSPSingleResponse = CERTOCSPSingleResponseStr;
pub type SEC_HTTP_SERVER_SESSION = *mut ::std::os::raw::c_void;
pub type SEC_HTTP_REQUEST_SESSION = *mut ::std::os::raw::c_void;
pub type SEC_HttpServer_CreateSessionFcn =
    ::std::option::Option<unsafe extern "C" fn(host:
                                                   *const ::std::os::raw::c_char,
                                               portnum: PRUint16,
                                               pSession:
                                                   *mut SEC_HTTP_SERVER_SESSION)
                              -> SECStatus>;
pub type SEC_HttpServer_KeepAliveSessionFcn =
    ::std::option::Option<unsafe extern "C" fn(session:
                                                   SEC_HTTP_SERVER_SESSION,
                                               pPollDesc:
                                                   *mut *mut PRPollDesc)
                              -> SECStatus>;
pub type SEC_HttpServer_FreeSessionFcn =
    ::std::option::Option<extern "C" fn(session: SEC_HTTP_SERVER_SESSION)
                              -> SECStatus>;
pub type SEC_HttpRequest_CreateFcn =
    ::std::option::Option<unsafe extern "C" fn(session:
                                                   SEC_HTTP_SERVER_SESSION,
                                               ...
                                               timeout: PRIntervalTime,
                                               pRequest:
                                                   *mut SEC_HTTP_REQUEST_SESSION)
                              -> SECStatus>;
pub type SEC_HttpRequest_SetPostDataFcn =
    ::std::option::Option<unsafe extern "C" fn(request:
                                                   SEC_HTTP_REQUEST_SESSION,
                                               http_data:
                                                   *const ::std::os::raw::c_char,
                                               http_data_len: PRUint32,
                                               http_content_type:
                                                   *const ::std::os::raw::c_char)
                              -> SECStatus>;
pub type SEC_HttpRequest_AddHeaderFcn =
    ::std::option::Option<unsafe extern "C" fn(request:
                                                   SEC_HTTP_REQUEST_SESSION,
                                               http_header_name:
                                                   *const ::std::os::raw::c_char,
                                               http_header_value:
                                                   *const ::std::os::raw::c_char)
                              -> SECStatus>;
pub type SEC_HttpRequest_TrySendAndReceiveFcn =
    ::std::option::Option<unsafe extern "C" fn(request:
                                                   SEC_HTTP_REQUEST_SESSION,
                                               pPollDesc:
                                                   *mut *mut PRPollDesc,
                                               ...
                                               http_response_data_len:
                                                   *mut PRUint32)
                              -> SECStatus>;
pub type SEC_HttpRequest_CancelFcn =
    ::std::option::Option<extern "C" fn(request: SEC_HTTP_REQUEST_SESSION)
                              -> SECStatus>;
pub type SEC_HttpRequest_FreeFcn =
    ::std::option::Option<extern "C" fn(request: SEC_HTTP_REQUEST_SESSION)
                              -> SECStatus>;
#[repr(C)]
#[derive(Copy, Clone)]
#[derive(Debug)]
pub struct SEC_HttpClientFcnV1Struct {
    pub createSessionFcn: SEC_HttpServer_CreateSessionFcn,
    pub keepAliveSessionFcn: SEC_HttpServer_KeepAliveSessionFcn,
    pub freeSessionFcn: SEC_HttpServer_FreeSessionFcn,
    pub createFcn: SEC_HttpRequest_CreateFcn,
    pub setPostDataFcn: SEC_HttpRequest_SetPostDataFcn,
    pub addHeaderFcn: SEC_HttpRequest_AddHeaderFcn,
    pub trySendAndReceiveFcn: SEC_HttpRequest_TrySendAndReceiveFcn,
    pub cancelFcn: SEC_HttpRequest_CancelFcn,
    pub freeFcn: SEC_HttpRequest_FreeFcn,
}
impl ::std::default::Default for SEC_HttpClientFcnV1Struct {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
pub type SEC_HttpClientFcnV1 = SEC_HttpClientFcnV1Struct;
#[repr(C)]
#[derive(Copy, Clone)]
#[derive(Debug)]
pub struct SEC_HttpClientFcnStruct {
    pub version: PRInt16,
    pub fcnTable: Union_Unnamed34,
}
impl ::std::default::Default for SEC_HttpClientFcnStruct {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
#[repr(C)]
#[derive(Copy, Clone)]
...
impl Union_Unnamed34 {
    pub unsafe fn ftable1(&mut self) -> *mut SEC_HttpClientFcnV1 {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_);
        ::std::mem::transmute(raw.offset(0))
    }
}
...
pub type SEC_HttpClientFcn = SEC_HttpClientFcnStruct;
#[derive(Copy, Clone)]
#[repr(u32)]
#[derive(Debug)]
pub enum SEC_OcspFailureMode {
...
#[repr(i32)]
#[derive(Debug)]
pub enum CERTOCSPResponderIDType {
...
extern "C" {
    ...
    pub fn NSS_Get_CERT_TimeChoiceTemplate(arg: *mut ::std::os::raw::c_void,
                                           enc: PRBool)
     -> *const SEC_ASN1Template;
    pub fn SEC_RegisterDefaultHttpClient(fcnTable: *const SEC_HttpClientFcn)
     -> SECStatus;
    pub fn SEC_GetRegisteredHttpClient() -> *const SEC_HttpClientFcn;
    pub fn CERT_OCSPCacheSettings(maxCacheEntries: PRInt32,
                                  minimumSecondsToNextFetchAttempt: PRUint32,
                                  maximumSecondsToNextFetchAttempt: PRUint32)
     -> SECStatus;
    pub fn CERT_SetOCSPFailureMode(ocspFailureMode: SEC_OcspFailureMode)
     -> SECStatus;
    pub fn CERT_SetOCSPTimeout(seconds: PRUint32) -> SECStatus;
    pub fn CERT_ClearOCSPCache() -> SECStatus;
    pub fn CERT_EnableOCSPChecking(handle: *mut CERTCertDBHandle)
     -> SECStatus;
    pub fn CERT_DisableOCSPChecking(handle: *mut CERTCertDBHandle)
     -> SECStatus;
    pub fn CERT_SetOCSPDefaultResponder(handle: *mut CERTCertDBHandle,
                                        url: *const ::std::os::raw::c_char,
                                        name: *const ::std::os::raw::c_char)
     -> SECStatus;
    pub fn CERT_EnableOCSPDefaultResponder(handle: *mut CERTCertDBHandle)
     -> SECStatus;
    pub fn CERT_DisableOCSPDefaultResponder(handle: *mut CERTCertDBHandle)
     -> SECStatus;
    pub fn CERT_ForcePostMethodForOCSP(forcePost: PRBool) -> SECStatus;
    pub fn CERT_CreateOCSPRequest(certList: *mut CERTCertList, time: PRTime,
                                  addServiceLocator: PRBool,
                                  signerCert: *mut CERTCertificate)
     -> *mut CERTOCSPRequest;
    pub fn CERT_AddOCSPAcceptableResponses(request: *mut CERTOCSPRequest,
                                           responseType0: SECOidTag, ...)
     -> SECStatus;
    pub fn CERT_EncodeOCSPRequest(arena: *mut PLArenaPool,
                                  request: *mut CERTOCSPRequest,
                                  pwArg: *mut ::std::os::raw::c_void)
     -> *mut SECItem;
    pub fn CERT_DecodeOCSPRequest(src: *const SECItem)
     -> *mut CERTOCSPRequest;
    pub fn CERT_DestroyOCSPRequest(request: *mut CERTOCSPRequest);
    pub fn CERT_DecodeOCSPResponse(src: *const SECItem)
     -> *mut CERTOCSPResponse;
    pub fn CERT_DestroyOCSPResponse(response: *mut CERTOCSPResponse);
    pub fn CERT_GetEncodedOCSPResponse(arena: *mut PLArenaPool,
                                       certList: *mut CERTCertList,
                                       location:
                                           *const ::std::os::raw::c_char,
                                       time: PRTime,
                                       addServiceLocator: PRBool,
                                       signerCert: *mut CERTCertificate,
                                       pwArg: *mut ::std::os::raw::c_void,
                                       pRequest: *mut *mut CERTOCSPRequest)
     -> *mut SECItem;
    pub fn CERT_VerifyOCSPResponseSignature(response: *mut CERTOCSPResponse,
                                            handle: *mut CERTCertDBHandle,
                                            pwArg:
                                                *mut ::std::os::raw::c_void,
                                            pSignerCert:
                                                *mut *mut CERTCertificate,
                                            issuerCert: *mut CERTCertificate)
     -> SECStatus;
    pub fn CERT_GetOCSPAuthorityInfoAccessLocation(cert:
                                                       *const CERTCertificate)
     -> *mut ::std::os::raw::c_char;
    pub fn CERT_RegisterAlternateOCSPAIAInfoCallBack(newCallback:
                                                         CERT_StringFromCertFcn,
                                                     oldCallback:
                                                         *mut CERT_StringFromCertFcn)
     -> SECStatus;
    pub fn CERT_ParseURL(url: *const ::std::os::raw::c_char,
                         pHostname: *mut *mut ::std::os::raw::c_char,
                         pPort: *mut PRUint16,
                         pPath: *mut *mut ::std::os::raw::c_char)
     -> SECStatus;
    pub fn CERT_CheckOCSPStatus(handle: *mut CERTCertDBHandle,
                                cert: *mut CERTCertificate, time: PRTime,
                                pwArg: *mut ::std::os::raw::c_void)
     -> SECStatus;
    pub fn CERT_CacheOCSPResponseFromSideChannel(handle:
                                                 ...
                                                 pwArg:
                                                     *mut ::std::os::raw::c_void)
     -> SECStatus;
    pub fn CERT_GetOCSPStatusForCertID(handle: *mut CERTCertDBHandle,
                                       response: *mut CERTOCSPResponse,
                                       certID: *mut CERTOCSPCertID,
                                       signerCert: *mut CERTCertificate,
                                       time: PRTime) -> SECStatus;
    pub fn CERT_GetOCSPResponseStatus(response: *mut CERTOCSPResponse)
     -> SECStatus;
    pub fn CERT_CreateOCSPCertID(cert: *mut CERTCertificate, time: PRTime)
     -> *mut CERTOCSPCertID;
    pub fn CERT_DestroyOCSPCertID(certID: *mut CERTOCSPCertID) -> SECStatus;
    pub fn CERT_CreateOCSPSingleResponseGood(arena: *mut PLArenaPool,
                                             id: *mut CERTOCSPCertID,
                                             thisUpdate: PRTime,
                                             nextUpdate: *const PRTime)
     -> *mut CERTOCSPSingleResponse;
    pub fn CERT_CreateOCSPSingleResponseUnknown(arena: *mut PLArenaPool,
                                                id: *mut CERTOCSPCertID,
                                                thisUpdate: PRTime,
                                                nextUpdate: *const PRTime)
     -> *mut CERTOCSPSingleResponse;
    pub fn CERT_CreateOCSPSingleResponseRevoked(arena: *mut PLArenaPool,
                                                id: *mut CERTOCSPCertID,
                                                thisUpdate: PRTime,
                                                nextUpdate: *const PRTime,
                                                revocationTime: PRTime,
                                                revocationReason:
                                                    *const CERTCRLEntryReasonCode)
     -> *mut CERTOCSPSingleResponse;
    pub fn CERT_CreateEncodedOCSPSuccessResponse(arena: *mut PLArenaPool,
                                                 responderCert:
                                                     *mut CERTCertificate,
                                                 responderIDType:
                                                 ...
                                                 producedAt: PRTime,
                                                 responses:
                                                     *mut *mut CERTOCSPSingleResponse,
                                                 wincx:
                                                     *mut ::std::os::raw::c_void)
     -> *mut SECItem;
    pub fn CERT_CreateEncodedOCSPErrorResponse(arena: *mut PLArenaPool,
                                               error: ::std::os::raw::c_int)
     -> *mut SECItem;
    pub fn CERT_PostOCSPRequest(arena: *mut PLArenaPool,
                                location: *const ::std::os::raw::c_char,
                                encodedRequest: *const SECItem)
     -> *mut SECItem;
}
