...
extern "C" {
    ...
    pub fn HASH_ResultLen(type_: HASH_HashType) -> ::std::os::raw::c_uint;
    pub fn HASH_ResultLenContext(context: *mut HASHContext)
     -> ::std::os::raw::c_uint;
    pub fn HASH_ResultLenByOidTag(hashOid: SECOidTag)
     -> ::std::os::raw::c_uint;
    pub fn HASH_HashBuf(type_: HASH_HashType,
                        dest: *mut ::std::os::raw::c_uchar,
                        src: *const ::std::os::raw::c_uchar,
                        src_len: PRUint32) -> SECStatus;
    pub fn HASH_Create(type_: HASH_HashType) -> *mut HASHContext;
    pub fn HASH_Clone(context: *mut HASHContext) -> *mut HASHContext;
    pub fn HASH_Destroy(context: *mut HASHContext);
    pub fn HASH_Begin(context: *mut HASHContext);
    pub fn HASH_Update(context: *mut HASHContext,
                       src: *const ::std::os::raw::c_uchar,
                       len: ::std::os::raw::c_uint);
    pub fn HASH_End(context: *mut HASHContext,
                    result: *mut ::std::os::raw::c_uchar,
                    result_len: *mut ::std::os::raw::c_uint,
                    max_result_len: ::std::os::raw::c_uint);
    pub fn HASH_GetType(context: *mut HASHContext) -> HASH_HashType;
    pub fn HASH_GetHashObject(type_: HASH_HashType) -> *const SECHashObject;
    pub fn HASH_GetHashObjectByOidTag(hashOid: SECOidTag)
     -> *const SECHashObject;
    pub fn HASH_GetHashTypeByOidTag(hashOid: SECOidTag) -> HASH_HashType;
    pub fn HASH_GetHashOidTagByHMACOidTag(hmacOid: SECOidTag) -> SECOidTag;
    pub fn HASH_GetHMACOidTagByHashOidTag(hashOid: SECOidTag) -> SECOidTag;
}
