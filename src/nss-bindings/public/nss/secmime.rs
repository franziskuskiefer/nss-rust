...
extern "C" {
    ...
    pub fn SEC_PKCS7GetKeyLength(cinfo: *mut SEC_PKCS7ContentInfo)
     -> ::std::os::raw::c_int;
    pub fn SECMIME_EnableCipher(which: ::std::os::raw::c_long,
                                on: ::std::os::raw::c_int) -> SECStatus;
    pub fn SECMIME_SetPolicy(which: ::std::os::raw::c_long,
                             on: ::std::os::raw::c_int) -> SECStatus;
    pub fn SECMIME_DecryptionAllowed(algid: *mut SECAlgorithmID,
                                     key: *mut PK11SymKey) -> PRBool;
    pub fn SECMIME_EncryptionPossible() -> PRBool;
    pub fn SECMIME_CreateEncrypted(scert: *mut CERTCertificate,
                                   rcerts: *mut *mut CERTCertificate,
                                   certdb: *mut CERTCertDBHandle,
                                   pwfn: SECKEYGetPasswordKey,
                                   pwfn_arg: *mut ::std::os::raw::c_void)
     -> *mut SEC_PKCS7ContentInfo;
    pub fn SECMIME_CreateSigned(scert: *mut CERTCertificate,
                                ecert: *mut CERTCertificate,
                                certdb: *mut CERTCertDBHandle,
                                digestalg: SECOidTag, digest: *mut SECItem,
                                pwfn: SECKEYGetPasswordKey,
                                pwfn_arg: *mut ::std::os::raw::c_void)
     -> *mut SEC_PKCS7ContentInfo;
}
