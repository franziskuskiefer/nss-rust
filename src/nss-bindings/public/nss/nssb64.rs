...
extern "C" {
    ...
    pub fn PORT_LoadLibraryFromOrigin(existingShLibName:
                                      ...
                                      newShLibName:
                                          *const ::std::os::raw::c_char)
     -> *mut PRLibrary;
    pub fn NSSBase64Decoder_Create(output_fn:
                                       ::std::option::Option<unsafe extern "C" fn(arg1:
                                                                                      *mut ::std::os::raw::c_void,
                                                                                  arg2:
                                                                                      *const ::std::os::raw::c_uchar,
     ...
     -> *mut NSSBase64Decoder;
    pub fn NSSBase64Encoder_Create(output_fn:
                                       ::std::option::Option<unsafe extern "C" fn(arg1:
                                                                                      *mut ::std::os::raw::c_void,
                                                                                  arg2:
                                                                                      *const ::std::os::raw::c_char,
                                                                 ...
                                                                 -> PRInt32>,
                                   output_arg: *mut ::std::os::raw::c_void)
     -> *mut NSSBase64Encoder;
    pub fn NSSBase64Decoder_Update(data: *mut NSSBase64Decoder,
                                   buffer: *const ::std::os::raw::c_char,
                                   size: PRUint32) -> SECStatus;
    pub fn NSSBase64Encoder_Update(data: *mut NSSBase64Encoder,
                                   buffer: *const ::std::os::raw::c_uchar,
                                   size: PRUint32) -> SECStatus;
    pub fn NSSBase64Decoder_Destroy(data: *mut NSSBase64Decoder,
                                    abort_p: PRBool) -> SECStatus;
    pub fn NSSBase64Encoder_Destroy(data: *mut NSSBase64Encoder,
                                    abort_p: PRBool) -> SECStatus;
    pub fn NSSBase64_DecodeBuffer(arenaOpt: *mut PLArenaPool,
                                  outItemOpt: *mut SECItem,
                                  inStr: *const ::std::os::raw::c_char,
                                  inLen: ::std::os::raw::c_uint)
     -> *mut SECItem;
    pub fn NSSBase64_EncodeItem(arenaOpt: *mut PLArenaPool,
                                outStrOpt: *mut ::std::os::raw::c_char,
                                maxOutLen: ::std::os::raw::c_uint,
                                inItem: *mut SECItem)
     -> *mut ::std::os::raw::c_char;
}
