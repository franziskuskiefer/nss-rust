...
#[derive(Copy, Clone)]
#[derive(Debug)]
pub struct NSSLOWKEYAttributeStr {
    pub attrType: SECItem,
    pub attrValue: *mut SECItem,
}
impl ::std::default::Default for NSSLOWKEYAttributeStr {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
pub type NSSLOWKEYAttribute = NSSLOWKEYAttributeStr;
#[repr(C)]
#[derive(Copy, Clone)]
#[derive(Debug)]
pub struct NSSLOWKEYPrivateKeyInfoStr {
    pub arena: *mut PLArenaPool,
    pub version: SECItem,
    pub algorithm: SECAlgorithmID,
    pub privateKey: SECItem,
    pub attributes: *mut *mut NSSLOWKEYAttribute,
}
impl ::std::default::Default for NSSLOWKEYPrivateKeyInfoStr {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
pub type NSSLOWKEYPrivateKeyInfo = NSSLOWKEYPrivateKeyInfoStr;
#[derive(Copy, Clone)]
#[repr(u32)]
#[derive(Debug)]
pub enum NSSLOWKEYType {
    NSSLOWKEYNullKey = 0,
    NSSLOWKEYRSAKey = 1,
    NSSLOWKEYDSAKey = 2,
    NSSLOWKEYDHKey = 4,
...
#[derive(Copy, Clone)]
#[derive(Debug)]
pub struct NSSLOWKEYPublicKeyStr {
    pub arena: *mut PLArenaPool,
    pub keyType: NSSLOWKEYType,
    pub u: Union_Unnamed11,
}
impl ::std::default::Default for NSSLOWKEYPublicKeyStr {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
#[repr(C)]
#[derive(Copy, Clone)]
...
pub struct Union_Unnamed11 {
    pub _bindgen_data_: [u64; 34usize],
}
impl Union_Unnamed11 {
    pub unsafe fn rsa(&mut self) -> *mut RSAPublicKey {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_);
        ::std::mem::transmute(raw.offset(0))
    }
    pub unsafe fn dsa(&mut self) -> *mut DSAPublicKey {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_);
        ::std::mem::transmute(raw.offset(0))
    }
    pub unsafe fn dh(&mut self) -> *mut DHPublicKey {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_);
        ::std::mem::transmute(raw.offset(0))
    }
    pub unsafe fn ec(&mut self) -> *mut ECPublicKey {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_);
        ::std::mem::transmute(raw.offset(0))
    }
}
...
pub type NSSLOWKEYPublicKey = NSSLOWKEYPublicKeyStr;
#[repr(C)]
#[derive(Copy, Clone)]
#[derive(Debug)]
pub struct NSSLOWKEYPrivateKeyStr {
    pub arena: *mut PLArenaPool,
    pub keyType: NSSLOWKEYType,
    pub u: Union_Unnamed12,
}
impl ::std::default::Default for NSSLOWKEYPrivateKeyStr {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
#[repr(C)]
#[derive(Copy, Clone)]
...
pub struct Union_Unnamed12 {
    pub _bindgen_data_: [u64; 40usize],
}
impl Union_Unnamed12 {
    pub unsafe fn rsa(&mut self) -> *mut RSAPrivateKey {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_);
        ::std::mem::transmute(raw.offset(0))
    }
    pub unsafe fn dsa(&mut self) -> *mut DSAPrivateKey {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_);
        ::std::mem::transmute(raw.offset(0))
    }
    pub unsafe fn dh(&mut self) -> *mut DHPrivateKey {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_);
        ::std::mem::transmute(raw.offset(0))
    }
    pub unsafe fn ec(&mut self) -> *mut ECPrivateKey {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_);
        ::std::mem::transmute(raw.offset(0))
    }
}
...
pub type NSSLOWKEYPrivateKey = NSSLOWKEYPrivateKeyStr;
...
extern "C" {
    ...
    pub static mut nsslowkey_PQGParamsTemplate: [SEC_ASN1Template; 0usize];
    pub static mut nsslowkey_RSAPrivateKeyTemplate:
               [SEC_ASN1Template; 0usize];
    pub static mut nsslowkey_DSAPrivateKeyTemplate:
               [SEC_ASN1Template; 0usize];
    pub static mut nsslowkey_DSAPrivateKeyExportTemplate:
               [SEC_ASN1Template; 0usize];
    pub static mut nsslowkey_DHPrivateKeyTemplate: [SEC_ASN1Template; 0usize];
    pub static mut nsslowkey_DHPrivateKeyExportTemplate:
               [SEC_ASN1Template; 0usize];
    pub static mut nsslowkey_ECPrivateKeyTemplate: [SEC_ASN1Template; 0usize];
    pub static mut nsslowkey_PrivateKeyInfoTemplate:
               [SEC_ASN1Template; 0usize];
    pub static mut nsslowkey_EncryptedPrivateKeyInfoTemplate:
               [SEC_ASN1Template; 0usize];
}
extern "C" {
    ...
    pub fn prepare_low_rsa_priv_key_for_asn1(key: *mut NSSLOWKEYPrivateKey);
    pub fn prepare_low_pqg_params_for_asn1(params: *mut PQGParams);
    pub fn prepare_low_dsa_priv_key_for_asn1(key: *mut NSSLOWKEYPrivateKey);
    pub fn prepare_low_dsa_priv_key_export_for_asn1(key:
                                                        *mut NSSLOWKEYPrivateKey);
    pub fn prepare_low_dh_priv_key_for_asn1(key: *mut NSSLOWKEYPrivateKey);
    pub fn prepare_low_ec_priv_key_for_asn1(key: *mut NSSLOWKEYPrivateKey);
    pub fn prepare_low_ecparams_for_asn1(params: *mut ECParams);
    pub fn nsslowkey_DestroyPrivateKey(key: *mut NSSLOWKEYPrivateKey);
    pub fn nsslowkey_DestroyPublicKey(key: *mut NSSLOWKEYPublicKey);
    pub fn nsslowkey_PublicModulusLen(pubKey: *mut NSSLOWKEYPublicKey)
     -> ::std::os::raw::c_uint;
    pub fn nsslowkey_PrivateModulusLen(privKey: *mut NSSLOWKEYPrivateKey)
     -> ::std::os::raw::c_uint;
    pub fn nsslowkey_ConvertToPublicKey(privateKey: *mut NSSLOWKEYPrivateKey)
     -> *mut NSSLOWKEYPublicKey;
    pub fn nsslowkey_CopyPrivateKey(privKey: *mut NSSLOWKEYPrivateKey)
     -> *mut NSSLOWKEYPrivateKey;
}
