...
impl Union_Unnamed16 {
    ...
    pub unsafe fn mac_named_fragment(&mut self) -> *mut Struct_Unnamed17 {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_);
        ::std::mem::transmute(raw.offset(0))
    }
    pub unsafe fn mac_indexed_fragment(&mut self) -> *mut Struct_Unnamed18 {
        let raw: *mut u8 = ::std::mem::transmute(&self._bindgen_data_);
        ::std::mem::transmute(raw.offset(0))
    }
...
#[derive(Copy, Clone)]
#[derive(Debug)]
pub struct SSL3StatisticsStr {
    pub sch_sid_cache_hits: ::std::os::raw::c_long,
    pub sch_sid_cache_misses: ::std::os::raw::c_long,
    pub sch_sid_cache_not_ok: ::std::os::raw::c_long,
    pub hsh_sid_cache_hits: ::std::os::raw::c_long,
    pub hsh_sid_cache_misses: ::std::os::raw::c_long,
    pub hsh_sid_cache_not_ok: ::std::os::raw::c_long,
    pub hch_sid_cache_hits: ::std::os::raw::c_long,
    pub hch_sid_cache_misses: ::std::os::raw::c_long,
    pub hch_sid_cache_not_ok: ::std::os::raw::c_long,
    pub sch_sid_stateless_resumes: ::std::os::raw::c_long,
    pub hsh_sid_stateless_resumes: ::std::os::raw::c_long,
    pub hch_sid_stateless_resumes: ::std::os::raw::c_long,
    pub hch_sid_ticket_parse_failures: ::std::os::raw::c_long,
}
impl ::std::default::Default for SSL3StatisticsStr {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
pub type SSL3Statistics = SSL3StatisticsStr;
#[derive(Copy, Clone)]
#[repr(u32)]
#[derive(Debug)]
pub enum SSLKEAType {
...
#[derive(Copy, Clone)]
#[derive(Debug)]
pub struct SSLSignatureAndHashAlgStr {
    pub hashAlg: SSLHashType,
    pub sigAlg: SSLSignType,
}
impl ::std::default::Default for SSLSignatureAndHashAlgStr {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
pub type SSLSignatureAndHashAlg = SSLSignatureAndHashAlgStr;
#[derive(Copy, Clone)]
#[repr(u32)]
#[derive(Debug)]
...
#[derive(Copy, Clone)]
#[derive(Debug)]
pub struct SSLExtraServerCertDataStr {
    pub authType: SSLAuthType,
    pub certChain: *const CERTCertificateList,
    pub stapledOCSPResponses: *const SECItemArray,
    pub signedCertTimestamps: *const SECItem,
}
impl ::std::default::Default for SSLExtraServerCertDataStr {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
pub type SSLExtraServerCertData = SSLExtraServerCertDataStr;
#[repr(C)]
#[derive(Copy, Clone)]
#[derive(Debug)]
pub struct SSLChannelInfoStr {
    ...
    pub sessionID: [PRUint8; 32usize],
    pub compressionMethodName: *const ::std::os::raw::c_char,
    pub compressionMethod: SSLCompressionMethod,
    pub extendedMasterSecretUsed: PRBool,
}
impl ::std::default::Default for SSLChannelInfoStr {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
...
#[derive(Copy, Clone)]
#[derive(Debug)]
pub struct SSLPreliminaryChannelInfoStr {
    pub length: PRUint32,
    pub valuesSet: PRUint32,
    pub protocolVersion: PRUint16,
    pub cipherSuite: PRUint16,
}
impl ::std::default::Default for SSLPreliminaryChannelInfoStr {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
pub type SSLPreliminaryChannelInfo = SSLPreliminaryChannelInfoStr;
#[repr(C)]
#[derive(Copy, Clone)]
#[derive(Debug)]
pub struct SSLCipherSuiteInfoStr {
    pub length: PRUint16,
    pub cipherSuite: PRUint16,
    pub cipherSuiteName: *const ::std::os::raw::c_char,
    pub authAlgorithmName: *const ::std::os::raw::c_char,
    pub authAlgorithm: SSLAuthType,
    pub keaTypeName: *const ::std::os::raw::c_char,
    pub keaType: SSLKEAType,
    pub symCipherName: *const ::std::os::raw::c_char,
    pub symCipher: SSLCipherAlgorithm,
    pub symKeyBits: PRUint16,
    pub symKeySpace: PRUint16,
    pub effectiveKeyBits: PRUint16,
    pub macAlgorithmName: *const ::std::os::raw::c_char,
    pub macAlgorithm: SSLMACAlgorithm,
    pub macBits: PRUint16,
    pub _bindgen_bitfield_1_: PRUintn,
    pub _bindgen_bitfield_2_: PRUintn,
    pub _bindgen_bitfield_3_: PRUintn,
    pub _bindgen_bitfield_4_: PRUintn,
    pub authType: SSLAuthType,
}
impl ::std::default::Default for SSLCipherSuiteInfoStr {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
...
impl ::std::default::Default for SSLVersionRangeStr {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
...
#[repr(u32)]
#[derive(Debug)]
pub enum SSLSniNameType { SSL_sni_host_name = 0, SSL_sni_type_total = 1, }
#[derive(Copy, Clone)]
#[repr(u32)]
#[derive(Debug)]
pub enum SSLExtensionType {
    ...
    ssl_tls13_draft_version_xtn = 65282,
}
#[derive(Copy, Clone)]
#[repr(u32)]
#[derive(Debug)]
pub enum SSLDHEGroupType {
...
pub type SSLAuthCertificate =
    ::std::option::Option<unsafe extern "C" fn(arg:
                                               ...
                                               isServer: PRBool)
                              -> SECStatus>;
pub type SSLGetClientAuthData =
    ::std::option::Option<unsafe extern "C" fn(arg:
                                                   *mut ::std::os::raw::c_void,
                                               fd: *mut PRFileDesc,
                                               caNames: *mut CERTDistNames,
                                               pRetCert:
                                                   *mut *mut CERTCertificate,
                                               pRetKey:
                                                   *mut *mut SECKEYPrivateKey)
                              -> SECStatus>;
pub type SSLSNISocketConfig =
    ::std::option::Option<unsafe extern "C" fn(fd: *mut PRFileDesc,
                                               srvNameArr: *const SECItem,
                                               srvNameArrSize: PRUint32,
                                               arg:
                                                   *mut ::std::os::raw::c_void)
                              -> PRInt32>;
...
extern "C" {
    ...
    pub static mut SSL_ImplementedCiphers: [PRUint16; 0usize];
    pub static SSL_NumImplementedCiphers: PRUint16;
}
extern "C" {
    ...
    pub fn SSL_ImportFD(model: *mut PRFileDesc, fd: *mut PRFileDesc)
     -> *mut PRFileDesc;
    pub fn DTLS_ImportFD(model: *mut PRFileDesc, fd: *mut PRFileDesc)
     -> *mut PRFileDesc;
    pub fn SSL_OptionSet(fd: *mut PRFileDesc, option: PRInt32, on: PRBool)
     -> SECStatus;
    pub fn SSL_OptionGet(fd: *mut PRFileDesc, option: PRInt32,
                         on: *mut PRBool) -> SECStatus;
    pub fn SSL_OptionSetDefault(option: PRInt32, on: PRBool) -> SECStatus;
    pub fn SSL_OptionGetDefault(option: PRInt32, on: *mut PRBool)
     -> SECStatus;
    pub fn SSL_CertDBHandleSet(fd: *mut PRFileDesc,
                               dbHandle: *mut CERTCertDBHandle) -> SECStatus;
    pub fn SSL_SetNextProtoCallback(fd: *mut PRFileDesc,
                                    callback: SSLNextProtoCallback,
                                    arg: *mut ::std::os::raw::c_void)
     -> SECStatus;
    pub fn SSL_SetNextProtoNego(fd: *mut PRFileDesc,
                                data: *const ::std::os::raw::c_uchar,
                                length: ::std::os::raw::c_uint) -> SECStatus;
    pub fn SSL_GetNextProto(fd: *mut PRFileDesc,
                            state: *mut SSLNextProtoState,
                            buf: *mut ::std::os::raw::c_uchar,
                            bufLen: *mut ::std::os::raw::c_uint,
                            bufLenMax: ::std::os::raw::c_uint) -> SECStatus;
    pub fn SSL_CipherPrefSet(fd: *mut PRFileDesc, cipher: PRInt32,
                             enabled: PRBool) -> SECStatus;
    pub fn SSL_CipherPrefGet(fd: *mut PRFileDesc, cipher: PRInt32,
                             enabled: *mut PRBool) -> SECStatus;
    pub fn SSL_CipherPrefSetDefault(cipher: PRInt32, enabled: PRBool)
     -> SECStatus;
    pub fn SSL_CipherPrefGetDefault(cipher: PRInt32, enabled: *mut PRBool)
     -> SECStatus;
    pub fn SSL_CipherPolicySet(cipher: PRInt32, policy: PRInt32) -> SECStatus;
    pub fn SSL_CipherPolicyGet(cipher: PRInt32, policy: *mut PRInt32)
     -> SECStatus;
    pub fn SSL_SignaturePrefSet(fd: *mut PRFileDesc,
                                algorithms: *const SSLSignatureAndHashAlg,
                                count: ::std::os::raw::c_uint) -> SECStatus;
    pub fn SSL_SignaturePrefGet(fd: *mut PRFileDesc,
                                algorithms: *mut SSLSignatureAndHashAlg,
                                count: *mut ::std::os::raw::c_uint,
                                maxCount: ::std::os::raw::c_uint)
     -> SECStatus;
    pub fn SSL_SignatureMaxCount() -> ::std::os::raw::c_uint;
    pub fn SSL_DHEGroupPrefSet(fd: *mut PRFileDesc,
                               groups: *mut SSLDHEGroupType,
                               num_groups: PRUint16) -> SECStatus;
    pub fn SSL_EnableWeakDHEPrimeGroup(fd: *mut PRFileDesc, enabled: PRBool)
     -> SECStatus;
    ...
    pub fn SSL_VersionRangeSetDefault(protocolVariant: SSLProtocolVariant,
     ...
     -> SECStatus;
    pub fn SSL_VersionRangeGet(fd: *mut PRFileDesc,
                               vrange: *mut SSLVersionRange) -> SECStatus;
    pub fn SSL_VersionRangeSet(fd: *mut PRFileDesc,
                               vrange: *const SSLVersionRange) -> SECStatus;
    pub fn SSL_SetDowngradeCheckVersion(fd: *mut PRFileDesc,
                                        version: PRUint16) -> SECStatus;
    pub fn SSL_ResetHandshake(fd: *mut PRFileDesc, asServer: PRBool)
     -> SECStatus;
    pub fn SSL_ForceHandshake(fd: *mut PRFileDesc) -> SECStatus;
    pub fn SSL_ForceHandshakeWithTimeout(fd: *mut PRFileDesc,
                                         timeout: PRIntervalTime)
     -> SECStatus;
    pub fn SSL_SecurityStatus(fd: *mut PRFileDesc,
                              on: *mut ::std::os::raw::c_int,
                              cipher: *mut *mut ::std::os::raw::c_char,
                              keySize: *mut ::std::os::raw::c_int,
                              secretKeySize: *mut ::std::os::raw::c_int,
                              issuer: *mut *mut ::std::os::raw::c_char,
                              subject: *mut *mut ::std::os::raw::c_char)
     -> SECStatus;
    ...
    pub fn SSL_PeerStapledOCSPResponses(fd: *mut PRFileDesc)
     -> *const SECItemArray;
    pub fn SSL_PeerSignedCertTimestamps(fd: *mut PRFileDesc)
     -> *const SECItem;
    pub fn SSL_SetStapledOCSPResponses(fd: *mut PRFileDesc,
                                       responses: *const SECItemArray,
                                       kea: SSLKEAType) -> SECStatus;
    pub fn SSL_SetSignedCertTimestamps(fd: *mut PRFileDesc,
                                       scts: *const SECItem, kea: SSLKEAType)
     -> SECStatus;
    pub fn SSL_AuthCertificateHook(fd: *mut PRFileDesc, f: SSLAuthCertificate,
                                   arg: *mut ::std::os::raw::c_void)
     -> SECStatus;
    pub fn SSL_AuthCertificate(arg: *mut ::std::os::raw::c_void,
                               fd: *mut PRFileDesc, checkSig: PRBool,
                               isServer: PRBool) -> SECStatus;
    pub fn SSL_GetClientAuthDataHook(fd: *mut PRFileDesc,
                                     f: SSLGetClientAuthData,
                                     a: *mut ::std::os::raw::c_void)
     -> SECStatus;
    pub fn SSL_SNISocketConfigHook(fd: *mut PRFileDesc, f: SSLSNISocketConfig,
                                   arg: *mut ::std::os::raw::c_void)
     -> SECStatus;
    pub fn SSL_ReconfigFD(model: *mut PRFileDesc, fd: *mut PRFileDesc)
     -> *mut PRFileDesc;
    pub fn SSL_SetPKCS11PinArg(fd: *mut PRFileDesc,
                               a: *mut ::std::os::raw::c_void) -> SECStatus;
    pub fn SSL_BadCertHook(fd: *mut PRFileDesc, f: SSLBadCertHandler,
                           arg: *mut ::std::os::raw::c_void) -> SECStatus;
    pub fn SSL_ConfigServerCert(fd: *mut PRFileDesc,
                                cert: *mut CERTCertificate,
                                key: *mut SECKEYPrivateKey,
                                data: *const SSLExtraServerCertData,
                                data_len: ::std::os::raw::c_uint)
     -> SECStatus;
    pub fn SSL_ConfigSecureServer(fd: *mut PRFileDesc,
                                  cert: *mut CERTCertificate,
                                  key: *mut SECKEYPrivateKey, kea: SSLKEAType)
     -> SECStatus;
    pub fn SSL_ConfigSecureServerWithCertChain(fd: *mut PRFileDesc,
                                               cert: *mut CERTCertificate,
                                               certChainOpt:
                                                   *const CERTCertificateList,
                                               key: *mut SECKEYPrivateKey,
                                               kea: SSLKEAType) -> SECStatus;
    pub fn SSL_ConfigServerSessionIDCache(maxCacheEntries:
                                              ::std::os::raw::c_int,
                                          timeout: PRUint32,
                                          ssl3_timeout: PRUint32,
                                          directory:
                                              *const ::std::os::raw::c_char)
     -> SECStatus;
    pub fn SSL_ConfigServerSessionIDCacheWithOpt(timeout: PRUint32,
                                                 ssl3_timeout: PRUint32,
                                                 directory:
                                                     *const ::std::os::raw::c_char,
                                                 maxCacheEntries:
                                                 ...
                                                 maxSrvNameCacheEntries:
                                                     ::std::os::raw::c_int,
                                                 enableMPCache: PRBool)
     -> SECStatus;
    pub fn SSL_ConfigMPServerSIDCache(maxCacheEntries: ::std::os::raw::c_int,
                                      timeout: PRUint32,
                                      ssl3_timeout: PRUint32,
                                      directory:
                                          *const ::std::os::raw::c_char)
     -> SECStatus;
    pub fn SSL_GetMaxServerCacheLocks() -> PRUint32;
    pub fn SSL_SetMaxServerCacheLocks(maxLocks: PRUint32) -> SECStatus;
    pub fn SSL_InheritMPServerSIDCache(envString:
                                           *const ::std::os::raw::c_char)
     -> SECStatus;
    pub fn SSL_HandshakeCallback(fd: *mut PRFileDesc,
                                 cb: SSLHandshakeCallback,
                                 client_data: *mut ::std::os::raw::c_void)
     -> SECStatus;
    pub fn SSL_SetCanFalseStartCallback(fd: *mut PRFileDesc,
                                        callback: SSLCanFalseStartCallback,
                                        arg: *mut ::std::os::raw::c_void)
     -> SECStatus;
    pub fn SSL_RecommendedCanFalseStart(fd: *mut PRFileDesc,
                                        canFalseStart: *mut PRBool)
     -> SECStatus;
    pub fn SSL_ReHandshake(fd: *mut PRFileDesc, flushCache: PRBool)
     -> SECStatus;
    pub fn SSL_ReHandshakeWithTimeout(fd: *mut PRFileDesc, flushCache: PRBool,
                                      timeout: PRIntervalTime) -> SECStatus;
    pub fn SSL_SetURL(fd: *mut PRFileDesc, url: *const ::std::os::raw::c_char)
     -> SECStatus;
    pub fn SSL_SetTrustAnchors(fd: *mut PRFileDesc, list: *mut CERTCertList)
     -> SECStatus;
    pub fn SSL_DataPending(fd: *mut PRFileDesc) -> ::std::os::raw::c_int;
    pub fn SSL_InvalidateSession(fd: *mut PRFileDesc) -> SECStatus;
    pub fn SSL_GetSessionID(fd: *mut PRFileDesc) -> *mut SECItem;
    pub fn SSL_ClearSessionCache();
    pub fn SSL_ShutdownServerSessionIDCache() -> SECStatus;
    pub fn SSL_SetSockPeerID(fd: *mut PRFileDesc,
                             peerID: *const ::std::os::raw::c_char)
     -> SECStatus;
    pub fn SSL_RevealCert(socket: *mut PRFileDesc) -> *mut CERTCertificate;
    pub fn SSL_RevealPinArg(socket: *mut PRFileDesc)
     -> *mut ::std::os::raw::c_void;
    pub fn SSL_RevealURL(socket: *mut PRFileDesc)
     -> *mut ::std::os::raw::c_char;
    pub fn NSS_GetClientAuthData(arg: *mut ::std::os::raw::c_void,
                                 socket: *mut PRFileDesc,
                                 caNames: *mut CERTDistNamesStr,
                                 pRetCert: *mut *mut CERTCertificateStr,
                                 pRetKey: *mut *mut SECKEYPrivateKeyStr)
     -> SECStatus;
    pub fn SSL_SetSRTPCiphers(fd: *mut PRFileDesc, ciphers: *const PRUint16,
                              numCiphers: ::std::os::raw::c_uint)
     -> SECStatus;
    pub fn SSL_GetSRTPCipher(fd: *mut PRFileDesc, cipher: *mut PRUint16)
     -> SECStatus;
    pub fn NSS_CmpCertChainWCANames(cert: *mut CERTCertificate,
                                    caNames: *mut CERTDistNames) -> SECStatus;
    pub fn NSS_FindCertKEAType(cert: *mut CERTCertificate) -> SSLKEAType;
    pub fn NSS_SetDomesticPolicy() -> SECStatus;
    pub fn NSS_SetExportPolicy() -> SECStatus;
    pub fn NSS_SetFrancePolicy() -> SECStatus;
    pub fn SSL_GetStatistics() -> *mut SSL3Statistics;
    pub fn SSL_GetChannelInfo(fd: *mut PRFileDesc, info: *mut SSLChannelInfo,
                              len: PRUintn) -> SECStatus;
    pub fn SSL_GetPreliminaryChannelInfo(fd: *mut PRFileDesc,
                                         info: *mut SSLPreliminaryChannelInfo,
                                         len: PRUintn) -> SECStatus;
    pub fn SSL_GetCipherSuiteInfo(cipherSuite: PRUint16,
                                  info: *mut SSLCipherSuiteInfo, len: PRUintn)
     -> SECStatus;
    pub fn SSL_GetNegotiatedHostInfo(fd: *mut PRFileDesc) -> *mut SECItem;
    pub fn SSL_ExportKeyingMaterial(fd: *mut PRFileDesc,
                                    label: *const ::std::os::raw::c_char,
                                    labelLen: ::std::os::raw::c_uint,
                                    hasContext: PRBool,
                                    context: *const ::std::os::raw::c_uchar,
                                    contextLen: ::std::os::raw::c_uint,
                                    out: *mut ::std::os::raw::c_uchar,
                                    outLen: ::std::os::raw::c_uint)
     -> SECStatus;
    pub fn SSL_LocalCertificate(fd: *mut PRFileDesc) -> *mut CERTCertificate;
    pub fn SSL_CanBypass(cert: *mut CERTCertificate,
                         privKey: *mut SECKEYPrivateKey,
                         protocolmask: PRUint32, ciphers: *mut PRUint16,
                         nciphers: ::std::os::raw::c_int,
                         pcanbypass: *mut PRBool,
                         pwArg: *mut ::std::os::raw::c_void) -> SECStatus;
    pub fn SSL_HandshakeNegotiatedExtension(socket: *mut PRFileDesc,
                                            extId: SSLExtensionType,
                                            yes: *mut PRBool) -> SECStatus;
    pub fn DTLS_GetHandshakeTimeout(socket: *mut PRFileDesc,
                                    timeout: *mut PRIntervalTime)
     -> SECStatus;
    pub fn NSSSSL_VersionCheck(importedVersion: *const ::std::os::raw::c_char)
     -> PRBool;
    pub fn NSSSSL_GetVersion() -> *const ::std::os::raw::c_char;
    pub fn SSL_AuthCertificateComplete(fd: *mut PRFileDesc,
                                       error: PRErrorCode) -> SECStatus;
    pub fn NSS_NoDB_Init(configdir: *const ::std::os::raw::c_char)
     -> SECStatus;
    pub fn NSS_Initialize(configdir: *const ::std::os::raw::c_char,
                          certPrefix: *const ::std::os::raw::c_char,
                          keyPrefix: *const ::std::os::raw::c_char,
                          secmodName: *const ::std::os::raw::c_char,
                          flags: PRUint32) -> SECStatus;
