...
#[derive(Copy, Clone)]
#[derive(Debug)]
pub struct JAR_Item_ {
    pub pathname: *mut ::std::os::raw::c_char,
    pub type_: jarType,
    pub size: size_t,
    pub data: *mut ::std::os::raw::c_void,
}
impl ::std::default::Default for JAR_Item_ {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
pub type JAR_Item = JAR_Item_;
#[derive(Copy, Clone)]
#[repr(u32)]
#[derive(Debug)]
pub enum jarHash { jarHashNone = 0, jarHashBad = 1, jarHashPresent = 2, }
#[repr(C)]
#[derive(Copy, Clone)]
#[derive(Debug)]
pub struct JAR_Digest_ {
    pub md5_status: jarHash,
    pub md5: [::std::os::raw::c_uchar; 16usize],
    pub sha1_status: jarHash,
    pub sha1: [::std::os::raw::c_uchar; 20usize],
}
impl ::std::default::Default for JAR_Digest_ {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
pub type JAR_Digest = JAR_Digest_;
#[derive(Copy, Clone)]
#[repr(u32)]
#[derive(Debug)]
pub enum jarArch {
...
pub type ZZLink = ZZLinkStr;
pub type ZZList = ZZListStr;
#[repr(C)]
#[derive(Copy, Clone)]
#[derive(Debug)]
pub struct ZZLinkStr {
    pub next: *mut ZZLink,
    pub prev: *mut ZZLink,
    pub thing: *mut JAR_Item,
}
impl ::std::default::Default for ZZLinkStr {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
#[repr(C)]
#[derive(Copy, Clone)]
#[derive(Debug)]
pub struct ZZListStr {
    pub link: ZZLink,
}
impl ::std::default::Default for ZZListStr {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
pub type jar_settable_callback_fn =
    unsafe extern "C" fn(status: ::std::os::raw::c_int, jar: *mut JAR_,
                         metafile: *const ::std::os::raw::c_char,
                         pathname: *mut ::std::os::raw::c_char,
                         errortext: *mut ::std::os::raw::c_char)
        -> ::std::os::raw::c_int;
#[repr(C)]
#[derive(Copy, Clone)]
#[derive(Debug)]
pub struct JAR_ {
    ...
    pub fp: *mut FILE,
    pub manifest: *mut ZZList,
    pub hashes: *mut ZZList,
    pub phy: *mut ZZList,
    pub metainfo: *mut ZZList,
    pub globalmeta: *mut JAR_Digest,
    pub pkcs7: ::std::os::raw::c_int,
    pub valid: ::std::os::raw::c_int,
    pub signers: *mut ZZList,
    pub mw: *mut ::std::os::raw::c_void,
    pub signal: *mut jar_settable_callback_fn,
}
impl ::std::default::Default for JAR_ {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
pub type JAR = JAR_;
#[repr(C)]
#[derive(Copy, Clone)]
#[derive(Debug)]
pub struct JAR_Context_ {
    pub jar: *mut JAR,
    pub pattern: *mut ::std::os::raw::c_char,
    pub finding: jarType,
    pub next: *mut ZZLink,
    pub nextsign: *mut ZZLink,
}
impl ::std::default::Default for JAR_Context_ {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
pub type JAR_Context = JAR_Context_;
#[repr(C)]
#[derive(Copy, Clone)]
#[derive(Debug)]
pub struct JAR_Signer_ {
    pub pkcs7: ::std::os::raw::c_int,
    pub valid: ::std::os::raw::c_int,
    pub owner: *mut ::std::os::raw::c_char,
    pub digest: *mut JAR_Digest,
    pub sf: *mut ZZList,
    pub certs: *mut ZZList,
}
impl ::std::default::Default for JAR_Signer_ {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
pub type JAR_Signer = JAR_Signer_;
#[repr(C)]
#[derive(Copy, Clone)]
#[derive(Debug)]
pub struct JAR_Metainfo_ {
    pub header: *mut ::std::os::raw::c_char,
    pub info: *mut ::std::os::raw::c_char,
}
impl ::std::default::Default for JAR_Metainfo_ {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
pub type JAR_Metainfo = JAR_Metainfo_;
#[repr(C)]
#[derive(Copy, Clone)]
#[derive(Debug)]
pub struct JAR_Physical_ {
    pub compression: ::std::os::raw::c_uchar,
    pub offset: ::std::os::raw::c_ulong,
    pub length: ::std::os::raw::c_ulong,
    pub uncompressed_length: ::std::os::raw::c_ulong,
    pub mode: PRUint16,
    _bindgen_padding_0_: [u8; 6usize],
}
impl ::std::default::Default for JAR_Physical_ {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
pub type JAR_Physical = JAR_Physical_;
#[repr(C)]
#[derive(Copy, Clone)]
#[derive(Debug)]
pub struct JAR_Cert_ {
    pub length: size_t,
    pub key: *mut ::std::os::raw::c_void,
    pub cert: *mut CERTCertificate,
}
impl ::std::default::Default for JAR_Cert_ {
    fn default() -> Self { unsafe { ::std::mem::zeroed() } }
}
pub type JAR_Cert = JAR_Cert_;
#[derive(Copy, Clone)]
#[repr(u32)]
#[derive(Debug)]
pub enum jarCert {
...
extern "C" {
    ...
    pub fn ZZ_NewLink(thing: *mut JAR_Item) -> *mut ZZLink;
    pub fn ZZ_DestroyLink(link: *mut ZZLink);
    pub fn ZZ_NewList() -> *mut ZZList;
    pub fn ZZ_DestroyList(list: *mut ZZList);
    pub fn JAR_new() -> *mut JAR;
    pub fn JAR_destroy(jar: *mut JAR);
    pub fn JAR_get_error(status: ::std::os::raw::c_int)
     -> *mut ::std::os::raw::c_char;
    pub fn JAR_set_callback(type_: ::std::os::raw::c_int, jar: *mut JAR,
                            fn_: *mut jar_settable_callback_fn)
     -> ::std::os::raw::c_int;
    pub fn JAR_init_callbacks(string_cb:
                              ...
                              init_cx:
                                  ::std::option::Option<extern "C" fn()
                                                            ->
                                                                *mut ::std::os::raw::c_void>);
    pub fn JAR_set_context(jar: *mut JAR, mw: *mut ::std::os::raw::c_void)
     -> ::std::os::raw::c_int;
    pub fn JAR_find(jar: *mut JAR, pattern: *mut ::std::os::raw::c_char,
                    type_: jarType) -> *mut JAR_Context;
    pub fn JAR_find_next(ctx: *mut JAR_Context, it: *mut *mut JAR_Item)
     -> ::std::os::raw::c_int;
    pub fn JAR_find_end(ctx: *mut JAR_Context);
    pub fn JAR_parse_manifest(jar: *mut JAR,
                              raw_manifest: *mut ::std::os::raw::c_char,
                              length: ::std::os::raw::c_long,
                              path: *const ::std::os::raw::c_char,
                              url: *const ::std::os::raw::c_char)
     -> ::std::os::raw::c_int;
    pub fn JAR_calculate_digest(data: *mut ::std::os::raw::c_void,
                                length: ::std::os::raw::c_long)
     -> *mut JAR_Digest;
    pub fn JAR_verify_digest(jar: *mut JAR,
                             name: *const ::std::os::raw::c_char,
                             dig: *mut JAR_Digest) -> ::std::os::raw::c_int;
    pub fn JAR_digest_file(filename: *mut ::std::os::raw::c_char,
                           dig: *mut JAR_Digest) -> ::std::os::raw::c_int;
    pub fn JAR_get_metainfo(jar: *mut JAR, name: *mut ::std::os::raw::c_char,
                            header: *mut ::std::os::raw::c_char,
                            info: *mut *mut ::std::os::raw::c_void,
                            length: *mut ::std::os::raw::c_ulong)
     -> ::std::os::raw::c_int;
    pub fn JAR_get_filename(jar: *mut JAR) -> *mut ::std::os::raw::c_char;
    pub fn JAR_get_url(jar: *mut JAR) -> *mut ::std::os::raw::c_char;
    pub fn JAR_stash_cert(jar: *mut JAR, keylen: ::std::os::raw::c_long,
                          key: *mut ::std::os::raw::c_void)
     -> ::std::os::raw::c_int;
    pub fn JAR_fetch_cert(length: ::std::os::raw::c_long,
                          key: *mut ::std::os::raw::c_void)
     -> *mut CERTCertificate;
    pub fn JAR_pass_archive(jar: *mut JAR, format: jarArch,
                            filename: *mut ::std::os::raw::c_char,
                            url: *const ::std::os::raw::c_char)
     -> ::std::os::raw::c_int;
    pub fn JAR_pass_archive_unverified(jar: *mut JAR, format: jarArch,
                                       filename: *mut ::std::os::raw::c_char,
                                       url: *const ::std::os::raw::c_char)
     -> ::std::os::raw::c_int;
    pub fn JAR_verified_extract(jar: *mut JAR,
                                path: *mut ::std::os::raw::c_char,
                                outpath: *mut ::std::os::raw::c_char)
     -> ::std::os::raw::c_int;
    pub fn JAR_extract(jar: *mut JAR, path: *mut ::std::os::raw::c_char,
                       outpath: *mut ::std::os::raw::c_char)
     -> ::std::os::raw::c_int;
}
