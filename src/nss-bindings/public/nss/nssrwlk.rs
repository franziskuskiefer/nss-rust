...
extern "C" {
    ...
    pub fn NSSRWLock_New(lock_rank: PRUint32,
                         lock_name: *const ::std::os::raw::c_char)
     -> *mut NSSRWLock;
    pub fn nssRWLock_AtomicCreate(prwlock: *mut *mut NSSRWLock,
                                  lock_rank: PRUint32,
                                  lock_name: *const ::std::os::raw::c_char)
     -> *mut NSSRWLock;
    pub fn NSSRWLock_Destroy(lock: *mut NSSRWLock);
    pub fn NSSRWLock_LockRead(lock: *mut NSSRWLock);
    pub fn NSSRWLock_LockWrite(lock: *mut NSSRWLock);
    pub fn NSSRWLock_UnlockRead(lock: *mut NSSRWLock);
    pub fn NSSRWLock_UnlockWrite(lock: *mut NSSRWLock);
    pub fn NSSRWLock_HaveWriteLock(rwlock: *mut NSSRWLock) -> PRBool;
}
